    ...
    __call = function(p1, u2) -- Line: 8, Name: __call
        ...
        return setmetatable({
            ...
            __call = function(p4, p5, p6) -- Line: 18, Name: __call
                ...
                if not u3 then
                    u3 = p5:GetAttributeChangedSignal(u2):Connect(p6);

                    return u3;
                end;
            end,

            __index = function(p7, p8) -- Line: 28, Name: __index
                return p8 == "__SEAM_INDEX" and "OnAttributeChanged" or nil;
            end
        });
    end,

    __index = function(p9, p10) -- Line: 40, Name: __index
