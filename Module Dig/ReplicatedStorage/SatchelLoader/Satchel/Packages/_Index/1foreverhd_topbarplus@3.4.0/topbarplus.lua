...
function u4.bindToggleItem(p161, p162) -- Line: 867
...
function u4.unbindToggleItem(p163, p164) -- Line: 876
...
function u4._updateSelectionInstances(p165) -- Line: 882
...
function u4._setToggleItemsVisible(p167, p168, p169, p170) -- Line: 896
...
function u4.bindEvent(u171, p172, u173) -- Line: 908
    ...
    u171.bindedEvents[p172] = v174:Connect(function(...) -- Line: 912
...
function u4.unbindEvent(p177, p178) -- Line: 918
...
function u4.bindToggleKey(p180, p181) -- Line: 927
...
function u4.unbindToggleKey(p183, p184) -- Line: 935
...
function u4.call(u186, u187, ...) -- Line: 941
...
function u4.addToJanitor(p189, p190, p191, p192) -- Line: 949
    p189.janitor:add(p190, p191, p192);

    return p189;
end;

function u4.lock(p193) -- Line: 954
...
function u4.unlock(p194) -- Line: 962
...
function u4.debounce(p195, p196) -- Line: 969
    p195:lock();
    task.wait(p196);
    p195:unlock();
...
function u4.setCaption(p201, p202) -- Line: 1000
...
function u4.setCaptionHint(p204, p205) -- Line: 1018
...
function u4.leave(p207) -- Line: 1026
    p207.joinJanitor:clean();

    return p207;
end;

function u4.joinMenu(p208, p209) -- Line: 1032
...
function u4.setMenu(p210, p211) -- Line: 1038
    p210.menuSet:Fire(p211);

    return p210;
end;

function u4.setFixedMenu(p212, p213) -- Line: 1043
...
function u4.freezeMenu(u214) -- Line: 1049
    u214:select("FrozenMenu", u214);
    u214:bindEvent("deselected", function(p215) -- Line: 1053
        -- upvalues: u214 (copy)
...
function u4.joinDropdown(p216, p217) -- Line: 1059
    -- upvalues: Utility (copy)
    p217:getDropdown();
...
function u4.getDropdown(p218) -- Line: 1066
    -- upvalues: Elements (copy)
...
function u4.setDropdown(p219, p220) -- Line: 1076
    p219:getDropdown();
...
function u4.clipOutside(p221, p222) -- Line: 1082
    -- upvalues: Utility (copy)
...
function u4.setIndicator(p224, p225) -- Line: 1093
    -- upvalues: Elements (copy), u4 (copy)
...
function u4.convertLabelToNumberSpinner(u226, u227, u228) -- Line: 1105
    task.defer(function() -- Line: 1106
        ...
        for _, v in ipairs({ "FontFace", "BorderSizePixel", "BorderColor3", "Rotation", "TextStrokeTransparency", "TextStrokeColor3", "TextStrokeTransparency", "TextColor3" }) do
            u227[v] = u229[v];
            u226:addToJanitor(u229:GetPropertyChangedSignal(v):Connect(function() -- Line: 1129
        ...
        u226:addToJanitor(u226.iconAdded:Connect(function() -- Line: 1208
...
function u4.destroy(p238) -- Line: 1235
    -- upvalues: u4 (copy)
