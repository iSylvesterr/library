...
local u1 = { "k", "M", "B", "T", "Qd", "Qn", "Sx", "Sp", "O", "N", "De", "Ud", "DD", "tdD", "QnD", "SxD", "SpD", "OcD", "NvD", "VgN", "UvG", "DvG", "TvG", "QtV", "QnV", "SeV", "SpG", "OvG", "NvG", "TgN", "UtG", "DtG", "TsTg", "QtTg", "QnTg", "SsTg", "SpTg", "OcTg", "NoTg", "QdDr", "UnAg", "DuAg", "TeAg", "QdAg", "QnAG", "SxAg", "SpAg", "OcAg", "NvAg", "CT" };
...
return {
    new = function() -- Line: 61, Name: new
        -- upvalues: u1 (copy), setSetting (copy), numberToString (copy), numbersToSortedString (copy), stringToNumber (copy), commify (copy)
        return {
            _decimalPlaces = 2,
