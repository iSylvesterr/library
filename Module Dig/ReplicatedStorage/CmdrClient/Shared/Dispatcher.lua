...
local u47 = {
    ...
    Send = function(p27, p28, p29) -- Line: 92, Name: Send
    ...
    Run = function(p30, ...) -- Line: 104, Name: Run
    ...
    RunHooks = function(p37, p38, p39, ...) -- Line: 132, Name: RunHooks
    ...
    PushHistory = function(p41, p42) -- Line: 164, Name: PushHistory
    ...
    GetHistory = function(p45) -- Line: 179, Name: GetHistory
