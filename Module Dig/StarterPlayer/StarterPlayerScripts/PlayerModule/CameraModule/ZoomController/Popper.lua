...
local function canOcclude(p39) -- Line: 196
    -- upvalues: u37 (ref)
    if p39:HasTag("Passthrough") then
        return false;
    end;
    ...
    if u1 then
        ...
        while true do
            ...
            if v59 >= 64 then
                ...
                if Instance:HasTag("Passthrough") or 1 - (1 - Instance.Transparency) * (1 - Instance.LocalTransparencyModifier) >= 0.25 then
                    v63 = false;
                else
                    v63 = Instance.CanCollide;
        ...
        while true do
            ...
            if true then
                ...
                if v66 then
                    ...
                    if v66:HasTag("Passthrough") or 1 - (1 - v66.Transparency) * (1 - v66.LocalTransparencyModifier) >= 0.25 then
                        v69 = false;
                    else
                        v69 = v66.CanCollide;
...
local function queryViewport(p74, p75) -- Line: 367
...
local function testPromotion(p83, p84, p85) -- Line: 410
...
return function(p89, p90, p91) -- Line: 459, Name: Popper
