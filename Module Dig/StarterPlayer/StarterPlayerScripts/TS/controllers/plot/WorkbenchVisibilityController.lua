...
local u1 = setmetatable({}, {
    __tostring = function() -- Line: 9, Name: __tostring
        return "WorkbenchVisibilityController";
    end
});
u1.__index = u1;
...
function u1.onStart(u5) -- Line: 21
    task.spawn(function() -- Line: 22
        ...
        u5.plot:observePlots(function(p8, p9) -- Line: 27
            ...
            local Workbench = p8:FindFirstChild("Workbench");

            if Workbench then
                u5:hideBillboards(Workbench);
            end;
        end);
    end);
end;

function u1.hideBillboards(p10, p11) -- Line: 38
...
Reflect.defineMetadata(u1, "identifier", "client/controllers/plot/WorkbenchVisibilityController@WorkbenchVisibilityController");
...
return {
    WorkbenchVisibilityController = u1
};