...
function u1.EnableButton(u5, p6) -- Line: 76
    ...
    if p6 then
        ...
        u5.jumpButton.Visible = true;
        u5._connectionUtil:trackConnection("JUMP_INPUT_ENDED", u5.jumpButton.InputEnded:Connect(function(p7) -- Line: 91
            -- upvalues: u5 (copy)
            if p7 == u5.touchObject then
                u5:_reset();
            end;
        end));
        u5._connectionUtil:trackConnection("MENU_OPENED", GuiService.MenuOpened:Connect(function() -- Line: 101
            -- upvalues: u5 (copy)
...
function u1.UpdateEnabled(p8) -- Line: 118
    -- upvalues: CharacterUtil (copy)
    local v9 = CharacterUtil.getChild("Humanoid", "Humanoid");

    if v9 and p8.externallyEnabled and (v9.UseJumpPower and v9.JumpPower > 0 or not v9.UseJumpPower and v9.JumpHeight > 0) and v9:GetStateEnabled(Enum.HumanoidStateType.Jumping) then
...
function u1._setupConfigurations(u10) -- Line: 127
    -- upvalues: CharacterUtil (copy)
    local function update() -- Line: 128
        -- upvalues: u10 (copy)
        u10:UpdateEnabled();
    end;

    local v14 = CharacterUtil.onChild("Humanoid", "Humanoid", function(p11) -- Line: 133
        ...
        u10._connectionUtil:trackConnection("HUMANOID_JUMP_HEIGHT", p11:GetPropertyChangedSignal("JumpHeight"):Connect(update));
        u10._connectionUtil:trackConnection("HUMANOID_STATE_ENABLED_CHANGED", p11.StateEnabledChanged:Connect(function(p12, p13) -- Line: 146
            -- upvalues: u10 (ref)
...
function u1.Enable(p15, p16, p17) -- Line: 158
    if p17 then
...
function u1.Create(u18) -- Line: 175
    ...
    u18.touchObject = nil;
    u18.jumpButton.InputBegan:connect(function(p21) -- Line: 212
        -- upvalues: u18 (copy)
