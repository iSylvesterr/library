...
local u1 = { "K", "M", "B", "T", "Qa", "Qi", "Sx", "Sp", "Oc", "No", "Dc", "Ud", "Dd", "Td", "Qad", "Qid", "Sxd", "Spd", "Ocd", "Nod", "Vg", "Uvg", "Dvg", "Tvg", "Qavg", "Qivg", "Sxvg", "Spvg", "Ocvg", "Novg", "Tg" };
local Main = require(script.Parent.Main);
local v2 = {};
local u3 = {};
local u4 = {};

function v2.Format(p5, p6) -- Line: 45
...
function v2.FormatCompact(p12, p13) -- Line: 72
