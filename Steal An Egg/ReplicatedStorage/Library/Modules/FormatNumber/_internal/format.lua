...
function u1.format_expt(p29, p30, p31, p32) -- Line: 148
    -- upvalues: enums (copy)
    local v33 = "";
    local v34;
...
function u1.resolve_with_notation(p36, p37, p38, p39, p40) -- Line: 173
    -- upvalues: enums (copy), u1 (copy)
    local v41 = nil;
    local v42 = nil;
    local v43 = nil;
...
function u1.format_unsigned_finite(p46, p47, p48, p49, p50) -- Line: 230
...
function u1.display_sign(p63, p64, p65, p66, p67) -- Line: 298
    -- upvalues: enums (copy)
    local v68, v69;
