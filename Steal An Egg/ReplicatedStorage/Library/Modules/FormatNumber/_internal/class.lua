...
function u1.create_init_function(u6, p7, u8, p9, u10) -- Line: 16
    ...
    return function(p12, p13) -- Line: 33
...
function u1.is_a(p17, p18) -- Line: 59
...
function u1.get_data(p21) -- Line: 77
    -- upvalues: u3 (copy)
    return u3[p21].data;
end;

function u1.get_resolved_data(p22, p23) -- Line: 81
    -- upvalues: u3 (copy)
    local v24 = u3[p22];
...
function u1.try_coerce(p25, p26, p27, p28) -- Line: 96
...
function u1.try_coerce_range(p32, p33, p34, p35, p36) -- Line: 151
    -- upvalues: u1 (copy)
    local v37 = nil;
...
function u1.try_coerce_enum(p39, p40, p41, p42) -- Line: 179
    -- upvalues: u1 (copy)
    local v43 = nil;
...
function u1.double_to_int32(p45) -- Line: 200
