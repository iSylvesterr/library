...
function v1.createEnum(p3, u4) -- Line: 16
    -- upvalues: u2 (copy)
    ...
    local u9 = {};
    local u19 = {
        getName = function(p10) -- Line: 26, Name: getName
        ...
        getValue = function(p13) -- Line: 36, Name: getValue
        ...
        getProperty = function(p16) -- Line: 46, Name: getProperty
    ...
    for i, v in pairs(u4) do
        ...
        v20[v22] = v26;
        setmetatable(v20, {
            __index = function(p32, p33) -- Line: 85, Name: __index
                -- upvalues: u19 (copy)
                return u19[p33];
            end
        });
