...
function v1.setupWorldModel(p3) -- Line: 6
...
function v1._getCombinedResults(p5, p6, ...) -- Line: 18
    -- upvalues: u2 (ref)
...
function v1.GetPartBoundsInBox(p9, p10, p11, p12) -- Line: 29
    return p9:_getCombinedResults("GetPartBoundsInBox", p10, p11, p12);
end;

function v1.GetPartBoundsInRadius(p13, p14, p15, p16) -- Line: 33
    return p13:_getCombinedResults("GetPartBoundsInRadius", p14, p15, p16);
end;

function v1.GetPartsInPart(p17, p18, p19) -- Line: 37
