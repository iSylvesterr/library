...
function u6.new(p7) -- Line: 40
    ...
    u8.accuracy = enums.Accuracy.Low;
    u8.autoUpdate = true;
    ...
    for _, v in pairs(v11) do
        ...
        for _, v3 in pairs(v12) do
            local v15 = v10:add(Signal.new(true));
            local u16 = v3:sub(1, 1):upper() .. v3:sub(2);
            u8[v .. u16] = v15;
            v15.connectionsChanged:Connect(function(p17) -- Line: 115
    ...
    for _, v in pairs(v11) do
        ...
        if u18 then
            ...
            u6.touchedConnectionActions[v] = function(p19) -- Line: 141
...
function u6.fromRegion(p20, p21) -- Line: 159
    -- upvalues: u6 (copy)
    local Model = Instance.new("Model");

    local function createCube(p22, p23) -- Line: 162
...
function u6._calculateRegion(p27, p28, p29) -- Line: 188
    local v30 = {
        Min = {},
        Max = {}
    };
    ...
    for i, v in pairs(v30) do
        ...
        function v.parseCheck(p31, p32) -- Line: 192
            -- upvalues: i (copy)
            if i == "Min" then
                return p31 <= p32;
            end;
        ...
        function v.parse(p33, p34) -- Line: 199
    ...
    local function roundToFour(p41) -- Line: 231
...
function u6._displayBounds(p46) -- Line: 254
...
function u6._update(u47) -- Line: 273
    ...
    for _, v in pairs(v48) do
        local _, result = pcall(function() -- Line: 307
            -- upvalues: v (copy)
            return v.Shape.Name;
        end);
    ...
    v53.FilterType = Enum.RaycastFilterType.Whitelist;
    v53.MaxParts = #v48;
    ...
    local function update() -- Line: 329
        ...
        if u47.autoUpdate then
            ...
            local u56 = nil;
            u56 = RunService.Heartbeat:Connect(function() -- Line: 337
    ...
    local function verifyDefaultCollision(p57) -- Line: 351
    ...
    for _, v in pairs(v48) do
        ...
        u47._updateConnections:add(v:GetPropertyChangedSignal("CollisionGroupId"):Connect(function() -- Line: 364
            -- upvalues: v (copy)
            if v.CollisionGroupId ~= 0 then
                error("Zone parts must belong to the \'Default\' (0) CollisionGroup! Consider using zone:relocate() if you wish to move zones outside of workspace to prevent them interacting with other parts.");
            end;
    ...
    for _ in pairs(v51) do
        for _, v in pairs(v59) do
            u47._updateConnections:add(u47.container[v]:Connect(function(p60) -- Line: 374
                -- upvalues: u47 (copy), u49 (ref), RunService (ref)
                if p60:IsA("BasePart") and u47.autoUpdate then
                    ...
                    local u62 = nil;
                    u62 = RunService.Heartbeat:Connect(function() -- Line: 337
...
function u6._updateOccupants(p67, p68, p69) -- Line: 412
...
function u6._formTouchedConnection(p73, p74) -- Line: 442
...
function u6._updateTouchedConnection(p77, p78) -- Line: 454
...
function u6._updateTouchedConnections(p80) -- Line: 465
...
function u6._disconnectTouchedConnection(p82, p83) -- Line: 476
...
local function round(p86, p87) -- Line: 485
    return math.round(p86 * 10 ^ p87) * 10 ^ (-p87);
end;

function u6._partTouchedZone(u88, u89) -- Line: 488
    ...
    u93:add(Heartbeat:Connect(function() -- Line: 509
...
local u101 = {
    Ball = function(p98) -- Line: 550
        return "GetPartBoundsInRadius", { p98.Position, p98.Size.X };
    end,

    Block = function(p99) -- Line: 553
        return "GetPartBoundsInBox", { p99.CFrame, p99.Size };
    end,

    Other = function(p100) -- Line: 556
        return "GetPartsInPart", { p100 };
    end
};

function u6._getRegionConstructor(p102, u103, p104) -- Line: 560
    -- upvalues: u101 (copy)
    local success, result = pcall(function() -- Line: 561
        -- upvalues: u103 (copy)
...
function u6.findLocalPlayer(p108) -- Line: 581
    -- upvalues: u1 (copy)
    if not u1 then
...
function u6._find(p109, p110, p111) -- Line: 588
    -- upvalues: u3 (copy)
...
function u6.findPlayer(p113, p114) -- Line: 600
...
function u6.findItem(p115, p116) -- Line: 609
    return p115:_find("item", p116);
end;

function u6.findPart(p117, p118) -- Line: 613
...
function u6.getCheckerPart(p122) -- Line: 623
    -- upvalues: u3 (copy)
...
function u6.findPoint(p123, p124) -- Line: 644
...
function u6._getAll(p129, p130) -- Line: 661
    -- upvalues: u3 (copy)
...
function u6.getPlayers(p133) -- Line: 675
    return p133:_getAll("player");
end;

function u6.getItems(p134) -- Line: 679
    return p134:_getAll("item");
end;

function u6.getParts(p135) -- Line: 683
    local v136 = {};
...
function u6.getRandomPoint(p138) -- Line: 705
...
function u6.setAccuracy(p144, p145) -- Line: 729
    -- upvalues: enums (copy)
...
function u6.setDetection(p147, p148) -- Line: 745
    -- upvalues: enums (copy)
...
function u6.trackItem(u150, u151) -- Line: 762
    ...
    v154:add(u151.AncestryChanged:Connect(function() -- Line: 788
...
function u6.untrackItem(p156, p157) -- Line: 800
...
function u6.bindToGroup(p159, p160) -- Line: 811
    -- upvalues: u3 (copy)
...
function u6.unbindFromGroup(p161) -- Line: 818
    -- upvalues: u3 (copy)
...
function u6.relocate(p163) -- Line: 828
...
function u6._onItemCallback(u165, p166, p167, u168, u169) -- Line: 849
    ...
    local function triggerCallback() -- Line: 861
    ...
    if u165:findItem(u168) == p167 then
        ...
        local u171 = nil;
        u171 = u165[p166]:Connect(function(p172) -- Line: 874
...
function u6.onItemEnter(p173, ...) -- Line: 896
    p173:_onItemCallback("itemEntered", true, ...);
end;

function u6.onItemExit(p174, ...) -- Line: 900
    p174:_onItemCallback("itemExited", false, ...);
end;

function u6.destroy(p175) -- Line: 904
