...
return function(u1, u2) -- Line: 3
    u1.WidgetConstructor("Checkbox", {
        ...
        Events = {
            ...
            hovered = u2.EVENTS.hover(function(p7) -- Line: 25
                return p7.Instance;
            end)
        },

        Generate = function(u8) -- Line: 29, Name: Generate
            ...
            TextButton.MouseButton1Click:Connect(function() -- Line: 79
                -- upvalues: u8 (copy)
        ...
        Discard = function(p13) -- Line: 102, Name: Discard
            -- upvalues: u2 (copy)
            p13.Instance:Destroy();
            u2.discardState(p13);
        end,

        GenerateState = function(p14) -- Line: 106, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        UpdateState = function(p15) -- Line: 111, Name: UpdateState
