...
return function(u1, u2) -- Line: 3
    ...
    u2.UserInputService.InputBegan:Connect(function(p12) -- Line: 65
    ...
    u1.WidgetConstructor("MenuBar", {
        ...
        Generate = function(p15) -- Line: 105, Name: Generate
        ...
        Update = function(p16) -- Line: 123, Name: Update
            -- upvalues: u1 (copy)
            ...
            if v17 then
                ...
                u1._postCycleCallbacks[u18] = function() -- Line: 134
        ...
        ChildAdded = function(p20) -- Line: 148, Name: ChildAdded
            return p20.Instance;
        end,

        Discard = function(p21) -- Line: 151, Name: Discard
            -- upvalues: u1 (copy)
    ...
    u1.WidgetConstructor("Menu", {
        ...
        Events = {
            clicked = u2.EVENTS.click(function(p22) -- Line: 169
                return p22.Instance;
            end),
            hovered = u2.EVENTS.hover(function(p23) -- Line: 172
                return p23.Instance;
            end),
            opened = {
                Init = function(p24) -- Line: 176
                end,

                Get = function(p25) -- Line: 177
                    -- upvalues: u1 (copy)
                    return p25.lastOpenedTick == u1._cycleTick;
                end
            },
            closed = {
                Init = function(p26) -- Line: 182
                end,

                Get = function(p27) -- Line: 183
                    -- upvalues: u1 (copy)
        ...
        Generate = function(u28) -- Line: 188, Name: Generate
            ...
            v29.MouseButton1Click:Connect(function() -- Line: 269
            ...
            v29.MouseEnter:Connect(function() -- Line: 284
        ...
        Update = function(p35) -- Line: 343, Name: Update
        ...
        ChildAdded = function(p36, p37) -- Line: 353, Name: ChildAdded
        ...
        ChildDiscarded = function(p38, p39) -- Line: 357, Name: ChildDiscarded
            -- upvalues: UpdateChildContainerTransform (copy)
            UpdateChildContainerTransform(p38);
        end,

        GenerateState = function(p40) -- Line: 360, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        UpdateState = function(p41) -- Line: 365, Name: UpdateState
        ...
        Discard = function(p42) -- Line: 380, Name: Discard
            -- upvalues: u2 (copy)
    ...
    u1.WidgetConstructor("MenuItem", {
        ...
        Events = {
            clicked = u2.EVENTS.click(function(p43) -- Line: 398
                return p43.Instance;
            end),
            hovered = u2.EVENTS.hover(function(p44) -- Line: 401
                return p44.Instance;
            end)
        },

        Generate = function(u45) -- Line: 405, Name: Generate
            ...
            TextButton.MouseButton1Click:Connect(function() -- Line: 434
                -- upvalues: EmptyMenuStack (ref)
                EmptyMenuStack();
            end);
            TextButton.MouseEnter:Connect(function() -- Line: 438
        ...
        Update = function(p47) -- Line: 481, Name: Update
        ...
        Discard = function(p48) -- Line: 491, Name: Discard
    ...
    u1.WidgetConstructor("MenuToggle", {
        ...
        Events = {
            checked = {
                Init = function(p49) -- Line: 509
                end,

                Get = function(p50) -- Line: 510
                    -- upvalues: u1 (copy)
                    return p50.lastCheckedTick == u1._cycleTick;
                end
            },
            unchecked = {
                Init = function(p51) -- Line: 515
                end,

                Get = function(p52) -- Line: 516
                    -- upvalues: u1 (copy)
                    return p52.lastUncheckedTick == u1._cycleTick;
                end
            },
            hovered = u2.EVENTS.hover(function(p53) -- Line: 520
                return p53.Instance;
            end)
        },

        Generate = function(u54) -- Line: 524, Name: Generate
            -- upvalues: u2 (copy), u1 (copy), EmptyMenuStack (copy), u3 (ref), u4 (ref), u5 (copy)
            local TextButton = Instance.new("TextButton");
            TextButton.Name = "MenuItem";
            TextButton.BackgroundTransparency = 1;
            ...
            TextButton.MouseButton1Click:Connect(function() -- Line: 554
                -- upvalues: u54 (copy), EmptyMenuStack (ref)
                u54.state.isChecked:set(not u54.state.isChecked.value);
                EmptyMenuStack();
            end);
            TextButton.MouseEnter:Connect(function() -- Line: 560
        ...
        GenerateState = function(p58) -- Line: 620, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        Update = function(p59) -- Line: 625, Name: Update
        ...
        UpdateState = function(p60) -- Line: 635, Name: UpdateState
        ...
        Discard = function(p61) -- Line: 647, Name: Discard
            -- upvalues: u2 (copy)
