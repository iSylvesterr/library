...
return function(u1, u2) -- Line: 3
    u1.WidgetConstructor("RadioButton", {
        ...
        Events = {
            ...
            hovered = u2.EVENTS.hover(function(p9) -- Line: 32
                return p9.Instance;
            end)
        },

        Generate = function(u10) -- Line: 36, Name: Generate
            ...
            TextButton.MouseButton1Click:Connect(function() -- Line: 80
                -- upvalues: u10 (copy)
        ...
        Update = function(p12) -- Line: 98, Name: Update
            -- upvalues: u1 (copy)
        ...
        Discard = function(p13) -- Line: 107, Name: Discard
            -- upvalues: u2 (copy)
            p13.Instance:Destroy();
            u2.discardState(p13);
        end,

        GenerateState = function(p14) -- Line: 111, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        UpdateState = function(p15) -- Line: 116, Name: UpdateState
            -- upvalues: u1 (copy)
