...
return function(u1, u2) -- Line: 3
    ...
    u1.WidgetConstructor("Table", {
        ...
        Events = {
            hovered = u2.EVENTS.hover(function(p4) -- Line: 25
                return p4.Instance;
            end)
        },

        Generate = function(p5) -- Line: 29, Name: Generate
        ...
        Discard = function(p9) -- Line: 122, Name: Discard
            -- upvalues: u3 (copy)
            u3[p9.ID] = nil;
            p9.Instance:Destroy();
        end,

        ChildAdded = function(p10) -- Line: 126, Name: ChildAdded
            -- upvalues: u2 (copy), u1 (copy)
