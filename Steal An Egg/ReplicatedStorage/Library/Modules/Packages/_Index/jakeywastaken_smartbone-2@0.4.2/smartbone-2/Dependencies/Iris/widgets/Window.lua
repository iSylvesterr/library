...
return function(u1, u2) -- Line: 3
    ...
    u1.WidgetConstructor("Tooltip", {
        ...
        Generate = function(p5) -- Line: 34, Name: Generate
            -- upvalues: u1 (copy), u2 (copy)
        ...
        Update = function(p6) -- Line: 73, Name: Update
        ...
        Discard = function(p7) -- Line: 82, Name: Discard
            p7.Instance:Destroy();
        end
    });
    local u8 = 0;
    ...
    local function quickSwapWindows() -- Line: 107
    ...
    local function fitSizeToWindowBounds(p22, p23) -- Line: 134
        -- upvalues: u1 (copy), u2 (copy)
    ...
    local function fitPositionToWindowBounds(p32, p33) -- Line: 150
    ...
    function u1.SetFocusedWindow(p39) -- Line: 178
    ...
    u2.UserInputService.InputBegan:Connect(function(p40, p41) -- Line: 235
    ...
    u2.UserInputService.TouchTapInWorld:Connect(function(p46, p47) -- Line: 276
        -- upvalues: u1 (copy)
        if not p47 then
            u1.SetFocusedWindow(nil);
        end;
    end);
    u2.UserInputService.InputChanged:Connect(function(p48) -- Line: 282
    ...
    u2.UserInputService.InputEnded:Connect(function(p59, p60) -- Line: 344
    ...
    u1.WidgetConstructor("Window", {
        ...
        Events = {
            closed = {
                Init = function(p61) -- Line: 389
                end,

                Get = function(p62) -- Line: 390
                    -- upvalues: u1 (copy)
                    return p62.lastClosedTick == u1._cycleTick;
                end
            },
            opened = {
                Init = function(p63) -- Line: 395
                end,

                Get = function(p64) -- Line: 396
                    -- upvalues: u1 (copy)
                    return p64.lastOpenedTick == u1._cycleTick;
                end
            },
            collapsed = {
                Init = function(p65) -- Line: 401
                end,

                Get = function(p66) -- Line: 402
                    -- upvalues: u1 (copy)
                    return p66.lastCollapsedTick == u1._cycleTick;
                end
            },
            uncollapsed = {
                Init = function(p67) -- Line: 407
                end,

                Get = function(p68) -- Line: 408
                    -- upvalues: u1 (copy)
                    return p68.lastUncollapsedTick == u1._cycleTick;
                end
            },
            hovered = u2.EVENTS.hover(function(p69) -- Line: 412
                return p69.Instance.WindowButton;
            end)
        },

        Generate = function(u70) -- Line: 417, Name: Generate
            ...
            TextButton.InputBegan:Connect(function(p72) -- Line: 462
            ...
            ScrollingFrame:GetPropertyChangedSignal("CanvasPosition"):Connect(function() -- Line: 501
                -- upvalues: u70 (copy), ScrollingFrame (copy)
                u70.state.scrollDistance.value = ScrollingFrame.CanvasPosition.Y;
            end);
            ScrollingFrame.InputBegan:Connect(function(p73) -- Line: 506
            ...
            Frame2.InputBegan:Connect(function(p74) -- Line: 545
            ...
            TextButton2.MouseButton1Click:Connect(function() -- Line: 575
                -- upvalues: u70 (copy)
            ...
            TextButton3.MouseButton1Click:Connect(function() -- Line: 617
                -- upvalues: u70 (copy)
            ...
            TextButton4.MouseButton1Down:Connect(function() -- Line: 698
            ...
            TextButton5.MouseEnter:Connect(function() -- Line: 726
                -- upvalues: u17 (ref), u70 (copy), u14 (ref)
                if u17 == u70 then
                    u14 = true;
                end;
            end);
            TextButton5.MouseLeave:Connect(function() -- Line: 731
                -- upvalues: u17 (ref), u70 (copy), u14 (ref)
                if u17 == u70 then
                    u14 = false;
                end;
            end);
            TextButton.MouseEnter:Connect(function() -- Line: 737
        ...
        Update = function(p78) -- Line: 750, Name: Update
            -- upvalues: u1 (copy)
        ...
        Discard = function(p82) -- Line: 822, Name: Discard
        ...
        ChildAdded = function(p83) -- Line: 839, Name: ChildAdded
            return p83.Instance.WindowButton.ChildContainer;
        end,

        UpdateState = function(p84) -- Line: 844, Name: UpdateState
            -- upvalues: u1 (copy), u2 (copy)
            ...
            if value5 and value5 ~= 0 then
                ...
                u1._postCycleCallbacks[u85] = function() -- Line: 910
        ...
        GenerateState = function(p87) -- Line: 918, Name: GenerateState
