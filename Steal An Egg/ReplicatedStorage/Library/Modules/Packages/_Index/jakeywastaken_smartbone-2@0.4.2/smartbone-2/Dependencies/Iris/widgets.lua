...
return function(u2) -- Line: 5
    ...
    function u1.isPosInsideRect(p11, p12, p13) -- Line: 65
        local v14;
    ...
    function u1.extend(p15, p16) -- Line: 69
    ...
    function u1.UIPadding(p18, p19) -- Line: 77
    ...
    function u1.UIListLayout(p20, p21, p22) -- Line: 87
    ...
    function u1.UIStroke(p23, p24, p25, p26) -- Line: 96
    ...
    function u1.UICorner(p27, p28) -- Line: 107
    ...
    function u1.UISizeConstraint(p29, p30, p31) -- Line: 114
    ...
    function u1.UIReference(p32, p33, p34) -- Line: 122
    ...
    function u1.getScreenSizeForWindow(p35) -- Line: 131
    ...
    function u1.calculateTextSize(p36, p37) -- Line: 158
    ...
    function u1.applyTextStyle(p39) -- Line: 173
        -- upvalues: u2 (copy)
    ...
    function u1.applyInteractionHighlights(p40, u41, u42) -- Line: 184
        -- upvalues: u2 (copy)
        local u43 = false;
        p40.MouseEnter:Connect(function() -- Line: 186
        ...
        p40.InputEnded:Connect(function(p45) -- Line: 213
    ...
    function u1.applyInteractionHighlightsWithMultiHighlightee(p46, u47) -- Line: 235
        -- upvalues: u2 (copy)
        local u48 = false;
        p46.MouseEnter:Connect(function() -- Line: 240
        ...
        p46.MouseLeave:Connect(function() -- Line: 249
            -- upvalues: u47 (copy), u48 (ref)
            for _, v in u47 do
        ...
        p46.InputBegan:Connect(function(p49) -- Line: 258
            -- upvalues: u47 (copy)
        ...
        p46.InputEnded:Connect(function(p50) -- Line: 273
    ...
    function u1.applyTextInteractionHighlights(p51, u52, u53) -- Line: 297
        -- upvalues: u2 (copy)
        local u54 = false;
        p51.MouseEnter:Connect(function() -- Line: 303
        ...
        p51.MouseLeave:Connect(function() -- Line: 310
            -- upvalues: u52 (copy), u53 (copy), u54 (ref)
            u52.TextColor3 = u53.ButtonColor;
            u52.TextTransparency = u53.ButtonTransparency;
            u54 = true;
        end);
        p51.InputBegan:Connect(function(p55) -- Line: 317
        ...
        p51.InputEnded:Connect(function(p56) -- Line: 330
    ...
    function u1.applyFrameStyle(p57, p58, p59) -- Line: 352
    ...
    function u1.discardState(p60) -- Line: 397
    ...
    u1.EVENTS = {
        hover = function(u61) -- Line: 404, Name: hover
            return {
                Init = function(u62) -- Line: 406
                    -- upvalues: u61 (copy)
                    local v63 = u61(u62);
                    v63.MouseEnter:Connect(function() -- Line: 408
                        -- upvalues: u62 (copy)
                        u62.isHoveredEvent = true;
                    end);
                    v63.MouseLeave:Connect(function() -- Line: 411
                        -- upvalues: u62 (copy)
                ...
                Get = function(p64) -- Line: 416
                    return p64.isHoveredEvent;
                end
            };
        end,

        click = function(u65) -- Line: 422, Name: click
            -- upvalues: u2 (copy)
            return {
                Init = function(u66) -- Line: 424
                    -- upvalues: u65 (copy), u2 (ref)
                    local v67 = u65(u66);
                    u66.lastClickedTick = -1;
                    v67.MouseButton1Click:Connect(function() -- Line: 428
                        -- upvalues: u66 (copy), u2 (ref)
                        u66.lastClickedTick = u2._cycleTick + 1;
                    end);
                end,

                Get = function(p68) -- Line: 432
                    -- upvalues: u2 (ref)
        ...
        rightClick = function(u69) -- Line: 438, Name: rightClick
            -- upvalues: u2 (copy)
            return {
                Init = function(u70) -- Line: 440
                    -- upvalues: u69 (copy), u2 (ref)
                    local v71 = u69(u70);
                    u70.lastRightClickedTick = -1;
                    v71.MouseButton2Click:Connect(function() -- Line: 444
                        -- upvalues: u70 (copy), u2 (ref)
                        u70.lastRightClickedTick = u2._cycleTick + 1;
                    end);
                end,

                Get = function(p72) -- Line: 448
                    -- upvalues: u2 (ref)
        ...
        ctrlClick = function(u80) -- Line: 484, Name: ctrlClick
            -- upvalues: u1 (ref), u2 (copy)
            return {
                Init = function(u81) -- Line: 486
                    -- upvalues: u80 (copy), u1 (ref), u2 (ref)
                    local v82 = u80(u81);
                    u81.lastCtrlClickedTick = -1;
                    v82.MouseButton1Click:Connect(function() -- Line: 490
        ...
        shortcut = function(u84) -- Line: 505, Name: shortcut
            -- upvalues: u1 (ref), u2 (copy)
            return {
                Init = function(u85) -- Line: 507
                    -- upvalues: u84 (copy), u1 (ref), u2 (ref)
                    local v86, u87 = u84(u85);
                    u85.lastShortcutTick = -1;
                    u1.ContextActionService:BindAction(u85.ID, function(p88, p89, p90) -- Line: 513
