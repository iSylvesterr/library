...
return function(u1, u2) -- Line: 3
    ...
    u1.WidgetConstructor("Selectable", {
        ...
        Events = {
            ...
            unselected = {
                Init = function(p6) -- Line: 30
                end,

                Get = function(p7) -- Line: 31
                    -- upvalues: u1 (copy)
                    return p7.lastUnselectedTick == u1._cycleTick;
                end
            },
            active = {
                Init = function(p8) -- Line: 36
                end,

                Get = function(p9) -- Line: 37
                    return p9.state.index.value == p9.arguments.Index;
                end
            },
            clicked = u2.EVENTS.click(function(p10) -- Line: 41
                return p10.Instance.SelectableButton;
            end),
            rightClicked = u2.EVENTS.rightClick(function(p11) -- Line: 45
                return p11.Instance.SelectableButton;
            end),
            doubleClicked = u2.EVENTS.doubleClick(function(p12) -- Line: 49
                return p12.Instance.SelectableButton;
            end),
            ctrlClicked = u2.EVENTS.ctrlClick(function(p13) -- Line: 53
                return p13.Instance.SelectableButton;
            end),
            hovered = u2.EVENTS.hover(function(p14) -- Line: 57
                return p14.Instance.SelectableButton;
            end)
        },

        Generate = function(u15) -- Line: 62, Name: Generate
        ...
        Update = function(p17) -- Line: 104, Name: Update
            p17.Instance.SelectableButton.Text = p17.arguments.Text or "Selectable";
        end,

        Discard = function(p18) -- Line: 109, Name: Discard
            -- upvalues: u2 (copy)
            p18.Instance:Destroy();
            u2.discardState(p18);
        end,

        GenerateState = function(p19) -- Line: 113, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        UpdateState = function(p20) -- Line: 121, Name: UpdateState
            -- upvalues: u1 (copy)
    ...
    local function UpdateChildContainerTransform(p24) -- Line: 141
        -- upvalues: u1 (copy)
    ...
    u2.UserInputService.InputBegan:Connect(function(p28) -- Line: 176
    ...
    u1.WidgetConstructor("Combo", {
        ...
        Events = {
            opened = {
                Init = function(p31) -- Line: 211
                end,

                Get = function(p32) -- Line: 212
                    -- upvalues: u1 (copy)
                    return p32.lastOpenedTick == u1._cycleTick;
                end
            },
            closed = {
                Init = function(p33) -- Line: 217
                end,

                Get = function(p34) -- Line: 218
                    -- upvalues: u1 (copy)
                    return p34.lastClosedTick == u1._cycleTick;
                end
            },
            clicked = u2.EVENTS.click(function(p35) -- Line: 222
                return p35.Instance;
            end),
            hovered = u2.EVENTS.hover(function(p36) -- Line: 225
                return p36.Instance;
            end)
        },

        Generate = function(u37) -- Line: 229, Name: Generate
            ...
            TextButton.InputBegan:Connect(function(p41) -- Line: 333
        ...
        Update = function(p43) -- Line: 403, Name: Update
            -- upvalues: u1 (copy)
        ...
        ChildAdded = function(p44, p45) -- Line: 431, Name: ChildAdded
        ...
        ChildDiscarded = function(p46, p47) -- Line: 441, Name: ChildDiscarded
        ...
        GenerateState = function(u48) -- Line: 448, Name: GenerateState
            -- upvalues: u1 (copy)
            if u48.state.index == nil then
                u48.state.index = u1._widgetState(u48, "index", "No Selection");
            end;

            u48.state.index:onChange(function() -- Line: 452
                -- upvalues: u48 (copy)
        ...
        UpdateState = function(p49) -- Line: 461, Name: UpdateState
        ...
        Discard = function(p51) -- Line: 493, Name: Discard
            -- upvalues: u2 (copy)
