...
local u22 = {
    ...
    InViewFrustum = function(p10, p11, p12, p13, p14, p15, p16, p17, p18, p19) -- Line: 42, Name: InViewFrustum
        local v20 = p11 * p10;
...
function u22.ObjectInFrustum(p23, p24, p25, p26, p27, p28, p29, p30, p31, p32) -- Line: 92
