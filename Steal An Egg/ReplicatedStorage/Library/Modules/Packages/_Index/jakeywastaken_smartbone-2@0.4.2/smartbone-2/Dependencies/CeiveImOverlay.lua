...
function u2.m_Cleanup(p24) -- Line: 139
    p24.m_State = "";
    p24.m_Indent = 0;
    p24.m_RenderGroup = {};
end;

function u2.m_CreateLabel(p25, p26, p27, p28, p29) -- Line: 149
    -- upvalues: u1 (copy)
...
function u2.Render(p30) -- Line: 188
    if p30.m_State == "" then
        p30:m_Pool();
        p30:m_Cleanup();
        p30.DidUpdate = false;
...
function u2.Destroy(p33) -- Line: 252
