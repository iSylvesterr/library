...
local function isCallable(p2) -- Line: 12
...
local function makeEnum(u5, p6) -- Line: 30
    local v7 = {};
    ...
    return setmetatable(v7, {
        __index = function(p8, p9) -- Line: 38, Name: __index
            -- upvalues: u5 (copy)
            error(string.format("%s is not in %s!", p9, u5), 2);
        end,

        __newindex = function() -- Line: 41, Name: __newindex
            -- upvalues: u5 (copy)
...
function u10.new(p11, p12) -- Line: 66
    -- upvalues: u10 (ref)
    local v13 = p11 or {};
    local v14 = {
...
function u10.isKind(p19, p20) -- Line: 91
    -- upvalues: u10 (ref)
...
function u10.extend(p22, p23) -- Line: 97
    -- upvalues: u10 (ref)
    local v24 = p23 or {};
...
function u10.getErrorChain(p25) -- Line: 105
    local v26 = { p25 };
...
function u10.__tostring(p27) -- Line: 115
...
local function pack(...) -- Line: 139
    return select("#", ...), { ... };
end;

local function packResult(p29, ...) -- Line: 146
    return p29, select("#", ...), { ... };
end;

local function makeErrorHandler(u30) -- Line: 150
    -- upvalues: u10 (ref)
    assert(u30 ~= nil, "traceback is nil");

    return function(p31) -- Line: 153
...
local function runExecutor(u32, p33, ...) -- Line: 173
    -- upvalues: packResult (copy), u10 (ref)
    local v34 = xpcall;
    assert(u32 ~= nil, "traceback is nil");

    return packResult(v34(p33, function(p35) -- Line: 153
...
local function createAdvancer(u36, u37, u38, u39) -- Line: 181
...
local function isEmpty(p43) -- Line: 193
    return next(p43) == nil;
end;
...
function u44._new(p45, u46, p47) -- Line: 232
    ...
    local function resolve(...) -- Line: 280
        -- upvalues: u48 (copy)
        u48:_resolve(...);
    end;

    local function reject(...) -- Line: 284
        -- upvalues: u48 (copy)
        u48:_reject(...);
    end;

    local function onCancel(p49) -- Line: 288
    ...
    u48._thread = coroutine.create(function() -- Line: 300
...
function u44.resolve(...) -- Line: 420
    -- upvalues: pack (copy), u44 (copy)
    local u62, u63 = pack(...);

    return u44._new(debug.traceback(nil, 2), function(p64) -- Line: 422
        -- upvalues: u63 (copy), u62 (copy)
        p64(unpack(u63, 1, u62));
    end);
end;

function u44.reject(...) -- Line: 437
    -- upvalues: pack (copy), u44 (copy)
    local u65, u66 = pack(...);

    return u44._new(debug.traceback(nil, 2), function(p67, p68) -- Line: 439
        -- upvalues: u66 (copy), u65 (copy)
        p68(unpack(u66, 1, u65));
    end);
end;

function u44._try(p69, u70, ...) -- Line: 448
    -- upvalues: pack (copy), u44 (copy)
    local u71, u72 = pack(...);

    return u44._new(p69, function(p73) -- Line: 451
        -- upvalues: u70 (copy), u72 (copy), u71 (copy)
        p73(u70(unpack(u72, 1, u71)));
    end);
end;

function u44.try(p74, ...) -- Line: 479
    -- upvalues: u44 (copy)
    return u44._try(debug.traceback(nil, 2), p74, ...);
end;

function u44._all(p75, u76, u77) -- Line: 488
    -- upvalues: u44 (copy)
    ...
    return u44._new(p75, function(u78, u79, p80) -- Line: 506
        ...
        local function resolveOne(p86, ...) -- Line: 524
        ...
        p80(function() -- Line: 517, Name: cancel
            -- upvalues: u82 (copy)
            for _, v in ipairs(u82) do
                v:cancel();
            end;
        ...
        for i, v in ipairs(u76) do
            u82[i] = v:andThen(function(...) -- Line: 549
                -- upvalues: resolveOne (copy), i (copy)
                resolveOne(i, ...);
            end, function(...) -- Line: 551
...
function u44.all(p87) -- Line: 593
    -- upvalues: u44 (copy)
    return u44._all(debug.traceback(nil, 2), p87);
end;

function u44.fold(p88, u89, p90) -- Line: 622
    -- upvalues: u44 (copy)
    ...
    return u44.each(p88, function(u96, u97) -- Line: 627
        -- upvalues: u95 (ref), u89 (copy)
        u95 = u95:andThen(function(p98) -- Line: 628
            -- upvalues: u89 (ref), u96 (copy), u97 (copy)
            return u89(p98, u96, u97);
        end);
    end):andThen(function() -- Line: 631
        -- upvalues: u95 (ref)
        return u95;
    end);
end;

function u44.some(p99, p100) -- Line: 655
    -- upvalues: u44 (copy)
...
function u44.any(p102) -- Line: 661
    -- upvalues: u44 (copy)
    return u44._all(debug.traceback(nil, 2), p102, 1):andThen(function(p103) -- Line: 662
        return p103[1];
    end);
end;

function u44.allSettled(u104) -- Line: 683
    -- upvalues: u44 (copy)
    ...
    return u44._new(debug.traceback(nil, 2), function(u105, p106, p107) -- Line: 701
        -- upvalues: u104 (copy)
        local u108 = {};
        local u109 = {};
        local u110 = 0;

        local function u112(p111, ...) -- Line: 711
        ...
        for i, v in ipairs(u104) do
            u109[i] = v:finally(function(...) -- Line: 730
...
function u44.race(u113) -- Line: 761
    -- upvalues: u44 (copy)
    ...
    return u44._new(debug.traceback(nil, 2), function(u117, u118, p119) -- Line: 768
        -- upvalues: u113 (copy)
        local u120 = {};
        local u121 = false;

        local function cancel() -- Line: 772
            -- upvalues: u120 (copy)
        ...
        local function finalize(u122) -- Line: 778
            -- upvalues: u120 (copy), u121 (ref)
            return function(...) -- Line: 779
        ...
        for i, v in ipairs(u113) do
            u120[i] = v:andThen(function(...) -- Line: 779
...
function u44.each(u123, u124) -- Line: 800
    ...
    return u44._new(debug.traceback(nil, 2), function(p129, p130, p131) -- Line: 804
        -- upvalues: u123 (copy), u44 (ref), u10 (ref), u124 (copy)
        local v132 = {};
        local u133 = {};
        local u134 = false;

        local function _() -- Line: 810
            -- upvalues: u133 (copy)
        ...
        for i, v in ipairs(u123) do
            if u44.is(v) then
                ...
                local v136 = v:andThen(function(...) -- Line: 849
                    return ...;
                end);
...
function u44.promisify(u151) -- Line: 948
    -- upvalues: u44 (copy)
...
function u44.delay(p154) -- Line: 979
    ...
    return u44._new(debug.traceback(nil, 2), function(p157, p158, p159) -- Line: 987
        ...
        if u153 == nil then
            u152 = u162;
            u153 = u44._timeEvent:Connect(function() -- Line: 999
...
function u44.prototype.timeout(p166, u167, u168) -- Line: 1070
    -- upvalues: u44 (copy), u10 (ref)
    local u169 = debug.traceback(nil, 2);

    return u44.race({ u44.delay(u167):andThen(function() -- Line: 1074
...
function u44.prototype.getStatus(p170) -- Line: 1094
    return p170._status;
end;

function u44.prototype._andThen(u171, u172, u173, u174) -- Line: 1103
    -- upvalues: u44 (copy), runExecutor (copy)
    u171._unhandledRejection = false;

    if u171._status ~= u44.Status.Cancelled then
        return u44._new(u172, function(u175, u176, p177) -- Line: 1115
    ...
    local v189 = u44.new(function() -- Line: 1108
    end);
    v189:cancel();
...
function u44.prototype.andThen(p190, p191, p192) -- Line: 1152
    local v193;
...
function u44.prototype.catch(p199, p200) -- Line: 1159
    local v201;
...
function u44.prototype.tap(p204, u205) -- Line: 1164
    ...
    return p204:_andThen(debug.traceback(nil, 2), function(...) -- Line: 1166
        ...
        return v209:andThen(function() -- Line: 1171
...
function u44.prototype.andThenCall(p212, u213, ...) -- Line: 1199
    -- upvalues: pack (copy)
    local v214;
    ...
    return p212:_andThen(debug.traceback(nil, 2), function() -- Line: 1202
        -- upvalues: u213 (copy), u218 (copy), u217 (copy)
        return u213(unpack(u218, 1, u217));
    end);
end;

function u44.prototype.andThenReturn(p219, ...) -- Line: 1207
    -- upvalues: pack (copy)
    local u220, u221 = pack(...);

    return p219:_andThen(debug.traceback(nil, 2), function() -- Line: 1209
        -- upvalues: u221 (copy), u220 (copy)
        return unpack(u221, 1, u220);
    end);
end;

function u44.prototype.cancel(p222) -- Line: 1225
    -- upvalues: u44 (copy)
...
function u44.prototype._consumerCancelled(p223, p224) -- Line: 1253
    -- upvalues: u44 (copy)
...
function u44.prototype._finally(u225, p226, u227) -- Line: 1269
    -- upvalues: u44 (copy)
    u225._unhandledRejection = false;

    return u44._new(p226, function(u228, u229, p230) -- Line: 1272
        -- upvalues: u225 (copy), u227 (copy), u44 (ref)
        local u231 = nil;
        p230(function() -- Line: 1275
        ...
        local v234 = u227 and function(...) -- Line: 1288
...
function u44.prototype.finally(p235, p236) -- Line: 1370
    local v237;
...
function u44.prototype.finallyCall(p240, u241, ...) -- Line: 1384
    -- upvalues: pack (copy)
    local v242;
    ...
    return p240:_finally(debug.traceback(nil, 2), function() -- Line: 1387
        -- upvalues: u241 (copy), u246 (copy), u245 (copy)
        return u241(unpack(u246, 1, u245));
    end);
end;

function u44.prototype.finallyReturn(p247, ...) -- Line: 1409
    -- upvalues: pack (copy)
    local u248, u249 = pack(...);

    return p247:_finally(debug.traceback(nil, 2), function() -- Line: 1411
        -- upvalues: u249 (copy), u248 (copy)
        return unpack(u249, 1, u248);
    end);
end;

function u44.prototype.awaitStatus(p250) -- Line: 1423
    -- upvalues: u44 (copy)
    p250._unhandledRejection = false;

    if p250._status == u44.Status.Started then
        local u251 = coroutine.running();
        p250:finally(function() -- Line: 1430
            -- upvalues: u251 (copy)
            task.spawn(u251);
        end):catch(function() -- Line: 1436
        end);
        coroutine.yield();
    end;
...
local function awaitHelper(p252, ...) -- Line: 1451
    -- upvalues: u44 (copy)
    return p252 == u44.Status.Resolved, ...;
end;

function u44.prototype.await(p253) -- Line: 1455
    -- upvalues: awaitHelper (copy)
    return awaitHelper(p253:awaitStatus());
end;

local function expectHelper(p254, ...) -- Line: 1459
    -- upvalues: u44 (copy)
...
function u44.prototype.expect(p255) -- Line: 1492
...
function u44.prototype._unwrap(p256) -- Line: 1506
    -- upvalues: u44 (copy)
...
function u44.prototype._resolve(u257, ...) -- Line: 1516
    ...
    if u44.is((...)) then
        ...
        local u259 = ...;
        local v261 = u259:andThen(function(...) -- Line: 1537
            -- upvalues: u257 (copy)
            u257:_resolve(...);
        end, function(...) -- Line: 1539
...
function u44.prototype._reject(u264, ...) -- Line: 1587
    -- upvalues: u44 (copy), pack (copy)
    ...
    if next(u264._queuedReject) == nil then
        local u267 = tostring((...));
        coroutine.wrap(function() -- Line: 1609
...
function u44.prototype._finalize(p269) -- Line: 1641
    -- upvalues: u44 (copy)
...
function u44.prototype.now(p270, p271) -- Line: 1662
    -- upvalues: u44 (copy), u10 (ref)
    local v272 = debug.traceback(nil, 2);

    if p270._status == u44.Status.Resolved then
        return p270:_andThen(v272, function(...) -- Line: 1665
            return ...;
        end);
    end;
...
function u44.retry(u273, u274, ...) -- Line: 1707
    -- upvalues: u44 (copy)
    local v275;
    ...
    return u44.resolve(u273(...)):catch(function(...) -- Line: 1713
...
function u44.retryWithDelay(u281, u282, u283, ...) -- Line: 1735
    -- upvalues: u44 (copy)
    local v284;
    ...
    return u44.resolve(u281(...)):catch(function(...) -- Line: 1742
...
function u44.fromEvent(u291, p292) -- Line: 1777
    -- upvalues: u44 (copy)
    local u293 = p292 or function() -- Line: 1778
        return true;
    end;

    return u44._new(debug.traceback(nil, 2), function(u294, p295, p296) -- Line: 1782
        -- upvalues: u291 (copy), u293 (ref)
        local u297 = nil;
        local u298 = false;

        local function disconnect() -- Line: 1786
            -- upvalues: u297 (ref)
            u297:Disconnect();
            u297 = nil;
        end;

        u297 = u291:Connect(function(...) -- Line: 1795
...
function u44.onUnhandledRejection(u300) -- Line: 1829
    -- upvalues: u44 (copy)
    table.insert(u44._unhandledRejectionCallbacks, u300);

    return function() -- Line: 1832
