...
local u20 = {
    ...
    getLines = function(p16) -- Line: 66, Name: getLines
        local v17 = p16.Size.X / 2;
        local v18 = p16.Size.Y / 2;
        local v19 = p16.Size.Z / 2;

        return {
            nwColumn = { getWorldPosition(p16, (Vector3.new(-v17, -v18, v19))), getWorldPosition(p16, (Vector3.new(-v17, v18, v19))) },
            neColumn = { getWorldPosition(p16, (Vector3.new(v17, -v18, v19))), getWorldPosition(p16, (Vector3.new(v17, v18, v19))) },
            ...
            nBorder = { getWorldPosition(p16, (Vector3.new(v17, -v18, v19))), getWorldPosition(p16, (Vector3.new(-v17, -v18, v19))) },
            ...
            sTerrace = { getWorldPosition(p16, (Vector3.new(v17, v18, -v19))), getWorldPosition(p16, (Vector3.new(-v17, v18, -v19))) },
            nTerrace = { getWorldPosition(p16, (Vector3.new(v17, v18, v19))), getWorldPosition(p16, (Vector3.new(-v17, v18, v19))) },
            wTerrace = { getWorldPosition(p16, (Vector3.new(-v17, v18, -v19))), getWorldPosition(p16, (Vector3.new(-v17, v18, v19))) },
            eTerrace = { getWorldPosition(p16, (Vector3.new(v17, v18, -v19))), getWorldPosition(p16, (Vector3.new(v17, v18, v19))) }
        };
    end
};

function u20.getSurfaces(p21) -- Line: 131
    -- upvalues: u20 (copy), u1 (copy)
    local v22 = u20.getLines(p21);
    local v23 = {
        Top = getSurfaceCFrame(p21, Vector3.new(0, 1, 0)).LookVector,
        Bottom = getSurfaceCFrame(p21, Vector3.new(0, -1, 0)).LookVector,
        Left = getSurfaceCFrame(p21, Vector3.new(-1, 0, 0)).LookVector,
        Right = getSurfaceCFrame(p21, Vector3.new(1, 0, 0)).LookVector,
        Front = getSurfaceCFrame(p21, Vector3.new(0, 0, 1)).LookVector,
        Back = getSurfaceCFrame(p21, Vector3.new(0, 0, -1)).LookVector
    };
    local v24 = {};

    for i, v in pairs({
        [u1.Top] = { "sTerrace", "nTerrace", "eTerrace", "wTerrace" },
        [u1.Bottom] = { "sBorder", "nBorder", "eBorder", "wBorder" },
        [u1.Right] = { "seColumn", "neColumn", "eBorder", "eTerrace" },
        [u1.Left] = { "swColumn", "nwColumn", "wBorder", "wTerrace" },
        [u1.Front] = { "neColumn", "nwColumn", "nBorder", "nTerrace" },
        [u1.Back] = { "seColumn", "swColumn", "sBorder", "sTerrace" }
    }) do
        local v25 = {};

        for _, v2 in pairs(v) do
            table.insert(v25, v22[v2]);
        end;
