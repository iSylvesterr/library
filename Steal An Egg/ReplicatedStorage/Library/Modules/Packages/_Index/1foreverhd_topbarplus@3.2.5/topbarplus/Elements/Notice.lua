...
return function(u1, u2) -- Line: 1
    ...
    u1.noticeChanged:Connect(function(p3) -- Line: 42
    ...
    u1.noticeStarted:Connect(function(p7, p8) -- Line: 68
        ...
        u11:add(u1.endNotices:Connect(function() -- Line: 79
            -- upvalues: u12 (copy)
            u12:Fire();
        end));
        u11:add(v9:Connect(function() -- Line: 82
            -- upvalues: u12 (copy)
            u12:Fire();
        end));
        ...
        local function updateNotice() -- Line: 90
            -- upvalues: u1 (ref)
