...
function u1.getThemeValue(p2, p3, p4, p5) -- Line: 12
    if p2 then
...
function u1.getInstanceValue(u9, u10) -- Line: 24
...
function u1.getRealInstance(p11) -- Line: 34
...
function u1.getClippedClone(p12) -- Line: 45
...
function u1.refresh(p13, p14, p15) -- Line: 56
    -- upvalues: u1 (copy)
    if p15 then
...
function u1.apply(p25, p26, u27, u28, p29) -- Line: 90
    -- upvalues: u1 (copy)
    ...
    for _, v in pairs(v30) do
        if u27 ~= "Position" or not u1.getClippedClone(v) then
            if (u27 ~= "Size" or not u1.getRealInstance(v)) and (p29 or u28 ~= u1.getInstanceValue(v, u27)) then
                ...
                if not pcall(function() -- Line: 136
...
function u1.getModifications(p34) -- Line: 150
    return typeof(p34[1]) ~= "table" and { p34 } or p34;
end;

function u1.merge(p35, p36, p37) -- Line: 159
    -- upvalues: u1 (copy)
...
function u1.modify(u45, u46, u47) -- Line: 176
    ...
    task.spawn(function() -- Line: 184
        ...
        for _, v in pairs(u46) do
            ...
            local function nowSetIt() -- Line: 196
...
function u1.remove(p55, p56) -- Line: 221
    -- upvalues: u1 (copy)
...
function u1.removeWith(p57, p58, p59, p60) -- Line: 234
    -- upvalues: u1 (copy)
...
function u1.change(p62) -- Line: 250
    -- upvalues: u1 (copy)
...
function u1.set(u67, p68) -- Line: 260
    -- upvalues: u1 (copy)
    local themesJanitor = u67.themesJanitor;
    themesJanitor:clean();
    themesJanitor:add(u67.stateChanged:Connect(function() -- Line: 266
...
function u1.statesMatch(p69, p70) -- Line: 276
    local v71;
