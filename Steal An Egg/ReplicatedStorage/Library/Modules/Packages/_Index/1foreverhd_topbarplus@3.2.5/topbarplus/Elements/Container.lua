...
return function(u3) -- Line: 3
    ...
    local function checkInset(p11) -- Line: 15
        -- upvalues: GuiService (copy), u3 (copy), u10 (ref), checkInset (copy), u1 (ref), u7 (ref), u6 (copy), u8 (ref), u9 (ref), u5 (copy), u2 (ref)
        ...
        if Height == 0 and p11 == nil then
            task.delay(5, function() -- Line: 26
                -- upvalues: checkInset (ref)
                checkInset("ForceConvertToOld");
            end);
        elseif u10 == 1 then
            task.delay(5, function() -- Line: 30
                -- upvalues: u10 (ref), checkInset (ref)
                if u10 == 1 then
                    checkInset();
                end;
            end);
    ...
    u3.baseDisplayOrderChanged:Connect(function() -- Line: 101
    ...
    local function updateCenteredHoldersHeight() -- Line: 118
    ...
    u3.baseDisplayOrderChanged:Connect(function() -- Line: 123
    ...
    u3.baseDisplayOrderChanged:Connect(function() -- Line: 142
