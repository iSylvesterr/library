...
local function getPromiseReference() -- Line: 24
    return false;
end;

local u1 = newproxy(true);

getmetatable(u1).__tostring = function() -- Line: 29
    return "IndicesReference";
end;

local u2 = newproxy(true);

getmetatable(u2).__tostring = function() -- Line: 34
...
function u3.__index.Add(p7, p8, p9, p10) -- Line: 69
...
function u3.__index.AddPromise(p14, u15) -- Line: 108
    local v16 = false;
    ...
    local v21 = p14:Add(v16.new(function(p18, p19, p20) -- Line: 117
        -- upvalues: u15 (copy)
        if p20(function() -- Line: 118
            -- upvalues: u15 (ref)
            u15:cancel();
        end) then
            return;
...
function u3.__index.AddObject(p22, p23) -- Line: 142
...
function u3.__index.Remove(p27, p28) -- Line: 160
    -- upvalues: u1 (copy)
    local v29 = p27[u1];
...
function u3.__index.Get(p33, p34) -- Line: 189
    -- upvalues: u1 (copy)
    local v35 = p33[u1];
...
function u3.__index.Cleanup(p36) -- Line: 197
    -- upvalues: u1 (copy)
        ...
        for i, v in next, p36 do
            if i ~= u1 then
                ...
                if v37 == "string" or v37 == "number" then
                    ...
                    local function warnUser(p40) -- Line: 214
                        -- upvalues: u39 (copy)
...
function u3.__index.Destroy(p47) -- Line: 261
    p47:Cleanup();
end;
...
function u48.Disconnect(p49) -- Line: 271
...
function u48.__tostring(p50) -- Line: 278
    return "Disconnect<" .. tostring(p50.Connected) .. ">";
end;

function u3.__index.LinkToInstance(u51, p52, p53) -- Line: 282
    ...
    u54 = p52.AncestryChanged:Connect(function(p58, p59) -- Line: 288, Name: ChangedFunction
        -- upvalues: u57 (copy), u56 (ref), Heartbeat (ref), u54 (ref), u51 (copy)
        u56 = u57.Connected and p59 == nil;

        if u56 then
            coroutine.wrap(function() -- Line: 294
...
function u3.__index.LinkToInstances(p60, ...) -- Line: 325
    -- upvalues: u3 (copy)
    local v61 = u3.new();
