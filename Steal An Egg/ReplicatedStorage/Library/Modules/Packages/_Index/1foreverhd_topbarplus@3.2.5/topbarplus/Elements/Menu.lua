...
return function(u1) -- Line: 1
    ...
    u1.menuChildAdded:Connect(function() -- Line: 38, Name: totalChildrenChanged
        ...
        u3 = true;
        menuJanitor:add(u1.toggled:Connect(function() -- Line: 51
            -- upvalues: u1 (ref)
        ...
        task.defer(function() -- Line: 61
            ...
            menuJanitor:add(function() -- Line: 62
        ...
        local function rightAlignCanvas() -- Line: 71
        ...
        menuJanitor:add(u1.alignmentChanged:Connect(function() -- Line: 102, Name: updateAlignent
        ...
        u9.LayoutOrder = v13;
        ScrollingFrame:GetAttributeChangedSignal("MenuCanvasWidth"):Connect(function() -- Line: 118
        ...
        menuJanitor:add(u1.updateMenu:Connect(function() -- Line: 123
        ...
        local function startMenuUpdate() -- Line: 150
            -- upvalues: u1 (ref)
    ...
    u1.menuSet:Connect(function(p21) -- Line: 163
