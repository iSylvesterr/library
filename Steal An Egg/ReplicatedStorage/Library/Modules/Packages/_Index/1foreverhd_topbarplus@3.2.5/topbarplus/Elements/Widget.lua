...
return function(u1, u2) -- Line: 6
    ...
    Frame2.Active = false;
    u1.deselected:Connect(function() -- Line: 24
        -- upvalues: Frame2 (copy), u1 (copy)
        Frame2.ClipsDescendants = true;
        task.delay(0.2, function() -- Line: 26
    ...
    u1:setBehaviour("IconButton", "BackgroundTransparency", function(p3) -- Line: 35
    ...
    u1.janitor:add(GuiService:GetPropertyChangedSignal("PreferredTransparency"):Connect(function() -- Line: 43
    ...
    local function handleLabelAndImageChangesUnstaggered(p9) -- Line: 194
        ...
        task.defer(function() -- Line: 200
            ...
            local function getItemWidth(p13) -- Line: 230
            ...
            for i = 1, v33.Time * 100 do
                task.delay(i / 100, function() -- Line: 312
                    -- upvalues: u2 (ref), u1 (ref)
                    u2.iconChanged:Fire(u1);
                end);
            end;

            task.delay(v33.Time - 0.2, function() -- Line: 316
    ...
    u1:setBehaviour("IconLabel", "FontFace", function(p37) -- Line: 331
    ...
    local function updateBorderSize() -- Line: 358
