...
return function(u2) -- Line: 3
    ...
    Frame:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 144
    ...
    captionJanitor:add(CanvasGroup:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 154, Name: matchSize
    ...
    local function updateHotkey(p6) -- Line: 165
    ...
    local function getCaptionPosition(p11) -- Line: 191
        -- upvalues: u5 (ref)
        if p11 == nil then
            p11 = u5;
        end;
    ...
    local function updatePosition(p12) -- Line: 198
        ...
        local function updateCaret() -- Line: 226
        ...
        v20:Play();
        v20.Completed:Once(function() -- Line: 252
            -- upvalues: u21 (copy)
            u21:Disconnect();
        end);
    end;

    captionJanitor:add(u3:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 256
    ...
    local function setCaptionEnabled(p26) -- Line: 272
    ...
    captionJanitor:add(u2.stateChanged:Connect(function(p29) -- Line: 297
        ...
        task.delay(v30, function() -- Line: 302
