...
return function(u1, p2) -- Line: 1
    ...
    local function selectionChanged() -- Line: 27
    ...
    local function setIndicatorVisible(p5) -- Line: 57
    ...
    u1.indicatorSet:Connect(function(p6) -- Line: 73
    ...
    widget:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 82, Name: updateSize
