...
function u1.start(p10) -- Line: 21
    ...
    local u12 = false;
    local u14 = Utility.createStagger(0.1, function(p13) -- Line: 39
    ...
    CurrentCamera:GetPropertyChangedSignal("ViewportSize"):Connect(function() -- Line: 63
        -- upvalues: u14 (copy)
        u14(true);
    end);
    v11:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 66
        -- upvalues: u14 (copy)
        u14(true);
    end);
end;

function u1.getWidth(p15, p16) -- Line: 71
    local widget = p15.widget;

    return widget:GetAttribute("TargetWidth") or widget.AbsoluteSize.X;
end;

function u1.getAvailableIcons(p17) -- Line: 76
    -- upvalues: u3 (copy), u1 (copy)
    return u3[p17] or u1.updateAvailableIcons(p17);
end;

function u1.updateAvailableIcons(p18) -- Line: 84
    ...
    for _, v in pairs(u4) do
        ...
        if (not parentIconUID or u6[parentIconUID]) and (v.alignment == p18 and not u6[v.UID]) then
            table.insert(v20, v);
            v19 = v19 + 1;
        end;
    end;
    ...
    table.sort(v20, function(p21, p22) -- Line: 105
...
function u1.getRealXPositions(p23, p24) -- Line: 131
...
function u1.updateBoundary(u31) -- Line: 160
    ...
    local function checkToShiftCentralIcon() -- Line: 223
        ...
        local function secondaryCheck() -- Line: 227
