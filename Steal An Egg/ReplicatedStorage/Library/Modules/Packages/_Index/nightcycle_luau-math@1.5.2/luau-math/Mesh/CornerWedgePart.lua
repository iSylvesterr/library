...
function getSurfaceCFrame(p2, p3)
    ...
    local v9 = (function(p5, p6, p7) -- Line: 25, Name: getTranstionBetween
        local v8 = p5:Dot(p6);
...
local u20 = {
    getVertices = function(p12) -- Line: 45, Name: getVertices
...
function u20.getSurfaces(p21) -- Line: 102
    ...
    local v25 = {
        [Enum.NormalId.Top] = getSurfaceCFrame(p21, (Vector3.new(0, 0, 1)):Lerp(Vector3.new(0, 1, 0), (math.cos(v23)))).LookVector,
        [Enum.NormalId.Bottom] = getSurfaceCFrame(p21, Vector3.new(0, -1, 0)).LookVector,
        [Enum.NormalId.Left] = getSurfaceCFrame(p21, Vector3.new(1, 0, 0)).LookVector,
        [Enum.NormalId.Right] = getSurfaceCFrame(p21, (Vector3.new(-1, 0, 0)):Lerp(Vector3.new(0, 1, 0), (math.cos(v24)))).LookVector,
        [Enum.NormalId.Back] = getSurfaceCFrame(p21, Vector3.new(0, 0, -1)).LookVector
    };
    local v26 = {};

    for i, v in pairs({
        [u1.Front] = { "nBorder", "eTerrace", "wTerrace" },
