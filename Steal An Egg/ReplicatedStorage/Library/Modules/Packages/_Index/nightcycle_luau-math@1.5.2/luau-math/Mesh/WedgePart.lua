...
local u20 = {
    ...
    getLines = function(p16) -- Line: 61, Name: getLines
...
function u20.getSurfaces(p21) -- Line: 106
    -- upvalues: u20 (copy), u1 (copy)
    local v22 = u20.getLines(p21);
    local v23 = math.atan2(p21.Size.Y, p21.Size.Z);
    local v24 = {
        [u1.Top] = getSurfaceCFrame(p21, (Vector3.new(0, 0, -1)):Lerp(Vector3.new(0, 1, 0), (math.cos(v23)))).LookVector,
        [u1.Bottom] = getSurfaceCFrame(p21, Vector3.new(0, -1, 0)).LookVector,
        [u1.Left] = getSurfaceCFrame(p21, Vector3.new(-1, 0, 0)).LookVector,
        [u1.Right] = getSurfaceCFrame(p21, Vector3.new(1, 0, 0)).LookVector,
        [u1.Back] = getSurfaceCFrame(p21, Vector3.new(0, 0, 1)).LookVector
    };
    local v25 = {};

    for i, v in pairs({
        [u1.Top] = { "sTerrace", "nBorder", "eTerrace", "wTerrace" },
        [u1.Bottom] = { "sBorder", "nBorder", "eBorder", "wBorder" },
        [u1.Right] = { "seColumn", "eBorder", "eTerrace" },
