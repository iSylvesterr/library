...
function u1.new(p2, p3, p4, p5) -- Line: 32
    ...
    u10.Connection = RunService.Heartbeat:Connect(function(p11) -- Line: 70
        -- upvalues: u10 (copy)
        debug.profilebegin("Stroke :: Update");
        ...
        if u10.Instance.StrokeSizingMode ~= Enum.StrokeSizingMode.ScaledSize then
...
function u1.SetSize(p12, p13, p14) -- Line: 99
...
function u1.SetTransparency(p17, p18, p19) -- Line: 109
...
function u1.SetColor(p22, p23, p24) -- Line: 119
...
function u1.Pause(p27) -- Line: 129
    p27.IsPaused = true;
end;

function u1.Resume(p28) -- Line: 133
    p28.IsPaused = false;
end;

function u1.Destroy(p29) -- Line: 137
