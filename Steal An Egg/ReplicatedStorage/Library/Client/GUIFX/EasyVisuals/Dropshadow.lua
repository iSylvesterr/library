...
function u1.new(p2, p3, p4, p5) -- Line: 30
    ...
    u10.Connection = RunService.Heartbeat:Connect(function(p11) -- Line: 78
        -- upvalues: u10 (copy)
        debug.profilebegin("DropShadow :: Update");
...
function u1.SetOffset(p12, p13, p14) -- Line: 111
...
function u1.SetTransparency(p17, p18, p19) -- Line: 121
...
function u1.SetColor(p22, p23, p24) -- Line: 131
...
function u1.Pause(p27) -- Line: 141
    p27.IsPaused = true;
end;

function u1.Resume(p28) -- Line: 145
    p28.IsPaused = false;
end;

function u1.Destroy(p29) -- Line: 149
