...
function processBlocks(p2, p3, p4, p5)
    ...
    for i = p4, p5, 64 do
        ...
        v7 = bit32.bor(v7 + v21, 0);
        v8 = bit32.bor(v8 + v23, 0);
        v9 = bit32.bor(v9 + v22, 0);
        v10 = bit32.bor(v10 + v20, 0);
...
local v52 = {
    ...
    Digest = function(p50) -- Line: 152, Name: Digest
        return buffer.tostring(sha1(p50));
    end,

    DigestBuffer = function(p51) -- Line: 155, Name: DigestBuffer
