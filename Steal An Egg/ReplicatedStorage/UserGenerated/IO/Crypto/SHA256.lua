...
function processBlocks(p3, p4, p5, p6)
    ...
    for i = p5, p6, 64 do
        ...
        v8 = bit32.bor(v8 + v34, 0);
        v9 = bit32.bor(v9 + v33, 0);
        v10 = bit32.bor(v10 + v32, 0);
        v11 = bit32.bor(v11 + v36, 0);
        v12 = bit32.bor(v12 + v39, 0);
        v13 = bit32.bor(v13 + v38, 0);
        v14 = bit32.bor(v14 + v37, 0);
        v15 = bit32.bor(v15 + v35, 0);
    end;
...
function sha256(p53)
    local v54 = { 1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225 };
    local v55 = #p53;
    local v56 = v55 % 64;
    ...
    local v68 = bit32.byteswap(v54[8]);
    buffer.writeu32(v60, 28, v68);
...
local v71 = {
    ...
    Digest = function(p69) -- Line: 171, Name: Digest
        return buffer.tostring(sha256(p69));
    end,

    DigestBuffer = function(p70) -- Line: 174, Name: DigestBuffer
        return sha256(buffer.tostring(p70));
    end,
