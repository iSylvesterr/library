...
local function Unpack64(p24) -- Line: 52
    if p24 >= 0 then
...
local function ParseUUID(p26) -- Line: 65
...
return table.freeze({
    ...
    DoubleFromInt64 = function(p34, p35) -- Line: 60, Name: DoubleFromInt64
        -- upvalues: Mix (copy)
        local v36, v37;
    ...
    DoubleFromUUID = function(p39, p40) -- Line: 71, Name: DoubleFromUUID
        -- upvalues: Mix (copy)
    ...
    IntegerFromUUID = function(p49, p50, p51, p52) -- Line: 76, Name: IntegerFromUUID
        -- upvalues: Mix (copy)
