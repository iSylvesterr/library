...
local function nonPad(p2) -- Line: 26
    return p2;
end;
...
local function anxPad(p3, p4, p5) -- Line: 41
...
local function anxUnpad(p12, p13, p14) -- Line: 59
...
local function i10Pad(p20, p21, p22) -- Line: 82
...
local function i10Unpad(p26, p27, p28) -- Line: 97
    -- upvalues: len (copy), readu8 (copy), create (copy), copy (copy)
    local v29 = len(p26);
...
local function pksPad(p34, p35, p36) -- Line: 115
...
local function pksUnpad(p41, p42, p43) -- Line: 128
    -- upvalues: len (copy), readu8 (copy), create (copy), copy (copy)
    local v44 = len(p41);
...
local function ii7Pad(p49, p50, p51) -- Line: 151
...
local function ii7Unpad(p54, p55, p56) -- Line: 163
    -- upvalues: len (copy), readu8 (copy), create (copy), copy (copy)
    local v57 = len(p54) - 1;
...
local function zroPad(p60, p61, p62) -- Line: 188
...
local function zroUnpad(p65, p66, p67) -- Line: 199
    -- upvalues: len (copy), readu8 (copy), create (copy), copy (copy)
    local v68 = len(p65) - 1;
...
local v73 = {
    __index = function(p71, p72) -- Line: 220, Name: __index
    ...
    __newindex = function() -- Line: 249, Name: __newindex
    end
};
setmetatable(v1, v73);
v1.AnsiX923 = {};
