...
local function addByteCtr(p2, p3, p4, p5, p6) -- Line: 44
...
local v21 = {
    ECB = {
        FwdMode = function(p11, p12, p13, p14) -- Line: 81, Name: FwdMode
            -- upvalues: len (copy)
        ...
        InvMode = function(p16, p17, p18, p19) -- Line: 88, Name: InvMode
            -- upvalues: len (copy)
...
v21.CBC = {
    FwdMode = function(p22, p23, p24, p25, p26, p27) -- Line: 105, Name: FwdMode
    ...
    InvMode = function(p31, p32, p33, p34, p35, p36) -- Line: 123, Name: InvMode
        -- upvalues: len (copy), u1 (copy), readu32 (copy), bxor (copy), writeu32 (copy)
...
v21.PCBC = {
    FwdMode = function(p48, p49, p50, p51, p52, p53) -- Line: 161, Name: FwdMode
        -- upvalues: len (copy), u1 (copy), readu32 (copy), bxor (copy), writeu32 (copy)
    ...
    InvMode = function(p65, p66, p67, p68, p69, p70) -- Line: 189, Name: InvMode
        -- upvalues: len (copy), u1 (copy), readu32 (copy), bxor (copy), writeu32 (copy)
...
local function cfbFwd(p90, p91, p92, p93, p94, p95) -- Line: 243
...
local function cfbInv(p104, p105, p106, p107, p108, p109) -- Line: 284
    -- upvalues: len (copy), u1 (copy), create (copy), readu8 (copy), bxor (copy), writeu8 (copy), copy (copy)
    local v110 = len(p106);
...
local function ofbMode(p118, p119, p120, p121, p122, p123) -- Line: 334
    -- upvalues: len (copy), u1 (copy), readu32 (copy), bxor (copy), writeu32 (copy)
...
local function ctrMode(p139, p140, p141, p142, p143) -- Line: 391
...
local v157 = {
    __index = function(p155, p156) -- Line: 442, Name: __index
    ...
    __newindex = function() -- Line: 472, Name: __newindex
    end
};
