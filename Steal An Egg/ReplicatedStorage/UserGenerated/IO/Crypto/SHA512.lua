...
function processBlocks(p63, p64, p65, p66, p67)
    ...
    for i = p66, p67, 128 do
        ...
        local v142 = v114 + v78;
        v70 = bit32.bor(v113 + v70 + v142 // 4294967296, 0);
        v78 = bit32.bor(v142, 0);
        local v143 = v120 + v79;
        v71 = bit32.bor(v119 + v71 + v143 // 4294967296, 0);
...
local v163 = {
    ...
    Digest = function(p161) -- Line: 341, Name: Digest
        return buffer.tostring(sha512(p161));
    end,

    DigestBuffer = function(p162) -- Line: 344, Name: DigestBuffer
