...
function v1.Get(p3) -- Line: 45
    return p3.Value;
end;

function v1.GetAsync(p4) -- Line: 48
    if p4.ValueLoaded then
        return p4.Value;
    end;

    local u5 = coroutine.running();
    local v6 = p4.Loaded:Connect(function() -- Line: 53
        -- upvalues: u5 (copy)
        task.spawn(u5);
    end);
    coroutine.yield();
...
function v1.IsLoaded(p7) -- Line: 60
...
local function DecodeValue(p12) -- Line: 86
...
local function Create(p13, p14, p15) -- Line: 135
    ...
    p14(p15);
    Asserts.Optional(Asserts.Storable)(p15);
...
local v35 = {
    ...
    IsA = function(p23) -- Line: 64, Name: IsA
        -- upvalues: u2 (copy)
        local v24;
    ...
    Assert = function(p25) -- Line: 68, Name: Assert
        -- upvalues: u2 (copy)
        local v26;
    ...
    Replicated = function(p27, p28, p29) -- Line: 187, Name: Replicated
        -- upvalues: Create (copy)
        return Create(p27, p28, p29);
    end,

    Private = function(p30, p31, p32) -- Line: 191, Name: Private
        error("ServerOnly");
    end,

    Get = function(p33) -- Line: 195, Name: Get
    ...
    IsLoaded = function() -- Line: 204, Name: IsLoaded
        -- upvalues: u9 (ref)
        return u9;
    end
};
UpdateRemote.OnClientEvent:Connect(function(p36, p37) -- Line: 90, Name: SetContent
