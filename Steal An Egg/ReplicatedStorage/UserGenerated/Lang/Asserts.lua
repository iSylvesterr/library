...
local function LuaString(p9) -- Line: 72
    local v10, _ = string.format("%q", p9):gsub("\n", "n");

    return v10;
end;

local function StringRep(p11) -- Line: 77
...
local function SafeKeyStringRep(p13) -- Line: 86
...
local function StripErrorSource(p20) -- Line: 107
...
local function ParseError(p24) -- Line: 118
...
local function MakeError(p30, p31) -- Line: 130
    return `{p30} ${p31}`;
end;
...
local u53 = {
    ...
    IsVector2Finite = function(p47) -- Line: 64, Name: IsVector2Finite
    ...
    IsVector3Finite = function(p50) -- Line: 68, Name: IsVector3Finite
...
function u53.Array(u54) -- Line: 140
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u54);

    return function(p55) -- Line: 142
...
function u53.ArrayCoerce(u63) -- Line: 172
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u63);

    return function(p64) -- Line: 174
...
function u53.UniqueArray(u73) -- Line: 206
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u73);

    return function(p74) -- Line: 208
...
function u53.UniqueArrayCoerce(u83) -- Line: 246
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u83);

    return function(p84) -- Line: 248
...
function u53.Map(u94, u95, p96) -- Line: 289
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u94);
    u53.Function(u95);
...
function u53.MapCoerce(u110, u111, p112) -- Line: 324
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
    u53.Function(u110);
    u53.Function(u111);
...
function u53.Table(p127) -- Line: 365
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
...
function u53.TablePermissive(p138) -- Line: 399
    -- upvalues: u53 (copy)
...
function u53.TableCoerce(p149) -- Line: 434
    -- upvalues: u53 (copy), SafeKeyStringRep (copy)
...
function u53.IsASCII(p161) -- Line: 470
    local v162;
...
function u53.IsFinite(p164) -- Line: 473
    local v165;
...
function u53.IsInteger(p166) -- Line: 476
    local v167;
...
function u53.IsCFrameFinite(p168) -- Line: 479
    local v169;
...
function u53.IsVector2Finite(p183) -- Line: 482
    local v184;
...
function u53.Optional(u186) -- Line: 486
    if type(u186) ~= "function" then
        error("function", 2);
    end;

    return function(p187) -- Line: 490
        -- upvalues: u186 (copy)
        if p187 == nil then
            return nil;
        end;
...
function u53.Default(u192, p193) -- Line: 502
...
function u53.AnyTable(p210) -- Line: 554
...
function u53.Number(p211) -- Line: 560
...
function u53.Boolean(p212) -- Line: 566
...
function u53.Buffer(p213) -- Line: 572
...
function u53.Function(p214) -- Line: 578
...
function u53.Thread(p215) -- Line: 584
...
function u53.String(p216) -- Line: 591
...
function u53.RawString(p217) -- Line: 601
...
function u53.Any(p218) -- Line: 608
    return p218;
end;

function u53.Equals(u219) -- Line: 612
    return function(p220) -- Line: 613
        -- upvalues: u219 (copy)
        local v221 = u219;
...
function u53.Set(p222) -- Line: 621
    -- upvalues: u53 (copy)
    u53.Array(u53.Any);
    local u223 = {};
...
function u53.Pattern(u225) -- Line: 641
    -- upvalues: u53 (copy)
    u53.String(u225);

    return function(p226) -- Line: 643
        -- upvalues: u225 (copy)
...
function u53.NoMetatable(p227) -- Line: 657
...
function u53.Finite(p228) -- Line: 668
...
function u53.FinitePositive(p230) -- Line: 679
...
function u53.FiniteNonNegative(p232) -- Line: 693
...
function u53.Positive(p234) -- Line: 707
...
function u53.NonNegative(p235) -- Line: 718
...
function u53.Real(p236) -- Line: 729
...
function u53.Range(u237, u238) -- Line: 740
    -- upvalues: u53 (copy)
    u53.Real(u237);
    u53.Real(u238);
...
function u53.Integer(p240) -- Line: 758
...
function u53.Unsigned32(p242) -- Line: 769
...
function u53.IntegerPositive(p243) -- Line: 778
...
function u53.Index(p245) -- Line: 792
...
function u53.IntegerNonNegative(p247) -- Line: 806
...
function u53.IntegerRange(u249, u250) -- Line: 820
    -- upvalues: u53 (copy)
    u53.Integer(u249);
    u53.Integer(u250);
...
function u53.UInt32() -- Line: 840
    return function(p253) -- Line: 841
...
function u53.StringRange(u254, u255) -- Line: 853
    -- upvalues: u53 (copy)
    u53.Integer(u254);
    u53.Integer(u255);
...
function u53.ASCII(p258) -- Line: 874
...
function u53.ASCIIRange(u260, u261) -- Line: 888
    -- upvalues: u53 (copy)
    u53.Integer(u260);
    u53.Integer(u261);
...
function u53.CFrame(p265) -- Line: 912
...
function u53.CFrameFinite(p266) -- Line: 918
...
function u53.Vector2(p281) -- Line: 927
...
function u53.Vector2Finite(p282) -- Line: 933
...
function u53.Vector2Unit(p285) -- Line: 942
...
function u53.Vector3(p288) -- Line: 954
...
function u53.Vector3Finite(p289) -- Line: 960
...
function u53.Vector3Unit(p292) -- Line: 969
...
function u53.Vector3Positive(p295) -- Line: 981
...
function u53.Vector3int16(p298) -- Line: 993
...
function u53.Vector2int16(p299) -- Line: 999
...
function u53.Region3(p300) -- Line: 1005
...
function u53.Region3int16(p301) -- Line: 1011
...
function u53.UDim(p302) -- Line: 1017
...
function u53.UDim2(p303) -- Line: 1023
...
function u53.Rect(p304) -- Line: 1029
...
function u53.PhysicalProperties(p305) -- Line: 1035
...
function u53.Storable(p306, p307) -- Line: 1044
...
function u53.Networkable(p322, p323) -- Line: 1150
...
function u53.Enum(u337) -- Line: 1210
    if typeof(u337) ~= "Enum" then
        error("Enum", 2);
    end;

    return function(p338) -- Line: 1214
        -- upvalues: u337 (copy)
...
function u53.EnumValue(p339) -- Line: 1225
    ...
    return function(p341) -- Line: 1233
        -- upvalues: u340 (copy)
...
function u53.Player(p342) -- Line: 1244
...
function u53.BasePart(p343) -- Line: 1250
...
function u53.Part(p344) -- Line: 1256
...
function u53.MeshPart(p345) -- Line: 1262
...
function u53.Model(p346) -- Line: 1268
...
function u53.Animation(p347) -- Line: 1274
...
function u53.Humanoid(p348) -- Line: 1280
...
function u53.ParticleEmitter(p349) -- Line: 1286
...
function u53.Sound(p350) -- Line: 1292
...
function u53.Instance(p351) -- Line: 1298
...
function u53.InstanceOf(u352) -- Line: 1306
    -- upvalues: u53 (copy)
    u53.String(u352);

    return function(p353) -- Line: 1308
        -- upvalues: u352 (copy)
...
function u53.InstanceClass(u354) -- Line: 1319
    -- upvalues: u53 (copy)
    u53.String(u354);

    return function(p355) -- Line: 1321
        -- upvalues: u354 (copy)
...
function u53.HexLower(p356) -- Line: 1332
...
function u53.HexUpper(p358) -- Line: 1346
...
function u53.UUIDStripped(p360) -- Line: 1360
...
function u53.UUID(p363) -- Line: 1378
...
function u53.Base64(p364) -- Line: 1391
...
function u53.ToNumber(u365) -- Line: 1404
    return function(p366) -- Line: 1405
        -- upvalues: u365 (copy)
...
function u53.IsoDate(p372) -- Line: 1418
