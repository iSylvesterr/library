...
local function ErrorHandler(p1) -- Line: 96
    warn((`{tostring(p1)}\nStack Begin\n{debug.traceback(nil, 3)}Stack End`));
end;

local function WCall(p2, ...) -- Line: 100
    -- upvalues: ErrorHandler (copy)
    return xpcall(p2, ErrorHandler, ...);
end;

local function FindRight(p3, p4) -- Line: 108
    local v5 = #p3;
    local v6 = 1;
    local v7 = false;
...
local function FindLeft(p10, p11) -- Line: 132
    local v12 = #p10;
    local v13 = 1;
    local v14 = false;
...
local function InsertRight(p17, p18) -- Line: 155
...
local function Remove(p21, p22) -- Line: 165
...
local function Connection_Disconnect(p24) -- Line: 183
...
local v27 = table.freeze({
    IsConnected = function(p25) -- Line: 179, Name: Connection_IsConnected
        return p25.Ow ~= nil;
    end,

    Disconnect = Connection_Disconnect,

    GetPriority = function(p26) -- Line: 197, Name: Connection_GetPriority
        return p26.Pr;
    end
});
...
local function Connection_new(p29, p30, p31) -- Line: 208
    -- upvalues: u28 (copy)
    return setmetatable({
        Ow = p29,
        Cb = p30,
...
local v74 = table.freeze({
    Fire = function(p32, ...) -- Line: 250, Name: Bindable_Fire
        local Cs = p32.Cs;
        local v33 = 1;
    ...
    FireAndWait = function(p35, ...) -- Line: 264, Name: Bindable_FireAndWait
        -- upvalues: WCall (copy)
        local Cs = p35.Cs;
        ...
        local function executor(p38, ...) -- Line: 271
    ...
    FireSync = function(p41, ...) -- Line: 293, Name: Bindable_FireSync
        -- upvalues: WCall (copy)
        local Cs = p41.Cs;
        local v42 = 1;
    ...
    Invoke = function(p44, ...) -- Line: 305, Name: Bindable_Invoke
        local Cs = p44.Cs;
    ...
    Connect = function(p45, p46, p47) -- Line: 234, Name: Bindable_Connect
    ...
    Wait = function(p53) -- Line: 316, Name: Bindable_Wait
        -- upvalues: Connection_Disconnect (copy), u28 (copy)
        local u54 = coroutine.running();
        local u55 = true;
        local u56 = nil;

        local function v58(...) -- Line: 320
    ...
    Once = function(p61, u62, p63) -- Line: 337, Name: Bindable_Once
        -- upvalues: Connection_Disconnect (copy), u28 (copy), FindRight (copy)
        local u64 = nil;

        local function v65(...) -- Line: 343
    ...
    DisconnectAll = function(p71) -- Line: 350, Name: Bindable_DisconnectAll
    ...
    GetSize = function(p72) -- Line: 357, Name: Bindable_GetSize
        return #p72.Cs;
    end,

    IsEmpty = function(p73) -- Line: 361, Name: Bindable_IsEmpty
        return #p73.Cs == 0;
    end
});
...
return table.freeze({
    new = function(p76) -- Line: 379, Name: new
        -- upvalues: u75 (copy)
    ...
    IsA = function(p77) -- Line: 386, Name: IsA
        -- upvalues: u75 (copy)
        local v78;
    ...
    Assert = function(p79) -- Line: 390, Name: Assert
        -- upvalues: u75 (copy)
        local v80;
    ...
    IsAConnection = function(p81) -- Line: 222, Name: Connection_IsA
        -- upvalues: u28 (copy)
        local v82;
    ...
    AssertConnection = function(p83) -- Line: 226, Name: Connection_Assert
        -- upvalues: u28 (copy)
        local v84;
