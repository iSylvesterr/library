...
local function AttemptAge(p3, p4) -- Line: 43
...
local v18 = {
    RemoveUsedAt = function(p5, p6) -- Line: 83, Name: RemoveUsedAt
    end,

    InsertUsedAt = function(p7, p8) -- Line: 87, Name: InsertUsedAt
    end,

    SetUsedAt = function(p9, p10, p11) -- Line: 91, Name: SetUsedAt
        p9:RemoveUsedAt(p10);
        p10.UsedAt = p11;
        p9:InsertUsedAt(p10);
    end,

    Get = function(p12, p13) -- Line: 100, Name: Get
...
function v18.GetAsync(p25, p26) -- Line: 142
    -- upvalues: Lock (copy)
    local v27 = os.clock();
...
function v18.Delete(p30, p31) -- Line: 160
...
return table.freeze({
    new = function(p35) -- Line: 196, Name: new
