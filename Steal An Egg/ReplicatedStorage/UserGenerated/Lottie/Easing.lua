...
local function NormalizeHandle(p27, p28) -- Line: 80
    return type(p27) ~= "number" and (p27[p28 or 1] or 0) or p27;
end;

local function LerpScalar(p29, p30, p31) -- Line: 90
    return p29 + (p30 - p29) * p31;
end;

local function LerpArray(p32, p33, p34) -- Line: 94
...
local function LerpBezierShape(p36, p37, p38) -- Line: 102
...
local function FindKeyframes(p48, p49) -- Line: 119
    local v50 = #p48;
...
local function ExtractValue(p53) -- Line: 145
    if p53 == nil then
        return nil;
    end;
...
local function Evaluate(p54, p55) -- Line: 161
...
return table.freeze({
    ...
    EvaluateScalar = function(p63, p64) -- Line: 242, Name: EvaluateScalar
    ...
    EvaluateScalarAtFrame = function(p66, p67, p68) -- Line: 259, Name: EvaluateScalarAtFrame
        -- upvalues: Evaluate (copy)
        if p66 == nil then
            return p68;
        end;
    ...
    EvaluateVector = function(p70, p71, p72) -- Line: 276, Name: EvaluateVector
        -- upvalues: Evaluate (copy)
        if p70 == nil then
            return p72;
        end;
    ...
    EvaluateColor = function(p74, p75) -- Line: 293, Name: EvaluateColor
        -- upvalues: Evaluate (copy)
        if p74 == nil then
    ...
    EvaluateBezierShape = function(p77, p78) -- Line: 308, Name: EvaluateBezierShape
        -- upvalues: Evaluate (copy)
        if p77 == nil then
            return nil;
        end;
