        ...
        while true do
            ...
            if v54 == 0 then
                ...
                local function readBit() -- Line: 167
                    -- upvalues: u35 (copy), u40 (ref), u45 (ref)
                    local v65 = buffer.readu8(u35, u40);
                    local v66 = bit32.extract(v65, u45);
                    u45 = u45 + 1;
                ...
                local function readBits(p67) -- Line: 177
                    -- upvalues: u35 (copy), u40 (ref), u45 (ref)
                    local v68 = buffer.readbits(u35, u40 * 8 + u45, p67);
                    u45 = u45 + p67;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                ...
                local function readHuffmanTable(p69) -- Line: 185
                    -- upvalues: u35 (copy), u40 (ref), u45 (ref)
                    local v70 = buffer.readu8(u35, u40);
                    local v71 = bit32.extract(v70, u45);
                    u45 = u45 + 1;
                    ...
                    while not p69[v72] do
                        local v73 = buffer.readu8(u35, u40);
                        local v74 = bit32.extract(v73, u45);
                        u45 = u45 + 1;
                ...
                while true do
                    local v76 = buffer.readu8(u35, u40);
                    v42 = bit32.extract(v76, u45);
                    u45 = u45 + 1;
                    ...
                    v75 = buffer.readbits(u35, u40 * 8 + u45, 2);
                    u45 = u45 + 2;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                    ...
                    local v77 = buffer.readu16(u35, u40);
                    local v78 = buffer.readu16(u35, u40 + 2);
                    local v79 = bit32.bxor(v77, v78) == 65535;
                    assert(v79, "len ~= nlen");
                    u40 = u40 + 4;
                    buffer.copy(p36, v38, u35, u40, v77);
                    v38 = v38 + v77;
                    u40 = u40 + v77;
                    ::l0::;
                    ...
                    if v42 == 1 then
                        ...
                        v37 = adler32(p36, 0, buffer.len(p36));
                        v43 = buffer.readu32(u35, u40);
                        v39 = v37 == bit32.byteswap(v43);
                        assert(v39, "adler-32 checksum mismatch");
                ...
                if v75 ~= 2 then
                    ::l2::;
                    v55 = 2;
                    v56 = buffer.readu8(u35, u40);
                    v57 = bit32.extract(v56, u45);
                    u45 = u45 + 1;
                ...
                local v80 = buffer.readbits(u35, u40 * 8 + u45, 5);
                u45 = u45 + 5;
                u40 = u40 + bit32.rshift(u45, 3);
                u45 = bit32.band(u45, 7);
                v41 = v80 + 257;
                local v81 = buffer.readbits(u35, u40 * 8 + u45, 5);
                u45 = u45 + 5;
                u40 = u40 + bit32.rshift(u45, 3);
                u45 = bit32.band(u45, 7);
                v48 = v81 + 1;
                local v82 = buffer.readbits(u35, u40 * 8 + u45, 4);
                u45 = u45 + 4;
                u40 = u40 + bit32.rshift(u45, 3);
                u45 = bit32.band(u45, 7);
                ...
                for i = 1, v82 + 4 do
                    local v84 = u15[i] + 1;
                    local v85 = buffer.readbits(u35, u40 * 8 + u45, 3);
                    u45 = u45 + 3;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                    v83[v84] = v85;
                ...
                v49 = createHuffmanTable(v83);
                v50 = table.create(v41);
                v46 = nil;
                v54 = 1;
                continue;
            elseif v54 == 1 then
                v54 = -1;
                local v86 = buffer.readu8(u35, u40);
                local v87 = bit32.extract(v86, u45);
                u45 = u45 + 1;
                ...
                while not v49[v88] do
                    local v89 = buffer.readu8(u35, u40);
                    local v90 = bit32.extract(v89, u45);
                    u45 = u45 + 1;
                ...
                if v91 <= 15 then
                    v46 = v91;
                elseif v91 == 16 then
                    local v93 = buffer.readbits(u35, u40 * 8 + u45, 2);
                    u45 = u45 + 2;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                    v92 = v93 + 3;
                elseif v91 == 17 then
                    v46 = 0;
                    local v94 = buffer.readbits(u35, u40 * 8 + u45, 3);
                    u45 = u45 + 3;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                    v92 = v94 + 3;
                elseif v91 == 18 then
                    v46 = 0;
                    local v95 = buffer.readbits(u35, u40 * 8 + u45, 7);
                    u45 = u45 + 7;
                    u40 = u40 + bit32.rshift(u45, 3);
                    u45 = bit32.band(u45, 7);
                    v92 = v95 + 11;
                ...
                for _ = 1, v92 do
                    table.insert(v50, v46);
                end;

                if v41 <= #v50 then
                    v44 = createHuffmanTable(v50);
                    local v96 = table.create(v48);
                    local v97 = nil;
                    local v98 = buffer.readu8(u35, u40);
                    local v99 = bit32.extract(v98, u45);
                    u45 = u45 + 1;
                    ...
                    while not v49[v100] do
                        local v101 = buffer.readu8(u35, u40);
                        local v102 = bit32.extract(v101, u45);
                        u45 = u45 + 1;
                    ...
                    if v103 <= 15 then
                        v97 = v103;
                    elseif v103 == 16 then
                        local v105 = buffer.readbits(u35, u40 * 8 + u45, 2);
                        u45 = u45 + 2;
                        u40 = u40 + bit32.rshift(u45, 3);
                        u45 = bit32.band(u45, 7);
                        v104 = v105 + 3;
                    elseif v103 == 17 then
                        v97 = 0;
                        local v106 = buffer.readbits(u35, u40 * 8 + u45, 3);
                        u45 = u45 + 3;
                        u40 = u40 + bit32.rshift(u45, 3);
                        u45 = bit32.band(u45, 7);
                        v104 = v106 + 3;
                    elseif v103 == 18 then
                        v97 = 0;
                        local v107 = buffer.readbits(u35, u40 * 8 + u45, 7);
                        u45 = u45 + 7;
                        u40 = u40 + bit32.rshift(u45, 3);
                        u45 = bit32.band(u45, 7);
                        v104 = v107 + 11;
            ...
            elseif v54 == 2 then
                v54 = -1;
                local v108 = buffer.readu8(u35, u40);
                local v109 = bit32.extract(v108, u45);
                u45 = u45 + 1;
            ...
            elseif v54 == 4 then
                ...
                elseif v53 > 256 then
                    ...
                    if v53 > 268 then
                        ...
                        local v112 = buffer.readbits(u35, u40 * 8 + u45, v111);
                        u45 = u45 + v111;
                        u40 = u40 + bit32.rshift(u45, 3);
                        u45 = bit32.band(u45, 7);
                        v110 = v110 + v112;
                    elseif v53 > 264 then
                        local v113 = buffer.readu8(u35, u40);
                        local v114 = bit32.extract(v113, u45);
                        u45 = u45 + 1;
                    ...
                    local v115 = buffer.readu8(u35, u40);
                    local v116 = bit32.extract(v115, u45);
                    u45 = u45 + 1;
                    ...
                    while not v51[v117] do
                        local v119 = buffer.readu8(u35, u40);
                        local v120 = bit32.extract(v119, u45);
                        u45 = u45 + 1;
                    ...
                    if v121 > 5 then
                        local v123 = u16[v121];
                        local v124 = buffer.readbits(u35, u40 * 8 + u45, v123);
                        u45 = u45 + v123;
                        u40 = u40 + bit32.rshift(u45, 3);
                        u45 = bit32.band(u45, 7);
                        v122 = v122 + v124;
                    elseif v121 > 3 then
                        local v125 = buffer.readu8(u35, u40);
                        local v126 = bit32.extract(v125, u45);
                        u45 = u45 + 1;
                    ...
                    if v110 <= v122 then
                        buffer.copy(p36, v38, p36, v38 - v122, v110);
                        v38 = v38 + v110;
                        v51 = v118;
                    else
                        repeat
                            local v127 = math.min(v110, v122);
                            buffer.copy(p36, v38, p36, v38 - v122, v127);
                            v38 = v38 + v127;
                            v110 = v110 - v127;
                            v122 = v122 + v127;
                        until v110 == 0;
