...
local function IsInteger(p2) -- Line: 43
    -- upvalues: floor (copy)
    local v3;
...
local function AssertIntegerNonNegative(p4) -- Line: 48
    -- upvalues: floor (copy)
    local v5;
...
local function IsaacMix(p6) -- Line: 76
...
local function Isaac(p30) -- Line: 105
...
local function IsaacInit(p36, p37) -- Line: 132
...
local function Seed(p39, p40, p41) -- Line: 234
...
local v124 = table.freeze({
    NextU32 = function(p45) -- Line: 169, Name: NextU32
        -- upvalues: Isaac (copy)
    ...
    NextU64 = function(p47) -- Line: 179, Name: NextU64
    ...
    NextFloat = function(p51) -- Line: 183, Name: NextFloat
        -- upvalues: Isaac (copy), ldexp (copy)
    ...
    NextDouble = function(p53) -- Line: 187, Name: NextDouble
        -- upvalues: Isaac (copy), ldexp (copy)
    ...
    NextNumber = function(p57, p58, p59) -- Line: 191, Name: NextNumber
        -- upvalues: Isaac (copy), ldexp (copy)
    ...
    NextInteger = function(p63, p64, p65) -- Line: 195, Name: NextInteger
    ...
    NextNormal = function(p69, p70, p71) -- Line: 199, Name: NextNormal
    ...
    NextBoolean = function(p81, p82) -- Line: 206, Name: NextBoolean
        -- upvalues: Isaac (copy), ldexp (copy)
    ...
    NextVector2 = function(p86, p87) -- Line: 210, Name: NextVector2
    ...
    NextVector3 = function(p93, p94) -- Line: 216, Name: NextVector3
    ...
    NextUUIDv4 = function(p105) -- Line: 224, Name: NextUUIDv4
    ...
    Shuffle = function(p113, p114) -- Line: 261, Name: Shuffle
        -- upvalues: Isaac (copy), ldexp (copy), floor (copy)
    ...
    Clone = function(p121) -- Line: 269, Name: Clone
        -- upvalues: clone (copy)
        local v122 = {
            RSL = clone(p121.RSL),
            Count = p121.Count,
...
local u129 = {
    new = function(p126, p127) -- Line: 301, Name: new
...
function u129.Unique(p130) -- Line: 314
