...
function v10.Insert(p12, p13, p14) -- Line: 63
...
function v10.Remove(p20, p21, p22) -- Line: 75
...
function v10.Collect(p28, p29, p30) -- Line: 94
...
function v10.Query(p40, p41, p42) -- Line: 122
...
return table.freeze({
    new = function(p52, p53) -- Line: 156, Name: new
        -- upvalues: u11 (copy)
        local v54;
