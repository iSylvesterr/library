...
return table.freeze({
    ...
    ExternalLinkReferencesToInts = function(p7) -- Line: 76, Name: ExternalLinkReferencesToInts
        -- upvalues: u1 (copy)
        local v8 = {};
    ...
    GetPolicyInfoForPlayerAsync = function(p10, p11) -- Line: 87, Name: GetPolicyInfoForPlayerAsync
