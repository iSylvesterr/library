...
local u11 = {
    Create = function(u7) -- Line: 50, Name: Create
        return function(p8) -- Line: 51
            -- upvalues: u7 (copy)
...
local function CreateSignal() -- Line: 185
    ...
    function v51.connect(p55, u56) -- Line: 199
        ...
        return BindableEvent.Event:Connect(function() -- Line: 203
            -- upvalues: u56 (copy), u52 (ref), u53 (ref)
            u56(unpack(u52, 1, u53));
        end);
    end;

    function v51.wait(p57) -- Line: 208
        -- upvalues: BindableEvent (copy), u52 (ref), u53 (ref)
...
local function getViewportSize() -- Line: 219
...
local function isSmallTouchScreen() -- Line: 236
...
local function isPortrait() -- Line: 241
...
local function isTenFootInterface() -- Line: 246
    return false;
end;

local function usesSelectedObject() -- Line: 250
...
local function isPosOverGui(p60, p61, p62) -- Line: 263
...
local function isPosOverGuiWithClipping(p65, p66) -- Line: 271
...
local function areGuisIntersecting(p72, p73) -- Line: 304
...
local function isGuiVisible(p78, p79) -- Line: 319
    local v80 = p78;
    local v81;
...
local function addHoverState(u86, u87, u88, u89) -- Line: 348
    local function onNormalButtonStateCallback() -- Line: 349
    ...
    local function onHoverButtonStateCallback() -- Line: 354
...
local function addOnResizedCallback(p90, p91) -- Line: 368
...
local function MakeDefaultButton(p95, p96, u97, u98, u99) -- Line: 384
    ...
    local function deselectButton() -- Line: 445
        -- upvalues: u101 (copy)
        u101.Image = "rbxasset://textures/ui/Settings/MenuBarAssets/MenuButton.png";
    end;

    u101.InputBegan:Connect(function(p107) -- Line: 449
    ...
    u101.InputEnded:Connect(function(p110) -- Line: 454
    ...
    u101.SelectionGained:Connect(function() -- Line: 460
        -- upvalues: u99 (copy), u98 (copy), u101 (copy), u103 (ref)
        local v111 = u99;
    ...
    u101.SelectionLost:Connect(function() -- Line: 463
        -- upvalues: u101 (copy)
        u101.Image = "rbxasset://textures/ui/Settings/MenuBarAssets/MenuButton.png";
    end);
    GuiService.Changed:Connect(function(p113) -- Line: 467
...
local function MakeButton(p117, p118, p119, p120, p121, p122) -- Line: 488
...
local function MakeImageButton(p127, p128, p129, p130, p131, p132, p133) -- Line: 519
...
local function AddButtonRow(p136, p137, p138, p139, p140, p141) -- Line: 537
...
local function CreateDropDown(p146, u147, u148) -- Line: 551
    ...
    local function onVREnabled(p159) -- Line: 597
    ...
    local function u167(p164, p165) -- Line: 643
    ...
    local function u168() -- Line: 671
    end;

    local function u169() -- Line: 673
        ...
        u162 = GuiService:GetPropertyChangedSignal("SelectedCoreObject"):Connect(function() -- Line: 692
    ...
    local function setSelection(p171) -- Line: 750
    ...
    local function setSelectionByValue(p173) -- Line: 766
        -- upvalues: u153 (copy), DropDownFrameTextLabel (copy), BindableEvent (copy)
        local v174 = false;
    ...
    local function processInput(p176) -- Line: 784
    ...
    local function setIsFaded(p177) -- Line: 807
        -- upvalues: u153 (copy)
        if p177 then
    ...
    function u153.SetSelectionIndex(p178, p179) -- Line: 822
        -- upvalues: setSelection (copy)
        setSelection(p179);
    end;

    function u153.SetSelectionByValue(p180, p181) -- Line: 826
        -- upvalues: setSelectionByValue (copy)
        return setSelectionByValue(p181);
    end;

    function u153.ResetSelectionIndex(p182) -- Line: 830
    ...
    function u153.GetSelectedIndex(p183) -- Line: 836
        -- upvalues: u153 (copy)
        return u153.CurrentIndex;
    end;

    function u153.SetZIndex(p184, p185) -- Line: 840
    ...
    function u153.SetInteractable(p186, p187) -- Line: 846
    ...
    function u153.UpdateDropDownList(p188, p189) -- Line: 866
        ...
        for i, v in pairs(p189) do
            ...
            u196.MouseEnter:Connect(function() -- Line: 927
        ...
        local function updateDropDownSize() -- Line: 942
        ...
        u158.Changed:Connect(function(p199) -- Line: 955
    ...
    u148.PoppedMenu:Connect(function(p200) -- Line: 970
...
local function CreateSelector(p201, u202) -- Line: 979
    ...
    if not UserInputService.TouchEnabled then
        local function v211(p210) -- Line: 1064
            -- upvalues: u3 (ref)
            p210.ImageColor3 = u3;
        end;

        local function v213(p212) -- Line: 1066
            -- upvalues: u4 (ref)
            p212.ImageColor3 = u4;
        end;
    ...
    u216.MouseButton1Click:Connect(function() -- Line: 1087
    ...
    local function u223(p219, p220) -- Line: 1106
    ...
    local function stepFunc(p224, p225) -- Line: 1157
    ...
    local function connectToGuiService() -- Line: 1197
        -- upvalues: u228 (ref), GuiService (ref), u204 (copy), u215 (copy), VRService (ref)
        u228 = GuiService:GetPropertyChangedSignal("SelectedCoreObject"):Connect(function() -- Line: 1198
    ...
    function u204.SetSelectionIndex(p229, p230) -- Line: 1222
        -- upvalues: u223 (copy)
        u223(p230, 1);
    end;

    function u204.GetSelectedIndex(p231) -- Line: 1226
        -- upvalues: u204 (copy)
        return u204.CurrentIndex;
    end;

    function u204.SetZIndex(p232, p233) -- Line: 1230
    ...
    function u204.SetInteractable(p234, p235) -- Line: 1241
    ...
    function u204.UpdateOptions(p236, p237) -- Line: 1263
    ...
    VRService.Changed:Connect(function(p240) -- Line: 1311, Name: onVREnabled
    ...
    u207.Selectable = VREnabled;
    u216.Selectable = VREnabled;
    u206.InputBegan:Connect(function(p241) -- Line: 1323
        -- upvalues: u205 (ref), VRService (ref), UserInputService (ref), GuiService (ref), u204 (copy), u223 (copy)
    ...
    u206.MouseButton1Click:Connect(function() -- Line: 1328
    ...
    u207.InputBegan:Connect(function(p246) -- Line: 1333
        -- upvalues: u205 (ref), VRService (ref), UserInputService (ref), GuiService (ref), u204 (copy), u223 (copy)
    ...
    u207.MouseButton1Click:Connect(function() -- Line: 1338
        -- upvalues: UserInputService (ref), u205 (ref), VRService (ref), GuiService (ref), u204 (copy), u223 (copy)
        if not UserInputService.TouchEnabled then
            if not u205 then
                return;
    ...
    UserInputService.InputBegan:Connect(function(p252) -- Line: 1347
    ...
    UserInputService.InputChanged:Connect(function(p257) -- Line: 1380
    ...
    u204.SelectorFrame.AncestryChanged:Connect(function(p258, p259) -- Line: 1421
    ...
    u12[u204.SelectorFrame] = function(p260, p261) -- Line: 1432, Name: onResized
        -- upvalues: u204 (copy)
...
local function ShowAlert(p265, p266, u267, u268, p269) -- Line: 1451
    ...
    local function v273(p271) -- Line: 1462
    ...
    local function v278(p276, p277) -- Line: 1545
...
local function CreateNewSlider(p284, p285, u286) -- Line: 1614
    ...
    if u288 > 0 then
        ...
        if not UserInputService.TouchEnabled then
            local function v299(p298) -- Line: 1720
                -- upvalues: u3 (ref)
                p298.ImageColor3 = u3;
            end;

            local function v301(p300) -- Line: 1722
                -- upvalues: u4 (ref)
                p300.ImageColor3 = u4;
            end;
        ...
        local function hideSelection() -- Line: 1786
        ...
        local function showSelection() -- Line: 1796
        ...
        local function setCurrentStep(p305) -- Line: 1819
        ...
        local function isActivateEvent(p306) -- Line: 1849
            if not p306 then
                return false;
            end;
        ...
        local function mouseDownFunc(p308, p309, p310) -- Line: 1860
            ...
            elseif p310 then
                ...
                u290 = 0;
                local u313 = nil;
                local u315 = UserInputService.InputChanged:Connect(function(p314) -- Line: 1886
                ...
                u313 = UserInputService.InputEnded:Connect(function(p316) -- Line: 1907
        ...
        local function mouseUpFunc(p318) -- Line: 1924
        ...
        local function touchClickFunc(p320, p321, p322) -- Line: 1935
        ...
        function u287.SetValue(p323, p324) -- Line: 1942
            -- upvalues: setCurrentStep (copy)
            setCurrentStep(p324);
        end;

        function u287.GetValue(p325) -- Line: 1946
            -- upvalues: u289 (ref)
            return u289;
        end;

        function u287.SetInteractable(p326, p327) -- Line: 1950
        ...
        function u287.SetZIndex(p328, p329) -- Line: 1961
        ...
        function u287.SetMinStep(p330, p331) -- Line: 1972
        ...
        u294.InputBegan:Connect(function(p332) -- Line: 1989
        ...
        u294.InputEnded:Connect(function(p336) -- Line: 1992
            -- upvalues: u292 (ref), u290 (ref)
            if not u292 then
                return;
            end;
        ...
        u295.InputBegan:Connect(function(p338) -- Line: 1995
            -- upvalues: u289 (ref), u292 (ref), VRService (ref), UserInputService (ref), GuiService (ref), u287 (copy), u290 (ref), setCurrentStep (copy)
            local v339 = u289 + 1;
        ...
        u295.InputEnded:Connect(function(p342) -- Line: 1998
            -- upvalues: u292 (ref), u290 (ref)
            if not u292 then
                return;
            end;
        ...
        local function v345(p344) -- Line: 2002
        ...
        local function modifySelection(p346) -- Line: 1809
        ...
        for i = 1, u288 do
            u287.Steps[i].InputBegan:Connect(function(p347) -- Line: 2029
                -- upvalues: mouseDownFunc (copy), i (copy)
                mouseDownFunc(p347, i);
            end);
            u287.Steps[i].InputEnded:Connect(function(p348) -- Line: 2032
                -- upvalues: u292 (ref), u290 (ref)
                if not u292 then
                    return;
                end;
        ...
        u287.SliderFrame.InputBegan:Connect(function(p350) -- Line: 2037
        ...
        u287.SliderFrame.InputEnded:Connect(function(p351) -- Line: 2046
        ...
        UserInputService.InputBegan:Connect(function(p356) -- Line: 2082
        ...
        UserInputService.InputEnded:Connect(function(p357) -- Line: 2110
        ...
        UserInputService.InputChanged:Connect(function(p358) -- Line: 2131
        ...
        local u359 = false;
        GuiService.Changed:Connect(function(p360) -- Line: 2172
        ...
        u287.SliderFrame.AncestryChanged:Connect(function(p361, p362) -- Line: 2195
            -- upvalues: u354 (ref)
            u354 = p362;
        end);
        setCurrentStep(u289);
...
local function AddNewRow(u365, u366, p367, p368, p369, p370) -- Line: 2210
    ...
    local function onResized(p375, p376) -- Line: 2275
    ...
    elseif p367 == "TextBox" then
        ...
        u379 = u384;
        u384.Focused:Connect(function() -- Line: 2331
        ...
        u384.FocusLost:Connect(function(p386, p387) -- Line: 2340
            -- upvalues: u382 (ref)
            u382 = false;
        end);
        ...
        u379.SelectionGained:Connect(function() -- Line: 2352
        ...
        u379.SelectionLost:Connect(function() -- Line: 2361
        ...
        local function v391(p390) -- Line: 2386
        ...
        u384.MouseEnter:Connect(function() -- Line: 2367
    ...
    elseif p367 == "TextEntry" then
        ...
        u379 = u397;
        u397.Focused:Connect(function() -- Line: 2430
        ...
        u397.FocusLost:Connect(function(p399, p400) -- Line: 2439
            -- upvalues: u395 (ref)
            u395 = false;
        end);
        ...
        u379.SelectionGained:Connect(function() -- Line: 2451
        ...
        u379.SelectionLost:Connect(function() -- Line: 2460
        ...
        local function v404(p403) -- Line: 2485
        ...
        u373.MouseEnter:Connect(function() -- Line: 2466
        ...
        function u380.SetZIndex(p407, p408) -- Line: 2497
            -- upvalues: u397 (copy)
            u397.ZIndex = p408;
        end;

        function u380.SetInteractable(p409, p410) -- Line: 2501
            -- upvalues: u397 (copy)
        ...
        function u380.SetValue(p411, p412) -- Line: 2512
            -- upvalues: u397 (copy)
            u397.Text = p412;
        end;
        ...
        local BindableEvent = Instance.new("BindableEvent");
        BindableEvent.Name = "ValueChanged";
        u397.FocusLost:Connect(function() -- Line: 2519
    ...
    if v371 then
        u373.MouseEnter:Connect(function() -- Line: 2538
        ...
        VRService.Changed:Connect(function(p416) -- Line: 2568, Name: onVREnabled
            ...
            if p416 == "VREnabled" then
                if VRService.VREnabled then
                    ...
                    u373.Active = true;
                    u379.Active = true;
                    GuiService.Changed:Connect(function(p417) -- Line: 2574
        ...
        if VRService.VREnabled then
            ...
            u373.Active = true;
            u379.Active = true;
            GuiService.Changed:Connect(function(p418) -- Line: 2574
                -- upvalues: GuiService (ref), u373 (ref)
        ...
        u379.SelectionGained:Connect(function() -- Line: 2595
        ...
        u379.SelectionLost:Connect(function() -- Line: 2610
...
local function AddNewRowObject(p421, p422, p423, p424) -- Line: 2625
    ...
    u426.SelectionGained:Connect(function() -- Line: 2650
        -- upvalues: u426 (copy)
        u426.BackgroundTransparency = 0.5;
    end);
    u426.SelectionLost:Connect(function() -- Line: 2653
        -- upvalues: u426 (copy)
    ...
    u12[u426] = function(p428, p429) -- Line: 2670, Name: onResized
        -- upvalues: u427 (copy)
        if p429 then
            u427.TextSize = 16;
    ...
    u364[p421] = v431;
    u426.MouseEnter:Connect(function() -- Line: 2695
    ...
    p423.SelectionGained:Connect(function() -- Line: 2704
    ...
    p423.SelectionLost:Connect(function() -- Line: 2713
        -- upvalues: u426 (copy)
        u426.ImageTransparency = 1;
        u426.BackgroundTransparency = 1;
    end);
...
local u513 = {
    Create = function(p432, u433) -- Line: 2727, Name: Create
        return function(p434) -- Line: 2728
            -- upvalues: u433 (copy)
    ...
    RayPlaneIntersection = function(p437, p438, p439, p440) -- Line: 2749, Name: RayPlaneIntersection
    ...
    GetEaseLinear = function(p443) -- Line: 2767, Name: GetEaseLinear
        -- upvalues: Linear (copy)
        return Linear;
    end,

    GetEaseOutQuad = function(p444) -- Line: 2770, Name: GetEaseOutQuad
        -- upvalues: EaseOutQuad (copy)
        return EaseOutQuad;
    end,

    GetEaseInOutQuad = function(p445) -- Line: 2773, Name: GetEaseInOutQuad
        -- upvalues: EaseInOutQuad (copy)
        return EaseInOutQuad;
    end,

    CreateNewSlider = function(p446, p447, p448, p449) -- Line: 2777, Name: CreateNewSlider
        -- upvalues: CreateNewSlider (copy)
        return CreateNewSlider(p447, p448, p449);
    end,

    CreateNewSelector = function(p450, p451, p452) -- Line: 2781, Name: CreateNewSelector
        -- upvalues: CreateSelector (copy)
        return CreateSelector(p451, p452);
    end,

    CreateNewDropDown = function(p453, p454, p455) -- Line: 2785, Name: CreateNewDropDown
        -- upvalues: CreateDropDown (copy)
        return CreateDropDown(p454, p455, nil);
    end,

    AddNewRow = function(p456, p457, p458, p459, p460, p461, p462) -- Line: 2789, Name: AddNewRow
        -- upvalues: AddNewRow (copy)
        return AddNewRow(p457, p458, p459, p460, p461, p462);
    end,

    AddNewRowObject = function(p463, p464, p465, p466, p467) -- Line: 2793, Name: AddNewRowObject
        -- upvalues: AddNewRowObject (copy)
        return AddNewRowObject(p464, p465, p466, p467);
    end,

    ShowAlert = function(p468, p469, p470, p471, p472, p473) -- Line: 2797, Name: ShowAlert
        -- upvalues: ShowAlert (copy)
        ShowAlert(p469, p470, p471, p472, p473);
    end,

    IsSmallTouchScreen = function(p474) -- Line: 2801, Name: IsSmallTouchScreen
        -- upvalues: getViewportSize (copy), UserInputService (copy)
    ...
    IsPortrait = function(p476) -- Line: 2805, Name: IsPortrait
        -- upvalues: getViewportSize (copy)
    ...
    MakeStyledButton = function(p478, p479, p480, p481, p482, p483, p484) -- Line: 2809, Name: MakeStyledButton
        -- upvalues: MakeButton (copy)
        return MakeButton(p479, p480, p481, p482, p483, p484);
    end,

    MakeStyledImageButton = function(p485, p486, p487, p488, p489, p490, p491, p492) -- Line: 2813, Name: MakeStyledImageButton
        -- upvalues: MakeImageButton (copy)
        return MakeImageButton(p486, p487, p488, p489, p490, p491, p492);
    end,

    AddButtonRow = function(p493, p494, p495, p496, p497, p498, p499) -- Line: 2817, Name: AddButtonRow
        -- upvalues: AddButtonRow (copy)
        return AddButtonRow(p494, p495, p496, p497, p498, p499);
    end,

    CreateSignal = function(p500) -- Line: 2821, Name: CreateSignal
        -- upvalues: CreateSignal (copy)
        return CreateSignal();
    end,

    UsesSelectedObject = function(p501) -- Line: 2825, Name: UsesSelectedObject
        -- upvalues: VRService (copy), UserInputService (copy)
        if VRService.VREnabled then
            return false;
        end;
    ...
    TweenProperty = function(p502, p503, p504, p505, p506, p507, p508, p509) -- Line: 2829, Name: TweenProperty
        return PropertyTweener(p503, p504, p505, p506, p507, p508, p509);
    end,

    OnResized = function(p510, p511, p512) -- Line: 2833, Name: OnResized
        -- upvalues: addOnResizedCallback (copy)
        return addOnResizedCallback(p511, p512);
    end
};

function u513.FireOnResized(p514) -- Line: 2837
...
function u513.Lerp(p517, p518, p519, p520) -- Line: 2848
    return (1 - p518) * p519 + p518 * p520;
end;

function u513.Round(p521, p522) -- Line: 2853
