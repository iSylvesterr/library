...
local function gfmul(p14, p15) -- Line: 409
...
local function keySchedule(p17, p18, p19, p20) -- Line: 158
...
local function encryptBlock(p50, p51, p52, p53, p54, p55) -- Line: 259
...
local function decryptBlock(p104, p105, p106, p107, p108, p109) -- Line: 326
...
local function newidx(p168, p169) -- Line: 481
    return error((`{p169} cannot be assigned to`));
end;

local function tostr() -- Line: 484
    return "AesCipher";
end;
...
local function expandKey(p170, p171) -- Line: 490
...
local function fromKey(p174, p175, p176) -- Line: 496
    ...
    local function encb(p199, p200, p201, p202, p203) -- Line: 544
    ...
    local function dec(p204, p205, p206, ...) -- Line: 553
    ...
    local function decb(p208, p209, p210, p211, p212) -- Line: 569
    ...
    local function destroy(p213) -- Line: 578
    ...
    function v186.__index(p214, p215) -- Line: 589
...
return table.freeze({
    new = function(p216, p217, p218) -- Line: 605, Name: new
