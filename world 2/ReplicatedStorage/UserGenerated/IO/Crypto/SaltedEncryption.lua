...
local function ApplyPKCS7Padding(p23) -- Line: 115
...
local function RemovePKCS7Padding(p28) -- Line: 137
...
local function Encrypt(p33, p34, p35) -- Line: 172
...
local function Decrypt(p45, p46, p47) -- Line: 226
...
local v63 = {
    ...
    EncryptString = function(p57, p58, p59) -- Line: 287, Name: EncryptString
        -- upvalues: Encrypt (copy)
        return Encrypt(p57, buffer.fromstring(p58), p59);
    end,

    DecryptString = function(p60, p61, p62) -- Line: 300, Name: DecryptString
