...
local function Search(p5, p6) -- Line: 73
    local v7 = #p5;
    local v8 = 1;
...
function v4.Pick(p14, p15) -- Line: 102
...
local function CompareOrderedEntry(p20, p21) -- Line: 115
...
local function new(p22) -- Line: 123
...
local u34 = table.freeze({
    __index = table.freeze({
        Add = function(p30, p31, p32) -- Line: 211, Name: Add
        ...
        Build = function(p33) -- Line: 221, Name: Build
            -- upvalues: new (copy)
...
return table.freeze({
    ...
    IsA = function(p35) -- Line: 176, Name: IsA
        -- upvalues: u19 (copy)
        local v36;
    ...
    Assert = function(p37) -- Line: 180, Name: Assert
        -- upvalues: u19 (copy)
    ...
    Builder = function(p38) -- Line: 227, Name: Builder
    ...
    IsABuilder = function(p40) -- Line: 241, Name: IsABuilder
        -- upvalues: u34 (copy)
        local v41;
    ...
    AssertBuilder = function(p42) -- Line: 245, Name: AssertBuilder
        -- upvalues: u34 (copy)
