...
local function Mul32(p2, p3) -- Line: 44
...
local function IsInteger(p8) -- Line: 55
    -- upvalues: floor (copy)
    local v9;
...
local function AssertInteger(p10) -- Line: 62
    -- upvalues: floor (copy)
    local v11;
...
local function AssertIntegerNonNegative(p12) -- Line: 67
    -- upvalues: floor (copy)
    local v13;
...
local function Seed(p14, p15) -- Line: 165
...
local v144 = table.freeze({
    NextU32 = function(p30) -- Line: 88, Name: NextU32
    ...
    NextU64 = function(p33) -- Line: 98, Name: NextU64
    ...
    NextFloat = function(p39) -- Line: 102, Name: NextFloat
        -- upvalues: lshift (copy), bxor (copy), rshift (copy), ldexp (copy)
        local x = p39.x;
        local w = p39.w;
    ...
    NextDouble = function(p42) -- Line: 106, Name: NextDouble
        -- upvalues: lshift (copy), bxor (copy), rshift (copy), ldexp (copy)
        local x = p42.x;
        local w = p42.w;
    ...
    NextNumber = function(p48, p49, p50) -- Line: 110, Name: NextNumber
        -- upvalues: lshift (copy), bxor (copy), rshift (copy), ldexp (copy)
        local x = p48.x;
        local w = p48.w;
    ...
    NextInteger = function(p56, p57, p58) -- Line: 114, Name: NextInteger
    ...
    NextNormal = function(p64, p65, p66) -- Line: 118, Name: NextNormal
    ...
    NextBoolean = function(p80, p81) -- Line: 130, Name: NextBoolean
        -- upvalues: lshift (copy), bxor (copy), rshift (copy), ldexp (copy)
        local x = p80.x;
        local w = p80.w;
    ...
    NextVector2 = function(p87, p88) -- Line: 134, Name: NextVector2
    ...
    NextVector3 = function(p96, p97) -- Line: 143, Name: NextVector3
    ...
    NextUUIDv4 = function(p112) -- Line: 155, Name: NextUUIDv4
    ...
    Shuffle = function(p123, p124) -- Line: 196, Name: Shuffle
        -- upvalues: lshift (copy), bxor (copy), rshift (copy), ldexp (copy), floor (copy)
    ...
    Clone = function(p133) -- Line: 204, Name: Clone
        local v134 = {
            x = p133.x,
            y = p133.y,
            z = p133.z,
    ...
    GetState = function(p136) -- Line: 214, Name: GetState
        return {
            p136.x,
            p136.y,
            p136.z,
    ...
    Skip = function(p137, p138) -- Line: 218, Name: Skip
...
local u148 = {
    new = function(p146) -- Line: 246, Name: new
...
function u148.Unique(p149) -- Line: 257
