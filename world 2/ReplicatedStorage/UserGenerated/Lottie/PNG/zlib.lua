...
return {
    inflate = function(u35, p36) -- Line: 156, Name: inflate
        ...
        local u37, u38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53;
        local v54 = 0;
        ...
        while true do
            ...
            if v54 == 0 then
                ...
                local function readBit() -- Line: 167
                    -- upvalues: u35 (copy), u37 (ref), u38 (ref)
                    local v65 = buffer.readu8(u35, u37);
                    local v66 = bit32.extract(v65, u38);
                    u38 = u38 + 1;
                ...
                local function readBits(p67) -- Line: 177
                    -- upvalues: u35 (copy), u37 (ref), u38 (ref)
                    local v68 = buffer.readbits(u35, u37 * 8 + u38, p67);
                    u38 = u38 + p67;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                ...
                local function readHuffmanTable(p69) -- Line: 185
                    -- upvalues: u35 (copy), u37 (ref), u38 (ref)
                    local v70 = buffer.readu8(u35, u37);
                    local v71 = bit32.extract(v70, u38);
                    u38 = u38 + 1;
                    ...
                    while not p69[v72] do
                        local v73 = buffer.readu8(u35, u37);
                        local v74 = bit32.extract(v73, u38);
                        u38 = u38 + 1;
                ...
                while true do
                    local v76 = buffer.readu8(u35, u37);
                    v43 = bit32.extract(v76, u38);
                    u38 = u38 + 1;
                    ...
                    v75 = buffer.readbits(u35, u37 * 8 + u38, 2);
                    u38 = u38 + 2;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                    ...
                    local v77 = buffer.readu16(u35, u37);
                    local v78 = buffer.readu16(u35, u37 + 2);
                    local v79 = bit32.bxor(v77, v78) == 65535;
                    assert(v79, "len ~= nlen");
                    u37 = u37 + 4;
                    buffer.copy(p36, v39, u35, u37, v77);
                    v39 = v39 + v77;
                    u37 = u37 + v77;
                    ::l0::;
                    ...
                    if v43 == 1 then
                        ...
                        v40 = adler32(p36, 0, buffer.len(p36));
                        v44 = buffer.readu32(u35, u37);
                        v41 = v40 == bit32.byteswap(v44);
                        assert(v41, "adler-32 checksum mismatch");
                ...
                if v75 ~= 2 then
                    ::l2::;
                    v55 = 2;
                    v56 = buffer.readu8(u35, u37);
                    v57 = bit32.extract(v56, u38);
                    u38 = u38 + 1;
                ...
                local v80 = buffer.readbits(u35, u37 * 8 + u38, 5);
                u38 = u38 + 5;
                u37 = u37 + bit32.rshift(u38, 3);
                u38 = bit32.band(u38, 7);
                v42 = v80 + 257;
                local v81 = buffer.readbits(u35, u37 * 8 + u38, 5);
                u38 = u38 + 5;
                u37 = u37 + bit32.rshift(u38, 3);
                u38 = bit32.band(u38, 7);
                v46 = v81 + 1;
                local v82 = buffer.readbits(u35, u37 * 8 + u38, 4);
                u38 = u38 + 4;
                u37 = u37 + bit32.rshift(u38, 3);
                u38 = bit32.band(u38, 7);
                ...
                for i = 1, v82 + 4 do
                    local v84 = u15[i] + 1;
                    local v85 = buffer.readbits(u35, u37 * 8 + u38, 3);
                    u38 = u38 + 3;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                    v83[v84] = v85;
                ...
                v51 = createHuffmanTable(v83);
                v47 = table.create(v42);
                v49 = nil;
                v54 = 1;
                continue;
            elseif v54 == 1 then
                v54 = -1;
                local v86 = buffer.readu8(u35, u37);
                local v87 = bit32.extract(v86, u38);
                u38 = u38 + 1;
                ...
                while not v51[v88] do
                    local v89 = buffer.readu8(u35, u37);
                    local v90 = bit32.extract(v89, u38);
                    u38 = u38 + 1;
                ...
                if v91 <= 15 then
                    v49 = v91;
                elseif v91 == 16 then
                    local v93 = buffer.readbits(u35, u37 * 8 + u38, 2);
                    u38 = u38 + 2;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                    v92 = v93 + 3;
                elseif v91 == 17 then
                    v49 = 0;
                    local v94 = buffer.readbits(u35, u37 * 8 + u38, 3);
                    u38 = u38 + 3;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                    v92 = v94 + 3;
                elseif v91 == 18 then
                    v49 = 0;
                    local v95 = buffer.readbits(u35, u37 * 8 + u38, 7);
                    u38 = u38 + 7;
                    u37 = u37 + bit32.rshift(u38, 3);
                    u38 = bit32.band(u38, 7);
                    v92 = v95 + 11;
                ...
                if v42 <= #v47 then
                    v45 = createHuffmanTable(v47);
                    local v96 = table.create(v46);
                    local v97 = nil;
                    local v98 = buffer.readu8(u35, u37);
                    local v99 = bit32.extract(v98, u38);
                    u38 = u38 + 1;
                    ...
                    while not v51[v100] do
                        local v101 = buffer.readu8(u35, u37);
                        local v102 = bit32.extract(v101, u38);
                        u38 = u38 + 1;
                    ...
                    if v103 <= 15 then
                        v97 = v103;
                    elseif v103 == 16 then
                        local v105 = buffer.readbits(u35, u37 * 8 + u38, 2);
                        u38 = u38 + 2;
                        u37 = u37 + bit32.rshift(u38, 3);
                        u38 = bit32.band(u38, 7);
                        v104 = v105 + 3;
                    elseif v103 == 17 then
                        v97 = 0;
                        local v106 = buffer.readbits(u35, u37 * 8 + u38, 3);
                        u38 = u38 + 3;
                        u37 = u37 + bit32.rshift(u38, 3);
                        u38 = bit32.band(u38, 7);
                        v104 = v106 + 3;
                    elseif v103 == 18 then
                        v97 = 0;
                        local v107 = buffer.readbits(u35, u37 * 8 + u38, 7);
                        u38 = u38 + 7;
                        u37 = u37 + bit32.rshift(u38, 3);
                        u38 = bit32.band(u38, 7);
                        v104 = v107 + 11;
            ...
            elseif v54 == 2 then
                v54 = -1;
                local v108 = buffer.readu8(u35, u37);
                local v109 = bit32.extract(v108, u38);
                u38 = u38 + 1;
            ...
            elseif v54 == 4 then
                ...
                elseif v53 > 256 then
                    ...
                    if v53 > 268 then
                        ...
                        local v112 = buffer.readbits(u35, u37 * 8 + u38, v111);
                        u38 = u38 + v111;
                        u37 = u37 + bit32.rshift(u38, 3);
                        u38 = bit32.band(u38, 7);
                        v110 = v110 + v112;
                    elseif v53 > 264 then
                        local v113 = buffer.readu8(u35, u37);
                        local v114 = bit32.extract(v113, u38);
                        u38 = u38 + 1;
                    ...
                    local v115 = buffer.readu8(u35, u37);
                    local v116 = bit32.extract(v115, u38);
                    u38 = u38 + 1;
                    ...
                    while not v52[v117] do
                        local v119 = buffer.readu8(u35, u37);
                        local v120 = bit32.extract(v119, u38);
                        u38 = u38 + 1;
                    ...
                    if v121 > 5 then
                        local v123 = u16[v121];
                        local v124 = buffer.readbits(u35, u37 * 8 + u38, v123);
                        u38 = u38 + v123;
                        u37 = u37 + bit32.rshift(u38, 3);
                        u38 = bit32.band(u38, 7);
                        v122 = v122 + v124;
                    elseif v121 > 3 then
                        local v125 = buffer.readu8(u35, u37);
                        local v126 = bit32.extract(v125, u38);
                        u38 = u38 + 1;
                    ...
                    if v110 <= v122 then
                        buffer.copy(p36, v39, p36, v39 - v122, v110);
                        v39 = v39 + v110;
                        v52 = v118;
                    else
                        repeat
                            local v127 = math.min(v110, v122);
                            buffer.copy(p36, v39, p36, v39 - v122, v127);
                            v39 = v39 + v127;
                            v110 = v110 - v127;
                            v122 = v122 + v127;
                        until v110 == 0;
