...
function u15.string(p28, p29) -- Line: 128
    return string.format("%q", p28);
end;

u15["function"] = function(p30) -- Line: 132
    return "[function]";
end;

function u15.Instance(p31) -- Line: 136
    if p31.Parent then
...
function u15.table(p32, p33) -- Line: 147
    -- upvalues: u15 (copy)
    ...
    if v38 then
        ...
        if order then
            table.sort(v46, function(p47, p48) -- Line: 199
...
function u15.Color3(p60, p61) -- Line: 237
    -- upvalues: u15 (copy)
    local v62 = p60.R * 255;
    local v63 = p60.G * 255;
    local v64 = p60.B * 255;
...
function u15.Vector3(p84, p85) -- Line: 251
    -- upvalues: u15 (copy)
...
function u15.Vector2(p98, p99) -- Line: 263
    -- upvalues: u15 (copy)
...
function u15.CFrame(p108, p109) -- Line: 274
    -- upvalues: u15 (copy)
...
function u15.EnumItem(p163, p164) -- Line: 304
...
local u172 = {
    ...
    Pretty = function(p165, p166) -- Line: 316, Name: Pretty
    ...
    Serialize = function(p168, p169) -- Line: 332, Name: Serialize
    ...
    Default = function(p170) -- Line: 341, Name: Default
        -- upvalues: u1 (copy), serialize (copy)
        local v171 = u1;
...
function u172.DefaultArgs(...) -- Line: 351
    -- upvalues: u172 (copy)
...
function u172.DefaultArgsPrefix(...) -- Line: 363
    -- upvalues: u172 (copy)
...
function u172.CompileOrder(p177) -- Line: 373
    -- upvalues: u172 (copy)
