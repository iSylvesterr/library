...
local function StripErrorSource(p1) -- Line: 38
...
local function ToString(p5) -- Line: 48
...
return table.freeze({
    ...
    ErrorUnsafe = function(p8, p9, ...) -- Line: 60, Name: ErrorUnsafe
        local u10 = nil;
        local v12 = table.pack(xpcall(p9, function(p11) -- Line: 66
            -- upvalues: u10 (ref)
            u10 = p11;
        end, ...));
    ...
    Error = function(p13, p14, ...) -- Line: 79, Name: Error
        -- upvalues: Stringify (copy)
        local u15 = nil;
        local v17 = table.pack(xpcall(p14, function(p16) -- Line: 85
            -- upvalues: u15 (ref)
            u15 = p16;
        end, ...));
    ...
    Equal = function(p21, p22) -- Line: 101, Name: Equal
        -- upvalues: Stringify (copy)
    ...
    DeepEqual = function(p23, p24) -- Line: 107, Name: DeepEqual
    ...
    FuzzyEqual = function(p25, p26, p27) -- Line: 113, Name: FuzzyEqual
        if (p27 or 0.001) < math.abs(p25 - p26) then
            error(`FuzzyEqual({tostring(p25)}, {tostring(p26)}): {math.abs(p25 - p26)}`, 2);
        end;
    end,

    ColorEqual = function(p28, p29, p30) -- Line: 120, Name: ColorEqual
        -- upvalues: Stringify (copy)
