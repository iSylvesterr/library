...
local function GetAttributes(p10) -- Line: 61
...
local function GetAttribute(p12, p13, p14) -- Line: 68
    -- upvalues: LocalPlayer (copy), u9 (ref)
...
local function GetAttributeAsync(p18, p19, p20) -- Line: 81
...
local function GetJobAttributes() -- Line: 93
    -- upvalues: LocalPlayer (copy), u9 (ref)
...
local function GetJobAssignments() -- Line: 108
    -- upvalues: u3 (ref)
    return u3;
end;
...
SharedABTests.UpdateRemote.OnClientEvent:Connect(function(p26, p27) -- Line: 120
...
return table.freeze({
    ...
    GetJobAttribute = function(p28, p29) -- Line: 96, Name: GetJobAttribute
        -- upvalues: GetAttribute (copy), LocalPlayer (copy)
        return GetAttribute(LocalPlayer, p28, p29);
    end,

    GetJobAttributeAsync = function(p30, p31) -- Line: 102, Name: GetJobAttributeAsync
    ...
    GetJobAssignmentsAsync = function(p32) -- Line: 111, Name: GetJobAssignmentsAsync
