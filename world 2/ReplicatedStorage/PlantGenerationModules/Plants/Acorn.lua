...
return {
    ...
    InitPlant = function(u1, p2, p3) -- Line: 9, Name: InitPlant
        ...
        local v13, v14, v15 = Color3.fromRGB(120, 95, 80):ToHSV();
        local v16 = 0.03 or 0.05;
        local v17 = v13 + u4:NextNumber(-v16, v16);
        local u18 = Color3.fromHSV(v17, v14, v15);
        local u19 = Color3.fromRGB(45, 139, 48);
        local u20 = Color3.fromRGB(62, 162, 62);
        ...
        local function CreateBranch(p67, p68, p69) -- Line: 149
        ...
        CreateLeaves(CFrame2, v39, u4:NextNumber(1.475, 1.725));
        u1:AddTag("InitializationComplete");
    end,

    BeginPlantGrowth = function(u96) -- Line: 264, Name: BeginPlantGrowth
        local PrimaryPart = u96.PrimaryPart;
        local u97 = {};

        for _, v in u96:QueryDescendants("BasePart") do
            local v98 = tonumber(v.Name);
            ...
            if v98 then
                ...
                table.insert(u97, v99);
                v.CanCollide = false;
                v.Transparency = 1;
            end;
        end;

        local function updateGrowth() -- Line: 282
            -- upvalues: u96 (copy), u97 (copy), PrimaryPart (copy)
            local v100 = u96:GetAttribute("Age") or 0;

            for _, v in u97 do
                local v101 = v[1];
                local v102 = v[2];
                local v103 = v[3];
                local v104 = math.min(v100 - v[4], 1);
                local v105 = math.clamp(v104, 0, 1);

                if v105 ~= v.lastProgress then
                    v.lastProgress = v105;

                    if v104 > 0 then
                        v101.Size = Vector3.new(v102.X, v102.Y * v104, v102.Z);
                        v101.CFrame = PrimaryPart.CFrame * v103 * CFrame.new(0, (v101.Size.Y - v102.Y) / 2, 0);
                        v101.Transparency = v101:GetAttribute("OG_Transparency") or 0;
