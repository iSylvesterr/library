...
return {
    ...
    InitPlant = function(u19, p20, p21) -- Line: 57, Name: InitPlant
        ...
        local function CreateBranch(p80, p81, p82, p83) -- Line: 145
            ...
            for i = 1, v84 do
                local v87 = CreatePart(u19, nil, "Studs 2x2 Plastic");
                v87.Size = p81;
        ...
        for i = 1, v52 do
            local v90 = CreatePart(u19, nil, "Studs 2x2 Plastic");
        ...
        for i = 1, 2 do
            ...
            for i2, v in v89 do
                ...
                local v114 = CreatePart(u19, nil, "Studs 2x2 Plastic");
                ...
                if i2 == 2 then
                    ...
                    for i3 = 1, 2 do
                        local v118 = CreatePart(u19, nil, "Studs 2x2 Plastic");
                        v118.Size = v116;
                        local Angles = CFrame.Angles;
    ...
    BeginPlantGrowth = function(u124) -- Line: 294, Name: BeginPlantGrowth
        ...
        local function updateGrowth() -- Line: 326
            -- upvalues: u124 (copy), u125 (copy), PrimaryPart (copy)
            local v129 = u124:GetAttribute("Age") or 0;

            for _, v in u125 do
                local v130 = math.min(v129 - v.partAge, 1);
                local v131 = math.clamp(v130, 0, 1);

                if v131 ~= v.lastProgress then
                    v.lastProgress = v131;

                    if v130 > 0 then
                        if v.growSide then
                            local v132 = v.maxSize.Z * v130;
                            v.part.Size = Vector3.new(v.maxSize.X, v.maxSize.Y, v132);
                            v.part.CFrame = PrimaryPart.CFrame * v.centerOffset * CFrame.new(0, 0, (v.maxSize.Z - v132) / 2);
                        else
                            local v133 = v.maxSize.Y * v130;
                            v.part.Size = Vector3.new(v.maxSize.X, v133, v.maxSize.Z);
                            v.part.CFrame = PrimaryPart.CFrame * v.centerOffset * CFrame.new(0, -((v.maxSize.Y - v133) / 2), 0);
                        end;
                        ...
                        for _, v2 in v.decals do
                            v2.decal.Transparency = v2.originalTransparency + (1 - v2.originalTransparency) * (1 - v130);
                        end;
                    else
