...
return {
    ...
    InitPlant = function(u1, p2, p3) -- Line: 9, Name: InitPlant
        ...
        local function CreatePart(p32, p33, p34) -- Line: 31
        ...
        for i = 1, v24 do
            ...
            for i2 = 1, v28 do
                ...
                v31.Parent = u1;
                local v63 = v46.CFrame * CFrame.new(0, -v46.Size.Y / 2 + v61 * i2, 0) * CFrame.Angles(0, math.rad(v37), 0) * CFrame.new(0, 0, v46.Size.X / 2 + v31.Size.X / 2);
