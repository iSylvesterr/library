...
return {
    ...
    InitPlant = function(u1, p2, p3) -- Line: 9, Name: InitPlant
        ...
        local u29 = {
            Start = Color3.fromRGB(36, 0, 71),
            End = Color3.fromRGB(36, 0, 71)
        };
        ...
        for i = 1, v26 do
            ...
            if i >= 3 then
                ...
                local v63 = CreatePart(nil, "2022 Stud Wavy");
                v63.Size = v49:Lerp(v50, (i - 2) / v26) + Vector3.new(0, 1, 0) * Magnitude;
                v63.CFrame = CFrame.lookAt(v57.Position, identity.Position) * CFrame.new(0, 0, -Magnitude / 2) * CFrame.Angles(-1.5707963267948966, 0, 0);
                v63.Color = Color3.fromRGB(0, 0, 0);
                v63.Name = i + 1;
            end;

            if i == 2 then
                local v64 = u5:NextInteger(3, 5);

                for i2 = 1, v64 do
                    local v65 = 360 / v64 * (i2 * u5:NextNumber(0.9, 1.1));
                    local v66 = v51.CFrame * CFrame.Angles(0, math.rad(v65), 0);
                    local Angles = CFrame.Angles;
                    local v67 = u5:NextNumber(80, 90);
                    GenerateDownwardsStem(v66 * Angles(0, 0, (math.rad(v67))), { 9, 18 }, v51.Color);
                end;
            end;

            if i > 2 and i < v26 then
                local v68 = script.BigLeaf:Clone();
                v68.Parent = u1;
                v68:ScaleTo(u4);
                local v69 = v51.CFrame * CFrame.Angles(0, math.rad(v46), 0);
                local Angles = CFrame.Angles;
                local v70 = u5:NextNumber(-110, -125);
                v68:PivotTo(v69 * Angles(math.rad(v70), 0, 0) * CFrame.new(0, v51.Size.Z / 2.25, 0));
                v46 = v46 + u5:NextNumber(45, 115);

                for _, child in v68:GetChildren() do
                    local v71 = tonumber(child.Name);
        ...
        v72.CFrame = CFrame2;
        v72.Parent = FruitSpawnLocations;
        v72.Transparency = 1;
        local v73 = u5:NextNumber(-0.025, 0.025);

        for _, child in u1:GetChildren() do
            if tonumber(child.Name) then
                local v74, v75, v76 = child.Color:ToHSV();
                child.Color = Color3.fromHSV(v74 + v73, v75, v76);
            end;
        end;
    ...
    BeginPlantGrowth = function(u77) -- Line: 248, Name: BeginPlantGrowth
        ...
        for _, v in u77:QueryDescendants("BasePart") do
            ...
            if v79 then
                local v80 = not v:GetAttribute("DontShow");
                local v81 = {};
        ...
        local function updateGrowth() -- Line: 283
            ...
            local v83 = u77:GetAttribute("Age") or 0;
            local v84 = u77:GetAttribute("MaxAge") or 1;
            local v85 = v83 / v84;

            for _, v in u78 do
                if not v.part:GetAttribute("DontShow") then
                    local v86 = math.clamp((v85 - v.partAge / v84) * v84, 0, 1);

                    if v86 ~= v.lastProgress then
                        v.lastProgress = v86;

                        if v86 > 0 then
                            local v87 = v.maxSize * v86;
                            v.part.Size = v87;
                            v.part.CFrame = PrimaryPart.CFrame * v.centerOffset * CFrame.new(0, -((v.maxSize.Y - v87.Y) / 2), 0);
                            v.part.Transparency = v.part:GetAttribute("OG_Transparency") or 0;
                            v.part.CanCollide = true;

                            for _, v2 in v.decals do
                                v2.decal.Transparency = v2.originalTransparency + (1 - v2.originalTransparency) * (1 - v86);
                            end;
                        else
