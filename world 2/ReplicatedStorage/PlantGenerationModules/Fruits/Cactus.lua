...
return {
    ...
    InitFruit = function(u1, p2, u3) -- Line: 11, Name: InitFruit
        ...
        local function CreateSpikesOnFace(p9, p10) -- Line: 45
        ...
        v19.Parent = u1;
        v19.Color = Color3.fromHSV(u4:NextInteger(100, 160) * 0.001, 1, 1);
        ...
        for _, v in u8 do
            v.Color = Color3.new(0.27451, 0.27451, 0.27451);
            v.Name = "4";
        end;
    ...
    BeginFruitGrowth = function(u24) -- Line: 166, Name: BeginFruitGrowth
    ...
    OnFullyGrown = function(p33) -- Line: 222, Name: OnFullyGrown
