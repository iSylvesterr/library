...
return {
    ...
    InitFruit = function(u1, p2, p3) -- Line: 8, Name: InitFruit
        ...
        local function AttachWedge_1(p25) -- Line: 115
        ...
        v28.Color = Color3.fromHSV(0.333333, 1, 0.666667);
        u8 = u8 + 1;
    ...
    BeginFruitGrowth = function(u32) -- Line: 163, Name: BeginFruitGrowth
    ...
    OnFullyGrown = function(p42) -- Line: 222, Name: OnFullyGrown
