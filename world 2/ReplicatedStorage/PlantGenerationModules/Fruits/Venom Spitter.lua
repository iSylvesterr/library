...
return {
    ...
    InitFruit = function(u1, p2, p3) -- Line: 10, Name: InitFruit
        ...
        if u4:NextInteger(1, 100) == 1 then
            for _, child in pairs(u1:GetChildren()) do
                if child:IsA("BasePart") then
                    child.Color = Color3.new(1, 0.666667, 1);
                end;
            end;
        end;
        ...
        if u4:NextInteger(1, 100) == 1 then
            for _, child in pairs(u1:GetChildren()) do
                if child:IsA("BasePart") then
                    child.Color = Color3.new(0.666667, 0.333333, 1);
                end;
            end;
        end;
    ...
    BeginFruitGrowth = function(u35) -- Line: 102, Name: BeginFruitGrowth
    ...
    OnFullyGrown = function(p46) -- Line: 176, Name: OnFullyGrown
