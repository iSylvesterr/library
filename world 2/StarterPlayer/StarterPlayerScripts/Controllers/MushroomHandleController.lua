...
local Mushrooms = ReplicatedStorage:WaitForChild("Assets"):WaitForChild("Mushrooms");
...
function v1.SpawnHandle(u20, u21, p22) -- Line: 85
    -- upvalues: u4 (copy), Mushrooms (copy), HandleScale (copy), LocalPlayer (copy), u5 (copy), u6 (copy), HeldHandleSelfHeal (copy), u3 (copy)
    if u4[u21] then
        return;
    end;
    ...
    local v24 = u21:GetAttribute("Mushroom");
    ...
    local v25 = Mushrooms:FindFirstChild(v24);
    ...
    if v28 then
        ...
        PrimaryPart.CFrame = v23.CFrame * HandleScale.ScaleGripTranslation(u6, v27);
        local WeldConstraint = Instance.new("WeldConstraint");
        WeldConstraint.Part0 = PrimaryPart;
    ...
    if Handle then
        HeldHandleSelfHeal.WatchHandle(u21, Handle, function() -- Line: 161
...
function v1.UpdateToolState(p30, p31) -- Line: 172
...
function v1.DisconnectTool(p35, p36) -- Line: 188
...
function v1.CleanupTool(p38, p39) -- Line: 200
    p38:ClearHandle(p39);
    p38:DisconnectTool(p39);
end;

function v1.IsTrackedTool(p40, p41) -- Line: 205
    return p41:GetAttribute("Mushroom") ~= nil;
end;

function v1.SetupTool(u42, u43, p44) -- Line: 209
    -- upvalues: u3 (copy), u2 (copy)
    u42:DisconnectTool(u43);
    local v45 = {};
    u3[u43] = p44;
    local v46 = u43:GetPropertyChangedSignal("Parent");
    table.insert(v45, v46:Connect(function() -- Line: 215
...
function v1.SetupCharacter(u47, u48) -- Line: 232
    ...
    task.defer(function() -- Line: 233
        ...
        u48.ChildAdded:Connect(function(u50) -- Line: 252
        ...
        HandleScale.MonitorCharacterScale(u48, function(p51) -- Line: 263
            -- upvalues: u47 (ref)
            return u47:IsTrackedTool(p51);
        end, function(p52, p53) -- Line: 264
            -- upvalues: u47 (ref)
...
function v1.SetupPlayer(u54, u55) -- Line: 268
    -- upvalues: BackpackListener (copy)
    if u55.Character then
        u54:SetupCharacter(u55.Character);
    end;

    u55.CharacterAdded:Connect(function(p56) -- Line: 273
        -- upvalues: u54 (copy)
        u54:SetupCharacter(p56);
    end);
    BackpackListener.bind(u55, function(u57) -- Line: 277
