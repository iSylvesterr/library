...
function u3.__index.AddPromise(p14, u15) -- Line: 124
    ...
    local v21 = p14:Add(v16.new(function(p18, p19, p20) -- Line: 132
        -- upvalues: u15 (copy)
        if p20(function() -- Line: 133
            -- upvalues: u15 (ref)
            u15:cancel();
        end) then
            return;
...
function u3.__index.AddObject(p22, p23) -- Line: 154
    -- upvalues: RunService (copy)
...
function u3.__index.Remove(p27, p28) -- Line: 177
    -- upvalues: u1 (copy)
    local v29 = p27[u1];
...
function u3.__index.Get(p33, p34) -- Line: 211
    -- upvalues: u1 (copy)
    local v35 = p33[u1];
...
function u3.__index.Cleanup(p36) -- Line: 222
    -- upvalues: u1 (copy)
        ...
        for i, v in next, p36 do
            if i ~= u1 then
                ...
                if v37 == "string" or v37 == "number" then
                    ...
                    local function warnUser(p40) -- Line: 239
                        -- upvalues: u39 (copy)
                        debug.traceback("", 3);
                    end;

                    if v38 == true then
                        local success, _ = pcall(i);
...
function u3.__index.Destroy(p44) -- Line: 281
    p44:Cleanup();
end;
...
function u45.Disconnect(p46) -- Line: 295
...
function u45.__tostring(p47) -- Line: 302
    return "Disconnect<" .. tostring(p47.Connected) .. ">";
end;

function u3.__index.LinkToInstance(u48, p49, p50) -- Line: 312
    ...
    u51 = p49.AncestryChanged:Connect(function(p55, p56) -- Line: 318, Name: ChangedFunction
...
function u3.__index.LinkToInstances(p57, ...) -- Line: 360
    -- upvalues: u3 (copy)
    local v58 = u3.new();
...
for i, v in next, u3.__index do
    local v59 = string.lower(i);
    local v60 = string.sub(v59, 1, 1) .. string.sub(i, 2);
    u3.__index[v60] = v;
end;
