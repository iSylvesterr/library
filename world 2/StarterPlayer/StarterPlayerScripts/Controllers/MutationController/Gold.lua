...
local function isInsideFruits(p4, p5) -- Line: 14
...
local function createVFXPart(u6) -- Line: 23
    ...
    GrowEffects.AddDescendantsAtBaseline(u6, function() -- Line: 27
...
local function tryCreateVFX(u9) -- Line: 51
    -- upvalues: u2 (copy), GrowEffects (copy), VFX (copy)
    if u9:IsA("Model") and u9.PrimaryPart then
        ...
        if u9:IsA("Model") then
            ...
            GrowEffects.AddDescendantsAtBaseline(u9, function() -- Line: 27
...
local function applyGoldToPart(p12) -- Line: 57
    -- upvalues: u3 (copy)
    p12.Color = u3;
    p12.Reflectance = 0.5;
    p12.Material = Enum.Material.Plastic;
    p12.MaterialVariant = "GoldStudTexture";
end;

function v1.ApplyMutationEffect(u13) -- Line: 64
    ...
    if u13:IsA("Model") and (u13.PrimaryPart and (not u2[u13] and (u13:IsA("Model") and u13.PrimaryPart))) then
        GrowEffects.AddDescendantsAtBaseline(u13, function() -- Line: 27
    ...
    if u13:IsA("BasePart") then
        u13.Color = u3;
        u13.Reflectance = 0.5;
        u13.Material = Enum.Material.Plastic;
        u13.MaterialVariant = "GoldStudTexture";
    end;
    ...
    for _, v in u13:QueryDescendants("BasePart") do
        ...
        if not v16 then
            ...
            v.MaterialVariant = "GoldStudTexture";
        end;
    end;

    u13.DescendantAdded:Connect(function(p17) -- Line: 77
        ...
        if p17:IsA("BasePart") then
            ...
            if not v19 then
                p17.Color = u3;
                p17.Reflectance = 0.5;
                p17.Material = Enum.Material.Plastic;
                p17.MaterialVariant = "GoldStudTexture";
            end;
        end;
        ...
        if not u2[u13] then
            ...
            if u20:IsA("Model") and u20.PrimaryPart then
                ...
                if u20:IsA("Model") then
                    ...
                    GrowEffects.AddDescendantsAtBaseline(u20, function() -- Line: 27
