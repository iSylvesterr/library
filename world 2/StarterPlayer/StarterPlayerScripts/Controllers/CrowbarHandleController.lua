...
local Crowbar = ReplicatedStorage:WaitForChild("Assets"):WaitForChild("Crowbar");
...
function v1.SpawnHandle(u20, u21, p22) -- Line: 85
    -- upvalues: u4 (copy), Crowbar (copy), HandleScale (copy), LocalPlayer (copy), u5 (copy), u6 (copy), HeldHandleSelfHeal (copy), u3 (copy)
    if u4[u21] then
        return;
    end;
    ...
    if v24:IsA("BasePart") then
        ...
        if v26 then
            ...
            v24.CFrame = v23.CFrame * HandleScale.ScaleGripTranslation(u6, v25);
    ...
    if Handle then
        HeldHandleSelfHeal.WatchHandle(u21, Handle, function() -- Line: 165
...
function v1.UpdateToolState(p28, p29) -- Line: 176
...
function v1.DisconnectTool(p33, p34) -- Line: 192
...
function v1.CleanupTool(p36, p37) -- Line: 204
    p36:ClearHandle(p37);
    p36:DisconnectTool(p37);
end;

function v1.IsTrackedTool(p38, p39) -- Line: 209
    return p39:GetAttribute("Crowbar") ~= nil;
end;

function v1.SetupTool(u40, u41, p42) -- Line: 213
    -- upvalues: u3 (copy), u2 (copy)
    u40:DisconnectTool(u41);
    local v43 = {};
    u3[u41] = p42;
    local v44 = u41:GetPropertyChangedSignal("Parent");
    table.insert(v43, v44:Connect(function() -- Line: 219
...
function v1.SetupCharacter(u45, u46) -- Line: 236
    ...
    task.defer(function() -- Line: 237
        ...
        u46.ChildAdded:Connect(function(u48) -- Line: 256
        ...
        HandleScale.MonitorCharacterScale(u46, function(p49) -- Line: 267
            -- upvalues: u45 (ref)
            return u45:IsTrackedTool(p49);
        end, function(p50, p51) -- Line: 268
            -- upvalues: u45 (ref)
...
function v1.SetupPlayer(u52, u53) -- Line: 272
    -- upvalues: BackpackListener (copy)
    if u53.Character then
        u52:SetupCharacter(u53.Character);
    end;

    u53.CharacterAdded:Connect(function(p54) -- Line: 277
        -- upvalues: u52 (copy)
        u52:SetupCharacter(p54);
    end);
    BackpackListener.bind(u53, function(u55) -- Line: 281
