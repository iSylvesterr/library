...
return function(u1) -- Line: 5
    ...
    local function connectVisibilityListeners(p41) -- Line: 293
        ...
        if p41:IsA("GuiObject") then
            ...
            p41:GetPropertyChangedSignal("Size"):Connect(updateChildSize);
        end;
    end;
    ...
    ScrollingFrame.ChildAdded:Connect(function(p42) -- Line: 305
        ...
        if p42:IsA("GuiObject") then
            ...
            p42:GetPropertyChangedSignal("Size"):Connect(updateChildSize);
        end;
