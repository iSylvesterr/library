...
local function connectLoop() -- Line: 418
    -- upvalues: u25 (ref), RunService (copy), u46 (ref), u24 (ref), u18 (ref), u15 (ref), u19 (ref), TweenService (copy), Sound (copy), Part (ref), new (copy), u12 (copy), u22 (ref), u13 (copy), u16 (ref), u28 (ref), u14 (copy), u23 (ref), u29 (ref), u17 (ref)
    local u47 = Random.new();
    local u48 = true;
    local u49 = 6;
    table.insert(u25, RunService.RenderStepped:connect(function() -- Line: 426
        -- upvalues: u46 (ref), u24 (ref), u18 (ref), u15 (ref), u19 (ref), TweenService (ref), Sound (ref), u49 (ref), Part (ref), new (ref), u48 (ref)
        local v50, _ = u46(Ray.new(workspace.CurrentCamera.CFrame.p, -u24 * 1000), true);

        if u18 and workspace.CurrentCamera.CFrame.p.y > u18 or v50 then
        ...
        u49 = 6;
        local v51 = workspace.CurrentCamera.CFrame.lookVector:Dot(u24);
        local v52 = math.abs(v51);
        local p = workspace.CurrentCamera.CFrame.p;
        local v53 = workspace.CurrentCamera.CFrame.lookVector:Cross(-u24);
        local v54 = v53.magnitude > 0.001 and v53.unit or -u24;
        local unit = u24:Cross(v54).unit;
        Part.Size = new(40, 40, (1 - v52) * 60 + 40);
        Part.CFrame = CFrame.new(p.x, p.y, p.z, v54.x, -u24.x, unit.x, v54.y, -u24.y, unit.y, v54.z, -u24.z, unit.z) + (1 - v52) * workspace.CurrentCamera.CFrame.lookVector * Part.Size.Z / 3 - v52 * u24 * 20;
    ...
    table.insert(u25, v55:connect(function() -- Line: 485
        -- upvalues: u49 (ref), u24 (ref), u12 (ref), u22 (ref), u13 (ref), u16 (ref), u48 (ref), u28 (ref), u19 (ref), u18 (ref), u14 (ref), u46 (ref), u15 (ref), TweenService (ref), Sound (ref), Part (ref), u23 (ref), u29 (ref), u47 (copy), new (ref), u17 (ref)
        u49 = u49 + 1;

        if u49 >= 6 then
            local v56 = workspace.CurrentCamera.CFrame.lookVector:Dot(u24);
            local v57 = math.abs(v56);
            local v58 = NumberSequence.new({
                u12,
                NumberSequenceKeypoint.new(0.25, (1 - v57) * u22 + v57, 0),
                NumberSequenceKeypoint.new(0.75, (1 - v57) * u22 + v57, 0),
                u13
            });
            local v59 = NumberSequence.new({
                u12,
                NumberSequenceKeypoint.new(0.25, v57 * u16 + (1 - v57), 0),
                NumberSequenceKeypoint.new(0.75, v57 * u16 + (1 - v57), 0),
                u13
            });
            local v60 = workspace.Camera.CFrame:inverse() * (workspace.Camera.CFrame.p - u24);
            ...
            if u48 then
                ...
                if not u19 then
                    ...
                    if u18 and workspace.CurrentCamera.CFrame.p.y > u18 then
                        v63 = 0;
                    else
                        local v64 = -u24 * 1000;
                        local v65 = 35;
        ...
        local p = workspace.CurrentCamera.CFrame.p;
        local v66 = workspace.CurrentCamera.CFrame.lookVector:Cross(-u24);
        local v67 = v66.magnitude > 0.001 and v66.unit or -u24;
        local unit = u24:Cross(v67).unit;
        local v68 = CFrame.new(p.x, p.y, p.z, v67.x, -u24.x, unit.x, v67.y, -u24.y, unit.y, v67.z, -u24.z, unit.z);
        local v69 = u24 * 550;
        ...
        for i = 1, u23 do
            ...
            if v74 then
                ...
                if u48 then
                    local v77 = v75 - u24 * 50;

                    if u18 and (u18 < v77.Y and u24.Y < 0) then
                        v77 = v77 + u24 * (u18 - v77.Y) / u24.Y;
                    end;
            ...
            elseif u48 then
                ...
                if u18 and (u18 < v78.Y and u24.Y < 0) then
                    v78 = v78 + u24 * (u18 - v78.Y) / u24.Y;
                end;
...
local function disable() -- Line: 655
    -- upvalues: disconnectLoop (copy), Part (ref), u19 (ref), disableSound (copy)
    disconnectLoop();
    Part.RainStraight.Enabled = false;
    Part.RainTopDown.Enabled = false;
    Part.Size = Vector3.new(0.05, 0.05, 0.05);
...
local function updateTransparency(p89) -- Line: 699
    -- upvalues: NumberValue (copy), u22 (ref), u16 (ref), u12 (copy), u13 (copy), u29 (ref)
...
local v112 = {
    ...
    Enable = function(p103, p104) -- Line: 782, Name: Enable
        -- upvalues: disconnectLoop (copy), Part (ref), u29 (ref), u28 (ref), RunService (copy), SoundGroup (copy), connectLoop (copy), TweenService (copy), NumberValue (copy), Sound (copy), u19 (ref)
    ...
    Disable = function(p105, p106) -- Line: 820, Name: Disable
        -- upvalues: TweenService (copy), NumberValue (copy), disconnectLoop (copy), Part (ref), u19 (ref), disableSound (copy)
        ...
        if p106 then
            ...
            u107.Completed:connect(function(p108) -- Line: 828
                -- upvalues: disconnectLoop (ref), Part (ref), u19 (ref), disableSound (ref), u107 (copy)
...
function v112.SetCollisionMode(p160, p161, p162) -- Line: 987
    -- upvalues: u11 (copy), u20 (ref), u21 (ref), Part (ref), None (ref), u46 (ref), u45 (copy)
