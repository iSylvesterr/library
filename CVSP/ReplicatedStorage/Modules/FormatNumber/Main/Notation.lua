...
function v4.WithMinExponentDigits(p6, p7) -- Line: 21
...
function v4.WithExponentSignDisplay(p11, p12) -- Line: 31
    -- upvalues: _internal (copy), u5 (copy)
...
function v1.scientific() -- Line: 61
...
function v1.engineering() -- Line: 72
    -- upvalues: u5 (copy), _internal (copy)
    return u5({
        power10Scale = 3,
        minExponentDigits = 1,
...
function v1.compactWithSuffixThousands(p16) -- Line: 83
