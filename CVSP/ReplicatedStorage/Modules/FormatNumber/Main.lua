...
function v2.Notation(p4, p5) -- Line: 24
...
function v2.Precision(p6, p7) -- Line: 34
    -- upvalues: _internal (copy), u3 (copy)
...
function v2.RoundingMode(p8, p9) -- Line: 44
...
function v2.Grouping(p10, p11) -- Line: 54
    -- upvalues: _internal (copy), enums (copy), u3 (copy)
...
function v2.IntegerWidth(p12, p13) -- Line: 64
    -- upvalues: _internal (copy), u3 (copy)
...
function v2.Symbols(p14, p15) -- Line: 74
    -- upvalues: _internal (copy), u3 (copy)
...
function v2.Sign(p16, p17) -- Line: 84
    -- upvalues: _internal (copy), enums (copy), u3 (copy)
...
function v2.Decimal(p18, p19) -- Line: 94
    -- upvalues: _internal (copy), enums (copy), u3 (copy)
...
local function resolve_nf_data(p20) -- Line: 105
...
function v2.ToSkeleton(p31) -- Line: 164
    -- upvalues: _internal (copy)
...
function v1.with() -- Line: 172
    -- upvalues: u3 (copy)
    return u3(nil);
end;

function v1.forSkeleton(p33) -- Line: 176
    -- upvalues: _internal (copy), u3 (copy)
