...
local function precision_to_skeleton(p6) -- Line: 40
...
local function int_width_to_skeleton(p18) -- Line: 122
    if p18.max == -1 then
...
function v1.settings_to_skeleton(p20) -- Line: 143
...
local function skeleton_to_scientific_notation(p29) -- Line: 258
...
local function skeleton_to_scientific_notation_concise(p33) -- Line: 296
...
local function skeleton_to_precision(p39) -- Line: 335
...
local function skeleton_to_int_width(p58) -- Line: 455
...
local function skeleton_to_int_width_concise(p62) -- Line: 487
...
function v1.to_option_linked_list(p63) -- Line: 493
