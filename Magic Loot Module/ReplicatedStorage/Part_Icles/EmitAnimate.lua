...
return function(u1) -- Line: 19
    ...
    function u1.EmitAttachmentAnimate(p52, p53, p54, p55) -- Line: 290
    ...
    function u1.EmitBeamAnimate(p83, p84, p85, p86) -- Line: 460
    ...
    function u1._refreshAnimateNonSpatial(p101, p102, p103) -- Line: 567
        -- upvalues: Graph (ref)
        if not p103 then
            return;
        end;
