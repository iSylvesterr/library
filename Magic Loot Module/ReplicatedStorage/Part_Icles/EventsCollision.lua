...
local function applySnapCFrame(p11, p12) -- Line: 157
...
local function readWorldCF(p13) -- Line: 170
...
local function bounceParentCF(p14) -- Line: 183
...
local function attachmentBounceLocalPos(p16, p17) -- Line: 200
    -- upvalues: PartConstants (copy)
...
local function handleKillOrStop(p21, p22, p23, p24) -- Line: 228
...
local function handleBounce(p29, p30, p31, p32) -- Line: 261
...
function v1.handle(p76, p77, p78, p79, p80) -- Line: 475
