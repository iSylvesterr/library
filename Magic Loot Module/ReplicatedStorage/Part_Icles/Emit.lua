...
return function(u2) -- Line: 33
    ...
    function u2.EmitAttachment(p56, p57, p58, p59) -- Line: 413
    ...
    function u2.EmitBeam(p94, p95, p96, p97) -- Line: 688
