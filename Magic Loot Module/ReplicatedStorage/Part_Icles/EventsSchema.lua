...
local function getConfig(p17) -- Line: 182
...
local function getTypeName(p19) -- Line: 189
    -- upvalues: TypeRegistry (copy)
...
function u1.isValidForItem(p24, p25) -- Line: 207
...
function u1.isValidForTypeName(p27, p28) -- Line: 217
    -- upvalues: u15 (copy)
    local v29 = u15[p27];
...
function u1.readEvent(p30, p31) -- Line: 223
    -- upvalues: u1 (copy)
...
function u1.ensureExcludeListFolder(p34) -- Line: 235
    if not p34 then
        return nil;
    end;
...
function u1.readEnabled(p35) -- Line: 266
...
function u1.ensure(p56) -- Line: 308
    -- upvalues: TypeRegistry (copy)
    local v57;
...
function u1.ensureEvent(p59, p60) -- Line: 324
...
function u1.setEnabled(p63, p64, p65) -- Line: 351
    -- upvalues: u1 (copy)
    if p65 then
...
function u1.trustEvent(p68, p69) -- Line: 374
    -- upvalues: u1 (copy)
...
function u1.trustAllEvents(p71) -- Line: 388
    -- upvalues: u1 (copy)
...
function u1.stampImportedUntrusted(p74) -- Line: 410
    -- upvalues: u1 (copy)
...
function u1.deleteEvent(p77, p78) -- Line: 427
    -- upvalues: u1 (copy)
...
function u1.sanitize(p81) -- Line: 445
...
function u1.snapshot(p95) -- Line: 559
...
function u1.apply(p100, p101) -- Line: 603
