...
function u1.Client_EnterStartup(u9) -- Line: 171
    ...
    task.delay(1.4, function() -- Line: 232
...
function u1.Server_EnterStartup(p18) -- Line: 237
end;

function u1.Client_EnterSummon(u19) -- Line: 242
    ...
    local function stillSummon() -- Line: 256
    ...
    local function scheduleFormationL4() -- Line: 273
        ...
        task.delay(0.4, function() -- Line: 274
            ...
            local v27 = material["召唤法阵3级_Emit和Enable"];
    ...
    local u31 = 0;
    local u32 = false;
    SkillCommon.connectRunEventWhile(skillRunData, "召唤空间球飞行", RunService.Heartbeat, stillSummon, function(p33) -- Line: 313
        ...
        if not v35 then
            task.delay(0.4, function() -- Line: 274
                ...
                local v37 = material["召唤法阵3级_Emit和Enable"];
        ...
        SkillCommon.playSoundLocal3D("音效-召唤法术-召唤物的法阵圈3", u25.Position);
...
function u1.Client_ExitSummon(p38) -- Line: 348
...
function u1.Server_EnterSummon(u40) -- Line: 361
    ...
    task.delay(1, function() -- Line: 381, Name: doSummon
        ...
        UtilsSystem.SystemSummon.CreateSummon(v44, 20000008, u43, {
...
function u1.Server_ExitSummon(p45) -- Line: 415
end;

function u1.Server_EnterRecovery(p46) -- Line: 420
    p46:releaseControl();
end;

function u1.Client_EnterRecovery(p47) -- Line: 424
end;

function u1.onEnd(p48) -- Line: 428
...
u1.SoundList = { "音效-召唤法术-通用融合", "音效-召唤法术-通用法阵圈消散", "音效-召唤法术-通用法阵", "音效-召唤法术-通用投掷", "音效-召唤法术-召唤物的法阵圈3" };
u1.AnimateList = { "小召唤术" };
u1.ResNameList = { "召唤法阵A01_起手空间法阵_Emit", "召唤法阵A02_起手空间爆点_Emit", "召唤法阵A03_空间球_Enable", "召唤法阵A04_空间爆发_Emit", "召唤法阵3级_Emit和Enable", "召唤系尾迹" };
u1.hitboxConfig = {};
u1.Action = {
    {
        action = "Animation",
