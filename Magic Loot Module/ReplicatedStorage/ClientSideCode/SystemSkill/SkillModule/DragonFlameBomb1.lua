...
function v1.Client_EnterStartup(p15) -- Line: 159
    ...
    local u17 = skillRunData.material["龙炎弹蓄力"];
    ...
    skillRunData.runEvent["龙炎弹蓄力跟随"] = RunService.Heartbeat:Connect(function() -- Line: 184
...
function v1.Client_ExitStartup(p19) -- Line: 191
    ...
    if v20 and v20["龙炎弹蓄力跟随"] then
        v20["龙炎弹蓄力跟随"]:Disconnect();
        v20["龙炎弹蓄力跟随"] = nil;
    end;
    ...
    if skillRunData and skillRunData.material then
        local v21 = skillRunData.material["龙炎弹蓄力"];
...
function v1.Client_EnterShotBomb(u24) -- Line: 208
    ...
    local u31 = material["龙炎弹火球"];
    local u32 = material["龙炎弹爆炸"];
    ...
    local u33 = 0;
    local u34 = false;
    skillRunData.runEvent["龙炎弹火球移动"] = RunService.Heartbeat:Connect(function(p35) -- Line: 258
        ...
        if v36 >= 1 and not u34 then
            ...
            if v39 and v39["龙炎弹火球移动"] then
                v39["龙炎弹火球移动"]:Disconnect();
                v39["龙炎弹火球移动"] = nil;
            end;
        end;
    end);
...
function v1.Client_ExitShotBomb(p40) -- Line: 277
    ...
    if v41 and v41["龙炎弹火球移动"] then
        v41["龙炎弹火球移动"]:Disconnect();
        v41["龙炎弹火球移动"] = nil;
    end;

    local v42 = p40.skillRunData and p40.skillRunData.material and p40.skillRunData.material["龙炎弹火球"];
...
function v1.Client_EnterRecovery(p57) -- Line: 334
    ...
    if v58 and v58["龙炎弹蓄力跟随"] then
        v58["龙炎弹蓄力跟随"]:Disconnect();
        v58["龙炎弹蓄力跟随"] = nil;
    end;

    local v59 = p57.skillRunData and p57.skillRunData.runEvent;

    if v59 and v59["龙炎弹火球移动"] then
        v59["龙炎弹火球移动"]:Disconnect();
        v59["龙炎弹火球移动"] = nil;
    end;
end;
...
v1.AnimateList = { "龙炎弹" };
v1.ResNameList = { "龙炎弹出现", "龙炎弹火球", "龙炎弹爆炸", "龙炎弹蓄力" };
v1.hitboxConfig = { {
        HitboxIndex = 1,
        PartName = "通用球",
