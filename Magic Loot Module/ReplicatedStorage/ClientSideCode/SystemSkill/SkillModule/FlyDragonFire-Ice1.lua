...
function v1.Client_EnterFlyFire(p50) -- Line: 235
    ...
    local u54 = material["飞龙吐息喷射火焰-冰"];
    local u55 = material["飞龙吐息地面火焰-冰"];
...
function v1.Client_ExitFlyFire(p60) -- Line: 289
    ...
    if v62 then
        local v63 = v62["飞龙吐息喷射火焰-冰"];
        local v64 = v62["飞龙吐息地面火焰-冰"];
...
v1.AnimateList = { "飞龙吐息" };
v1.ResNameList = { "飞龙吐息喷射火焰-冰", "飞龙吐息地面火焰-冰", "飞龙吐息起手-冰" };
v1.hitboxConfig = { {
        HitboxIndex = 1,
        PartName = "通用长方体",
