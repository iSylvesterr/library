...
function u1.Client_EnterSummon(u19) -- Line: 244
    ...
    local function scheduleFormationL4() -- Line: 275
        ...
        task.delay(0.4, function() -- Line: 276
            ...
            local v27 = material["召唤法阵1级_Emit和Enable"];
    ...
    SkillCommon.connectRunEventWhile(skillRunData, "召唤空间球飞行", RunService.Heartbeat, stillSummon, function(p33) -- Line: 315
        ...
        if not v35 then
            task.delay(0.4, function() -- Line: 276
                ...
                local v37 = material["召唤法阵1级_Emit和Enable"];
        ...
        SkillCommon.playSoundLocal3D("音效-召唤法术-召唤物的法阵圈1", u25.Position);
...
function u1.Server_EnterSummon(u40) -- Line: 363
    ...
    task.delay(1, function() -- Line: 383, Name: doSummon
        ...
        UtilsSystem.SystemSummon.CreateSummon(v44, 20000001, u43, {
...
u1.SoundList = { "音效-召唤法术-通用融合", "音效-召唤法术-通用法阵圈消散", "音效-召唤法术-通用法阵", "音效-召唤法术-通用投掷", "音效-召唤法术-召唤物的法阵圈1" };
u1.AnimateList = { "小召唤术" };
u1.ResNameList = { "召唤法阵A01_起手空间法阵_Emit", "召唤法阵A02_起手空间爆点_Emit", "召唤法阵A03_空间球_Enable", "召唤法阵A04_空间爆发_Emit", "召唤法阵1级_Emit和Enable", "召唤系尾迹" };
u1.hitboxConfig = {};
u1.Action = {
    {
        action = "Animation",
