...
function v1.Client_EnterSwing(u8) -- Line: 102
    ...
    local u9 = u8.skillRunData.material["蜘蛛撕咬特效"];
    ...
    u8.skillRunData.runEvent["刀光特效控制"] = RunService.Heartbeat:Connect(function(p10) -- Line: 120
        ...
        if HumanoidRootPart and HumanoidRootPart.Parent then
            ...
            u9:PivotTo(v11:ToWorldSpace(CFrame.new(0, 0, -2.5 * (character2 and character2:GetScale() or 1))));
        end;
    end);
end;
...
function v1.Server_EnterSwing(u13) -- Line: 137
    ...
    u13.skillRunData.runEvent["命中盒控制"] = RunService.Heartbeat:Connect(function(p15) -- Line: 146
        ...
        if HumanoidRootPart and HumanoidRootPart.Parent then
            ...
            hitbox:PivotTo(v16:ToWorldSpace(CFrame.new(0, 0, -2.5 * (character2 and character2:GetScale() or 1))));
        end;
    end);
end;
...
v1.SoundList = { "音效-蜘蛛攻击" };
v1.AnimateList = { "蜘蛛撕咬" };
v1.ResNameList = { "蜘蛛撕咬特效" };
v1.hitboxConfig = { {
        HitboxIndex = 1,
        PartName = "通用球",
