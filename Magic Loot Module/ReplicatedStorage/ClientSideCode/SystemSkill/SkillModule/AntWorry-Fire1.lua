...
function v1.Client_EnterSwing(u8) -- Line: 102
    ...
    local u9 = u8.skillRunData.material["森林蚁啃咬-火"];
    ...
    u8.skillRunData.runEvent["刀光特效控制"] = RunService.Heartbeat:Connect(function(p10) -- Line: 120
        ...
        if HumanoidRootPart and HumanoidRootPart.Parent then
            ...
            u9:PivotTo(v11:ToWorldSpace(CFrame.new(0, 0, -3 * (character2 and character2:GetScale() or 1))));
        end;
    end);
end;
...
v1.SoundList = { "音效-蚂蚁攻击" };
v1.AnimateList = { "蚂蚁撕咬攻击" };
v1.ResNameList = { "森林蚁啃咬-火" };
v1.hitboxConfig = { {
        HitboxIndex = 1,
        PartName = "通用球",
