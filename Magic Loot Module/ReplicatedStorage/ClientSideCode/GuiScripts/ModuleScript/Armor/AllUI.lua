...
local Armor = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui", (1 / 0)):WaitForChild("ScreenGui", (1 / 0)):WaitForChild("Armor", (1 / 0));
local v1 = Armor:FindFirstChild("ContentClip") or Armor;
