...
function u1.SetObject(p3, p4) -- Line: 99
    p3.m_Object = p4;
    p3:UpdateTransform();
end;
...
function u1.GetClosestPoint(p10, p11, p12) -- Line: 131
...
function u1.Step(p16) -- Line: 176
    p16:UpdateTransform();
end;

function u1.DrawDebug(p17, p18, p19, p20, p21, p22) -- Line: 188
    -- upvalues: Gizmo (copy)
...
function u1.Destroy(p34) -- Line: 280
