...
return function(u1, u2) -- Line: 3
    ...
    local function generateButtons(u22, p23, p24, p25) -- Line: 194
    ...
    local function generateInputScalar(u35, u36, u37) -- Line: 252
        ...
        return {
            ...
            Update = function(p48) -- Line: 376, Name: Update
            ...
            Discard = function(p60) -- Line: 421, Name: Discard
                -- upvalues: u2 (ref)
                p60.Instance:Destroy();
                u2.discardState(p60);
            end,

            GenerateState = function(p61) -- Line: 425, Name: GenerateState
            ...
            UpdateState = function(p62) -- Line: 433, Name: UpdateState
    ...
    local function DragMouseDown(p73, p74, p75, p76, p77) -- Line: 502
    ...
    u2.UserInputService.InputEnded:Connect(function(p81) -- Line: 525
    ...
    local function generateDragScalar(u82, u83, u84) -- Line: 533
        ...
        return {
            ...
            Events = {
                numberChanged = u5,
                hovered = u2.EVENTS.hover(function(p85) -- Line: 546
                    return p85.Instance;
                end)
            },

            Generate = function(u86) -- Line: 550, Name: Generate
                ...
                for i = 1, u83 do
                    ...
                    TextButton.MouseButton1Down:Connect(function(p96, p97) -- Line: 699
            ...
            Update = function(p98) -- Line: 719, Name: Update
            ...
            Discard = function(p110) -- Line: 759, Name: Discard
                -- upvalues: u2 (ref)
                p110.Instance:Destroy();
                u2.discardState(p110);
            end,

            GenerateState = function(p111) -- Line: 763, Name: GenerateState
            ...
            UpdateState = function(p112) -- Line: 771, Name: UpdateState
    ...
    local function generateColorDragScalar(u116, ...) -- Line: 819
        ...
        return u2.extend(v118, {
            ...
            Update = function(p119) -- Line: 830, Name: Update
            ...
            GenerateState = function(p120) -- Line: 857, Name: GenerateState
    ...
    local function SliderMouseDown(p133, p134, p135) -- Line: 915
    ...
    u2.UserInputService.InputEnded:Connect(function(p136) -- Line: 931
    ...
    local function generateSliderScalar(u137, u138, u139, ...) -- Line: 940
        ...
        return {
            ...
            Events = {
                numberChanged = u5,
                hovered = u2.EVENTS.hover(function(p140) -- Line: 953
                    return p140.Instance;
                end)
            },

            Generate = function(u141) -- Line: 957, Name: Generate
            ...
            Update = function(p149) -- Line: 1118, Name: Update
            ...
            Discard = function(p167) -- Line: 1176, Name: Discard
                -- upvalues: u2 (ref)
                p167.Instance:Destroy();
                u2.discardState(p167);
            end,

            GenerateState = function(p168) -- Line: 1180, Name: GenerateState
            ...
            UpdateState = function(p169) -- Line: 1188, Name: UpdateState
    ...
    local function generateEnumSliderScalar(u180, u181) -- Line: 1238
        ...
        return u2.extend(v182, {
            ...
            Update = function(p184) -- Line: 1250, Name: Update
            ...
            GenerateState = function(p188) -- Line: 1266, Name: GenerateState
    ...
    u1.WidgetConstructor("InputText", {
        ...
        Events = {
            textChanged = {
                Init = function(p190) -- Line: 1319
                    p190.lastTextchangeTick = 0;
                end,

                Get = function(p191) -- Line: 1322
                    -- upvalues: u1 (copy)
                    return p191.lastTextchangeTick == u1._cycleTick;
                end
            },
            hovered = u2.EVENTS.hover(function(p192) -- Line: 1326
                return p192.Instance;
            end)
        },

        Generate = function(u193) -- Line: 1330, Name: Generate
        ...
        Update = function(p195) -- Line: 1384, Name: Update
        ...
        Discard = function(p196) -- Line: 1392, Name: Discard
            -- upvalues: u2 (copy)
            p196.Instance:Destroy();
            u2.discardState(p196);
        end,

        GenerateState = function(p197) -- Line: 1396, Name: GenerateState
            -- upvalues: u1 (copy)
        ...
        UpdateState = function(p198) -- Line: 1401, Name: UpdateState
