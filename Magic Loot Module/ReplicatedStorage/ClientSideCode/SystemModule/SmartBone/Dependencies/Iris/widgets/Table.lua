...
return function(u1, u2) -- Line: 3
    ...
    u1.WidgetConstructor("Table", {
        ...
        Events = {
            hovered = u2.EVENTS.hover(function(p4) -- Line: 23
                return p4.Instance;
            end)
        },

        Generate = function(p5) -- Line: 27, Name: Generate
        ...
        Update = function(p6) -- Line: 51, Name: Update
        ...
        Discard = function(p9) -- Line: 113, Name: Discard
            -- upvalues: u3 (copy)
            u3[p9.ID] = nil;
            p9.Instance:Destroy();
        end,

        ChildAdded = function(p10) -- Line: 117, Name: ChildAdded
            -- upvalues: u2 (copy), u1 (copy)
            ...
            if p10.arguments.RowBg ~= false then
                local v14 = math.ceil(p10.RowColumnIndex / p10.InitialNumColumns);
                local v15;

                if v14 % 2 == 0 then
                    v15 = u1._config.TableRowBgAltColor;
                else
                    v15 = u1._config.TableRowBgColor;
                end;

                local v16;

                if v14 % 2 == 0 then
                    v16 = u1._config.TableRowBgAltTransparency;
                else
                    v16 = u1._config.TableRowBgTransparency;
                end;

                Frame.BackgroundColor3 = v15;
                Frame.BackgroundTransparency = v16;
            end;
