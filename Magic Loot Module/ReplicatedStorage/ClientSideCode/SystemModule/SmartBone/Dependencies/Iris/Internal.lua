...
return function(u1) -- Line: 3
    ...
    function v3.onChange(p7, p8) -- Line: 99
    ...
    function u2.WidgetConstructor(p13, p14) -- Line: 210
    ...
    function u2._Insert(p24, p25, p26) -- Line: 308
        -- upvalues: u2 (copy)
        local v27 = nil;
    ...
    function u2._GenNewWidget(p33, p34, p35, p36) -- Line: 375
        -- upvalues: u2 (copy)
        ...
        function v41.__index(p42, u43) -- Line: 432
    ...
    function u2._ContinueWidget(p44, p45) -- Line: 440
        -- upvalues: u2 (copy)
    ...
    function u2._DiscardWidget(p48) -- Line: 454
        -- upvalues: u2 (copy)
    ...
    function u2._widgetState(p49, p50, p51) -- Line: 465
        -- upvalues: u2 (copy)
    ...
    function u2._EventCall(p53, p54) -- Line: 481
        -- upvalues: u2 (copy)
    ...
    function u2._getID(p57) -- Line: 543
        -- upvalues: u2 (copy)
    ...
    function u2._deepCompare(p62, p63) -- Line: 570
        -- upvalues: u2 (copy)
        for i, v in p62 do
            local v64 = p63[i];
    ...
    function u2._deepCopy(p65) -- Line: 592
        -- upvalues: u2 (copy)
        local v66 = {};
