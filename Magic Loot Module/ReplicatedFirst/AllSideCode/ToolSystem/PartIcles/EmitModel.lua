...
return function(u1) -- Line: 18
    -- upvalues: Range (copy), DirectionVectors (copy), AxisLinks (copy), PartConstants (copy), Graph (copy), Pool (copy), Particles (copy), StaticPass (copy), NestedEmit (copy), Events (copy)
    function u1.EmitModel(u2, p3, p4, p5) -- Line: 21
        -- upvalues: Range (ref), DirectionVectors (ref), AxisLinks (ref), PartConstants (ref), Graph (ref), Pool (ref), Particles (ref), u1 (copy), StaticPass (ref), NestedEmit (ref)
        ...
        local u36 = {};
        NestedEmit.walk(u2, v6.RenderTemplate, u24, v27._nestedAlive, p5, function(p37) -- Line: 276
    ...
    function u1.EmitModelAnimate(p38, u39, p40, p41) -- Line: 284
        -- upvalues: Range (ref), DirectionVectors (ref), AxisLinks (ref), PartConstants (ref), Graph (ref), Particles (ref), u1 (copy), StaticPass (ref), Events (ref)
        ...
        local success, result = pcall(function() -- Line: 430
            -- upvalues: u39 (copy)
            return u39:GetScale();
        end);
