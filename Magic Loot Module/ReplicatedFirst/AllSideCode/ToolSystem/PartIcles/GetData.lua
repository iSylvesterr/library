...
local function safeEnum(u1, u2, p3) -- Line: 12
    if not u2 then
        return p3;
    end;
...
local function readAxisLinks(p4) -- Line: 19
...
return function(p6) -- Line: 30
    -- upvalues: TypeRegistry (copy), EventsSchema (copy), readAxisLinks (copy), Flipbook (copy)
    function p6.GetData(p7, p8) -- Line: 34
        -- upvalues: TypeRegistry (ref), EventsSchema (ref), readAxisLinks (ref), Flipbook (ref)
        local v9 = {};
        ...
        function v9.CheckEnabled() -- Line: 65
            -- upvalues: u10 (copy)
            local v14;
