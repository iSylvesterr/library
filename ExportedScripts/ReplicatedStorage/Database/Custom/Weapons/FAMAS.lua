...
return table.freeze({
    ...
    Capacity = 90,
    Rounds = 25,
    CharacterAnimations = ReplicatedStorage.Assets.WeaponAnimations.FAMAS.CharacterAnimations,
    CameraAnimations = ReplicatedStorage.Assets.WeaponAnimations.FAMAS.CameraAnimations,
    ShowCrosshair = true
});