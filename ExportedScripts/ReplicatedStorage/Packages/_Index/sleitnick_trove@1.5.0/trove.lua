...
function u8.Add(p10, p11, p12) -- Line: 238
...
function u8.Clone(p14, p15) -- Line: 260
...
function u8.Construct(p16, p17, ...) -- Line: 303
...
function u8.Connect(p20, p21, p22) -- Line: 336
...
function u8.BindToRenderStep(p23, u24, p25, p26) -- Line: 359
...
function u8.Remove(p29, p30) -- Line: 428
...
function u8.Extend(p31) -- Line: 457
    -- upvalues: u8 (copy)
...
function u8.Clean(p32) -- Line: 477
...
function u8.WrapClean(u33) -- Line: 519
...
function u8._findAndRemoveFromObjects(p34, p35, p36) -- Line: 525
...
function u8._cleanupObject(p38, p39, p40) -- Line: 545
...
function u8.AttachToInstance(u41, p42) -- Line: 585
    ...
    return u41:Connect(p42.Destroying, function() -- Line: 592
        -- upvalues: u41 (copy)
        u41:Destroy();
    end);
end;

function u8.Destroy(p43) -- Line: 606
    p43:Clean();
end;
