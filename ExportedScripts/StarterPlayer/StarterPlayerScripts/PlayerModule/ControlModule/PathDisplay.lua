...
local function renderPoint(p10, p11) -- Line: 57
    ...
    local v15, v16, v17 = workspace:FindPartOnRayWithIgnoreList(v14, { game:GetService("Players").LocalPlayer.Character, workspace.CurrentCamera });
...
function u3.setCurrentPoints(p18) -- Line: 92
    -- upvalues: u6 (ref)
...
function u3.clearRenderedPath() -- Line: 100
...
function u3.renderPath() -- Line: 109
