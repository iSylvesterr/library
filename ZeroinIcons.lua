...
-- Zeroin compatibility aliases. Existing scripts keep working while every
-- value now resolves to Footagesus/Lucide assets from the separate icon pack.
local Aliases = {
    home = "house",
    info = "info",
    player = "user-round",
...
local function normalize(name)
    ...
    local value = name:lower():gsub("_", "-"):gsub("%s+", "-")
    value = value:gsub("^lucide:", "")
    return Aliases[value] or value
end

function IconPack.ResolveName(name)
