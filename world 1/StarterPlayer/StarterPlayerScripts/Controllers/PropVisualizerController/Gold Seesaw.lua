...
return function(u3) -- Line: 44
    ...
    local function ApplyLocalExitFling(p21) -- Line: 133
        ...
        local v25 = math.lerp(1.25, 18.75, v24);
        ...
        local v28 = v27 * 6.25 * v25 + Vector3.new(0, v25 * 20, 0);
    ...
    ConnectLocalUnsit();
    LocalPlayer.CharacterAdded:Connect(function() -- Line: 331
        -- upvalues: ConnectLocalUnsit (copy)
        task.wait();
        ConnectLocalUnsit();
    end);
    u3.Destroying:Connect(function() -- Line: 336
