...
return function(u3) -- Line: 44
    ...
    local function ApplyLocalExitFling(p21) -- Line: 133
        ...
        local v28 = v27 * 5 * v25 + Vector3.new(0, v25 * 16, 0);
    ...
    local u64 = Networking.Seesaw.SeatChanged.OnClientEvent:Connect(function(p45, p46, p47, p48, u49) -- Line: 274
    ...
    for i = 1, 2 do
        u7[i].Touched:Connect(function(p65) -- Line: 313
    ...
    u3.Destroying:Connect(function() -- Line: 340
