...
return function(u1, u2) -- Line: 6
    ...
    local function updateBorderSize() -- Line: 349
    ...
    u1:setBehaviour("IconImage", "Image", function(p39) -- Line: 371
    ...
    u1.alignmentChanged:Connect(function(p41) -- Line: 378
    ...
    NumberValue:GetPropertyChangedSignal("Value"):Connect(function() -- Line: 389
