...
local function getTranslatorForLocale(p4) -- Line: 28
...
local function formatByKeyWithFallback(u7, u8, u9) -- Line: 40
    -- upvalues: u1 (ref)
...
return {
    FormatByKey = function(p10, p11, p12) -- Line: 54, Name: FormatByKey
        -- upvalues: u2 (ref), PlayerGui (copy), LocalizationService (copy)
        if u2 == nil then
            u2 = PlayerGui.CoreScriptLocalization:GetTranslator(LocalizationService.RobloxLocaleId);
        end;
    ...
    FormatByKeyForLocale = function(p13, p14, p15, p16) -- Line: 62, Name: FormatByKeyForLocale
        -- upvalues: u3 (copy), PlayerGui (copy)
        local v17 = u3[p15];
