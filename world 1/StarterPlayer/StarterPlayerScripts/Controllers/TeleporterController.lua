...
local function clearPreview() -- Line: 149
    -- upvalues: u9 (ref), u10 (ref), u6 (ref)
    if u9 then
        u9:Destroy();
        u9 = nil;
    end;
...
local function createPreview() -- Line: 161
    -- upvalues: u7 (ref), u9 (ref), u10 (ref), u6 (ref), LocalPlayer (copy), applyTransparencyToClone (copy), Temporary (copy)
    if u7 == nil then
        return;
    end;
...
local function updatePreview() -- Line: 190
    -- upvalues: u9 (ref), u4 (ref), LocalPlayer (copy), u6 (ref), Temporary (copy)
    if not u9 then
        return;
    end;
...
local function doTeleport() -- Line: 271
    -- upvalues: LocalPlayer (copy), u4 (ref), Networking (copy), spawnTeleportTrail (copy)
    local Character = LocalPlayer.Character;
...
local function onToolEquipped(p34) -- Line: 299
    -- upvalues: u5 (ref), u4 (ref), u1 (copy), createPreview (copy), u10 (ref), RunService (copy), u9 (ref), LocalPlayer (copy), u6 (ref), Temporary (copy)
    if not p34:GetAttribute("Teleporter") then
        return;
    end;

    u5 = p34;
    u4 = u1[p34:GetAttribute("Teleporter")] or 10;
    createPreview();
    u10 = RunService.RenderStepped:Connect(function() -- Line: 308
        -- upvalues: u9 (ref), u4 (ref), LocalPlayer (ref), u6 (ref), Temporary (ref)
        debug.profilebegin("Controllers/TeleporterController/PreviewUpdate");

        if u9 and u9.PrimaryPart then
            local v35 = u4;
            local Character = LocalPlayer.Character;
...
local function onToolUnequipped(p38) -- Line: 315
    -- upvalues: u5 (ref), u9 (ref), u10 (ref), u6 (ref)
    if u5 ~= p38 then
        return;
    end;
...
local function tryTeleport() -- Line: 325
    -- upvalues: u5 (ref), u2 (ref), doTeleport (copy), createPreview (copy), u10 (ref), RunService (copy), u9 (ref), u4 (ref), LocalPlayer (copy), u6 (ref), Temporary (copy)
    if not u5 then
        return;
    end;
    ...
    task.defer(function() -- Line: 335
        -- upvalues: u5 (ref), createPreview (ref), u10 (ref), RunService (ref), u9 (ref), u4 (ref), LocalPlayer (ref), u6 (ref), Temporary (ref)
        if u5 then
            createPreview();

            if not u10 then
                u10 = RunService.RenderStepped:Connect(function() -- Line: 339
                    -- upvalues: u9 (ref), u4 (ref), LocalPlayer (ref), u6 (ref), Temporary (ref)
                    debug.profilebegin("Controllers/TeleporterController/PreviewUpdate");
...
local function setupCharacter(p45) -- Line: 363
    -- upvalues: onToolEquipped (copy), u5 (ref), u9 (ref), u10 (ref), u6 (ref)
...
function v3.Init(p48) -- Line: 397
end;

function v3.Start(p49) -- Line: 400
    -- upvalues: UserInputService (copy), tryTeleport (copy), LocalPlayer (copy), setupCharacter (copy), u9 (ref), u10 (ref), u6 (ref), u5 (ref)
    ...
    LocalPlayer.CharacterAdded:Connect(function(p52) -- Line: 414
        -- upvalues: u9 (ref), u10 (ref), u6 (ref), u5 (ref), setupCharacter (ref)
        if u9 then
            u9:Destroy();
            u9 = nil;
        end;
