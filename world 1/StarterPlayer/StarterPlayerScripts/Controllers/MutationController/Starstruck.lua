...
function v1.ApplyMutationEffect(p18) -- Line: 94
    ...
    u2[p18] = v19;
    CollectionService:AddTag(p18, "Starstruck");
    ...
    if u3 == 1 then
        ...
        u5 = 0;
        u6 = 0;
        u4 = RunService.RenderStepped:Connect(function(p22) -- Line: 67
            -- upvalues: u6 (ref), EffectLoadManager (ref), u5 (ref), EmissiveStrength (ref), MaterialService (ref)
            u6 = u6 + p22;
...
function v1.RemoveMutationEffect(p27) -- Line: 139
...
CollectionService:GetInstanceAddedSignal("Starstruck"):Connect(v1.ApplyMutationEffect);
CollectionService:GetInstanceRemovedSignal("Starstruck"):Connect(v1.RemoveMutationEffect);

for _, v in CollectionService:GetTagged("Starstruck") do
