...
function v1.PlayOfflineCutscene(u211, p212) -- Line: 968
    ...
    local v243, u244, v245, v246, u247;
    ...
    if v213 then
        ...
        u244 = (v262.Magnitude < 0.01 and Vector3.new(0, 0, -1) or v262).Unit;
        local Unit = u244:Cross(Vector3.new(0, 1, 0)).Unit;
        local Position = v228.Position;
        u247 = Position + u244 * 10;
        local u263 = 0;
        local u264 = 24;
        local u265 = {};
        local u266 = 0;
        ...
        v245 = function(p270, p271, p272, p273) -- Line: 1324
            -- upvalues: u266 (ref), u223 (copy), getSpawnedPlant (copy), u220 (copy), Position (copy), u265 (copy), Unit (ref), u244 (ref), u250 (ref), u248 (ref), u249 (ref), u247 (ref), u255 (ref), u263 (ref), u257 (ref), u264 (ref), u256 (ref), u253 (ref), u252 (ref), u254 (ref), u260 (ref), u261 (ref), u258 (ref), u259 (ref), u251 (ref)
            u266 = u266 + 1;
            ...
            for i, v in u223 do
                ...
                if u285 and u285.Parent then
                    ...
                    if v291 then
                        ...
                        local v296 = v294:Dot(u244);
                        local v297 = math.abs(Unit.X) * v293.X + math.abs(Unit.Z) * v293.Z;
                        local v298 = math.abs(u244.X) * v293.X + math.abs(u244.Z) * v293.Z;
            ...
            local v299 = Position + u244 * 10;
            local v300;

            if v282 > 0 then
                v299 = Position + Unit * ((v276 + v277) * 0.5) + u244 * ((v278 + v279) * 0.5) + Vector3.new(0, (v280 + v281) * 0.5 - Position.Y, 0);
            ...
            u247 = u247:Lerp(v311, 1 - math.exp(-u255 * v312));
            ...
            local Unit2 = CFrame.fromAxisAngle(Vector3.new(0, 1, 0), v315):VectorToWorldSpace(u244).Unit;
            ...
            local v319 = u247 - Unit2 * u264 + Vector3.new(0, v317, 0) + v316;
            local v320 = u247 + Vector3.new(0, v318, 0);

            return CFrame.new(v319, v320);
        end;

        CurrentCamera.CameraType = Enum.CameraType.Scriptable;
        v246 = v245(0, 0, 0, 0.016666666666666666);
        CurrentCamera.CFrame = v246;
    end;
    ...
    if v214 then
        ...
        u346 = Instance.new("Frame");
        u346.Name = "HoldProgressBar";
        u346.AnchorPoint = Vector2.new(0, 0);
        u346.Position = UDim2.new(0, 0, 0, 0);
        u346.Size = UDim2.new(0, 0, 0, 4);
        u346.BackgroundColor3 = Color3.fromRGB(255, 255, 255);
        u346.BackgroundTransparency = 0.2;
        u346.BorderSizePixel = 0;
        u346.ZIndex = OfflineAnimation.BottomBar.ZIndex + 1;
        u346.Parent = OfflineAnimation.BottomBar;
        ...
        local function endHold() -- Line: 1637
            -- upvalues: u343 (ref), u346 (ref), TweenService (ref)
            u343 = nil;

            if u346 then
                TweenService:Create(u346, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    ...
    while true do
        ...
        if not v213 then
            CurrentCamera.CameraType = Enum.CameraType.Scriptable;
            v246 = v246:Lerp(v245(u340, u339, v356, v338), (math.clamp(v243 * ((1 - u339) * 0.45 + 0.55) * v338, 0, 0.12)));
            CurrentCamera.CFrame = v246;
        end;
        ...
        if not v214 and u343 then
            ...
            if u346 then
                u346.Size = UDim2.new(v360, 0, 0, 4);
            end;
    ...
    if not (v213 or u344) then
        ...
        while os.clock() - v361 < 2 do
            ...
            v246 = v246:Lerp(v364:Lerp(CFrame.new(v364.Position + Vector3.new(0, -1.25, 0) + u244 * 2, u247 + Vector3.new(0, 0.55, 0)), v363), (math.clamp(3.2 * v338, 0, 0.1)));
            CurrentCamera.CFrame = v246;
            v338 = RunService.Heartbeat:Wait();
        end;
    end;
