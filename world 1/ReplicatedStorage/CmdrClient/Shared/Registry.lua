...
function u14.RegisterDefaultCommands(p33, u34) -- Line: 186
    ...
    p33:RegisterCommandsIn(p33.Cmdr.DefaultCommandsFolder, v36 and function(p37) -- Line: 195
        -- upvalues: u34 (ref)
        return u34[p37.Group] or false;
    end or u34);
end;

function u14.GetCommand(p38, p39) -- Line: 201
    return p38.Commands[(p39 or ""):lower()];
end;

function u14.GetCommands(p40) -- Line: 207
    return p40.CommandsArray;
end;

function u14.GetCommandNames(p41) -- Line: 212
    local v42 = {};
...
function u14.GetTypeNames(p43) -- Line: 225
    local v44 = {};
...
function u14.GetType(p45, p46) -- Line: 237
    return p45.Types[p46];
end;

function u14.GetTypeName(p47, p48) -- Line: 242
    return p47.TypeAliases[p48] or p48;
end;

function u14.RegisterHook(p49, p50, p51, p52) -- Line: 247
    ...
    table.sort(p49.Hooks[p50], function(p53, p54) -- Line: 253
...
function u14.GetStore(p55, p56) -- Line: 261
    return p55.Stores[p56];
end;

function u14.FlushAutoExecBufferDeferred(u57) -- Line: 266
    -- upvalues: RunService (copy)
    if u57.AutoExecFlushConnection then
        return;
    end;

    u57.AutoExecFlushConnection = RunService.Heartbeat:Connect(function() -- Line: 271
        -- upvalues: u57 (copy)
...
function u14.FlushAutoExecBuffer(p58) -- Line: 279
