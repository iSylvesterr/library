...
function u2.GetArgument(p27, p28) -- Line: 162
    return p27.Arguments[p28];
end;

function u2.GetData(p29) -- Line: 170
    -- upvalues: u1 (copy)
    if p29.Data then
        return p29.Data;
    end;
...
function u2.SendEvent(p30, p31, p32, ...) -- Line: 183
...
function u2.BroadcastEvent(p36, ...) -- Line: 197
    -- upvalues: u1 (copy)
    if not u1 then
...
function u2.Reply(p37, ...) -- Line: 206
    return p37:SendEvent(p37.Executor, "AddLine", ...);
end;

function u2.GetStore(p38, ...) -- Line: 211
    return p38.Dispatcher.Cmdr.Registry:GetStore(...);
end;

function u2.HasImplementation(p39) -- Line: 216
