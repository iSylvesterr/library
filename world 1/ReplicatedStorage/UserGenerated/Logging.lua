...
local function GetPrefix(p2) -- Line: 40
...
local function Format(p7) -- Line: 52
...
local function FormatArgs(...) -- Line: 62
    -- upvalues: Stringify (copy), u1 (copy)
    local v8 = table.pack(...);
...
if RunService:IsStudio() then
    ...
    v10 = function(...) -- Line: 70
        -- upvalues: FormatArgs (copy)
        local spawn = task.spawn;

        local function v13(p12, ...) -- Line: 71
...
local function SetLevel(p30, p31) -- Line: 117
...
function v34.GetLevel() -- Line: 145
    -- upvalues: u29 (ref)
    return u29;
end;

function v34.SetLevel(p35) -- Line: 149
    -- upvalues: SetLevel (copy)
    SetLevel(p35);
end;

function v34.Sink(p36) -- Line: 153
    -- upvalues: u28 (copy)
