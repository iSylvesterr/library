...
local function MatZero(p3) -- Line: 33
...
local function MatIdent(p5) -- Line: 43
...
local function MatMul(p7, p8) -- Line: 53
    local v9 = #p7[1];
    local v10 = #p8[1];
    local v11 = {};
...
local function MatMulVec(p15, p16) -- Line: 73
    local v17 = #p15;
    local v18 = #p15[1];
...
local function MatSum(p22, p23) -- Line: 89
    -- upvalues: MatZero (copy)
    local v24 = #p22;
    local v25 = #p22[1];
...
local function MatInverse(p27) -- Line: 103
...
local function MatPow(p34, p35) -- Line: 132
...
local function L(p40, p41) -- Line: 150
    -- upvalues: MatZero (copy)
...
local function R(p43, p44) -- Line: 161
    -- upvalues: MatZero (copy)
...
local function Embed(p46, p47, p48, p49) -- Line: 172
    -- upvalues: MatZero (copy)
...
local function ToColumnVector128(p51, p52, p53, p54) -- Line: 187
...
local function FromColumnVector128(p60) -- Line: 203
    local v61 = 0;
    local v62 = 0;
    local v63 = 0;
    local v64 = 0;
...
local u75 = (function() -- Line: 216, Name: BuildMatTransform
...
return table.freeze({
    ...
    MatTransform = function() -- Line: 249, Name: MatTransform
        -- upvalues: MatClone (copy), u75 (copy)
        return MatClone(u75);
    end,

    Transform = function(p76, p77, p78, p79, p80) -- Line: 253, Name: Transform
