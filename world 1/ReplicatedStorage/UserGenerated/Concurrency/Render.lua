...
local u5 = table.freeze({
    __index = table.freeze({
        Disconnect = function(p1) -- Line: 53, Name: Disconnect
            p1.Connection:Disconnect();
            p1:OnDisconnected();
        end,

        OnDisconnected = function(p2) -- Line: 58, Name: OnDisconnected
        ...
        Then = function(p3, p4) -- Line: 69, Name: Then
...
function new(u6, u7)
    ...
    local u9 = 0;
    local u10 = nil;
    u10 = RunService.RenderStepped:Connect(function(p11) -- Line: 99
