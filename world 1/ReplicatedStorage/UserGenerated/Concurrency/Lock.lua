...
local u11 = table.freeze({
    __index = table.freeze({
        Call = function(u2, p3, ...) -- Line: 42, Name: Call
            ...
            return Finally(p3, function() -- Line: 52
                -- upvalues: u2 (copy)
                local v5 = u2;
                v5.Count = v5.Count - 1;
            end, ...);
        ...
        Try = function(u6, p7, ...) -- Line: 57, Name: Try
            -- upvalues: Finally (copy)
            ...
            return true, Finally(p7, function() -- Line: 67
                -- upvalues: u6 (copy)
                local v9 = u6;
                v9.Count = v9.Count - 1;
            end, ...);
        ...
        IsLocked = function(p10) -- Line: 72, Name: IsLocked
            return p10.Count > 0;
        end
    })
});
