...
local function Reserve(p9, p10) -- Line: 115
    local Pos = p9.Pos;
    local v11 = Pos + p10;
...
local function WriteString(p16, p17) -- Line: 131
...
local function WriteIndent(p20) -- Line: 137
    -- upvalues: Reserve (copy)
...
local function IncrementIndent(p23, p24) -- Line: 146
    p23.Indent = p23.Indent + p24;
end;

local function WriteU8(p25, p26) -- Line: 150
    -- upvalues: Reserve (copy)
    local v27 = Reserve(p25, 1);
    buffer.writeu8(p25.Buf, v27, p26);
end;

local function WriteU16(p28, p29) -- Line: 155
    -- upvalues: Reserve (copy)
    local v30 = Reserve(p28, 2);
    buffer.writeu16(p28.Buf, v30, p29);
end;

local function WriteU32(p31, p32) -- Line: 160
    -- upvalues: Reserve (copy)
    local v33 = Reserve(p31, 4);
    buffer.writeu32(p31.Buf, v33, p32);
end;

local function EncodeNumber(p34, p35) -- Line: 180
    -- upvalues: Reserve (copy)
    if p35 ~= p35 then
...
local function IsIdentifierName(p43, p44) -- Line: 207
...
local function EncodeString(p47, p48, p49) -- Line: 228
...
local function EncodeAny(p58, p59) -- Line: 316
...
local function EncodeArray(p60, p61) -- Line: 323
    -- upvalues: Reserve (copy)
...
local function EncodeMap(p71, p72) -- Line: 350
...
local v104 = {
    ["nil"] = function(p87, p88) -- Line: 165, Name: EncodeNull
        -- upvalues: Reserve (copy)
        local v89 = Reserve(p87, 4);
        buffer.writeu32(p87.Buf, v89, 1819047278);
    end,

    boolean = function(p90, p91) -- Line: 169, Name: EncodeBoolean
        -- upvalues: Reserve (copy)
        if p91 then
    ...
    buffer = function(p94, p95) -- Line: 278, Name: EncodeBuffer
    ...
    table = function(p102, p103) -- Line: 389, Name: EncodeTable
...
function v105.Vector2(p106, p107) -- Line: 398
    -- upvalues: EncodeArray (copy)
    EncodeArray(p106, { p107.X, p107.Y });
end;

function v105.Vector3(p108, p109) -- Line: 402
    -- upvalues: EncodeArray (copy)
    EncodeArray(p108, { p109.X, p109.Y, p109.Z });
end;

function v105.Vector2int16(p110, p111) -- Line: 406
    -- upvalues: EncodeArray (copy)
    EncodeArray(p110, { p111.X, p111.Y });
end;

function v105.Vector3int16(p112, p113) -- Line: 410
    -- upvalues: EncodeArray (copy)
    EncodeArray(p112, { p113.X, p113.Y, p113.Z });
end;

function v105.Region3(p114, p115) -- Line: 414
    -- upvalues: EncodeArray (copy)
...
function v105.Region3int16(p118, p119) -- Line: 420
    -- upvalues: EncodeArray (copy)
    EncodeArray(p118, {
        p119.Min.X,
        p119.Min.Y,
...
function v105.UDim(p120, p121) -- Line: 424
    -- upvalues: EncodeArray (copy)
    EncodeArray(p120, { p121.Scale, p121.Offset });
end;

function v105.UDim2(p122, p123) -- Line: 428
    -- upvalues: EncodeArray (copy)
    EncodeArray(p122, {
        p123.X.Scale,
        p123.X.Offset,
...
function v105.CFrame(p124, p125) -- Line: 432
    -- upvalues: EncodeArray (copy)
    EncodeArray(p124, { p125:GetComponents() });
end;

function v105.Color3(p126, p127) -- Line: 436
    -- upvalues: EncodeArray (copy)
    EncodeArray(p126, { math.round(p127.R * 255), math.round(p127.G * 255), (math.round(p127.B * 255)) });
end;

function v105.NumberRange(p128, p129) -- Line: 444
    -- upvalues: EncodeArray (copy)
    EncodeArray(p128, { p129.Min, p129.Max });
end;

function v105.Rect(p130, p131) -- Line: 448
    -- upvalues: EncodeArray (copy)
    EncodeArray(p130, {
        p131.Min.X,
        p131.Min.Y,
...
function v105.EnumItem(p132, p133) -- Line: 452
...
return table.freeze({
    Compact = function(p141, p142) -- Line: 485, Name: Compact
    ...
    Pretty = function(p144, p145) -- Line: 496, Name: Pretty
    ...
    CompactExt = function(p147, p148) -- Line: 507, Name: CompactExt
    ...
    PrettyExt = function(p150, p151) -- Line: 518, Name: PrettyExt
    ...
    Compact5 = function(p153, p154) -- Line: 532, Name: Compact5
    ...
    Pretty5 = function(p156, p157) -- Line: 545, Name: Pretty5
