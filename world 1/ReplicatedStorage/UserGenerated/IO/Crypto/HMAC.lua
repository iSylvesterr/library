...
local function Derive(u1, p2) -- Line: 46
    ...
    local function ComputeHmac(p9) -- Line: 72
    ...
    return {
        ...
        Digest = function(p13) -- Line: 92, Name: Digest
        ...
        DigestToBuffer = function(p14) -- Line: 96, Name: DigestToBuffer
            -- upvalues: ComputeHmac (copy)
...
return {
    ...
    DeriveString = function(p15, p16) -- Line: 111, Name: DeriveString
