...
function processBlocks(p3, p4, p5, p6)
    ...
    for i = p5, p6, 64 do
        ...
        v8 = bit32.bor(v8 + v33, 0);
        v9 = bit32.bor(v9 + v32, 0);
        v10 = bit32.bor(v10 + v39, 0);
        v11 = bit32.bor(v11 + v38, 0);
        v12 = bit32.bor(v12 + v36, 0);
        v13 = bit32.bor(v13 + v35, 0);
        v14 = bit32.bor(v14 + v34, 0);
        v15 = bit32.bor(v15 + v37, 0);
    end;
...
local v71 = {
    ...
    Digest = function(p69) -- Line: 172, Name: Digest
        return buffer.tostring(sha256(p69));
    end,

    DigestBuffer = function(p70) -- Line: 175, Name: DigestBuffer
