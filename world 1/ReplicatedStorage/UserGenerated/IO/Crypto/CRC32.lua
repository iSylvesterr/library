...
local u23 = {
    ...
    Update = function(p4, p5, p6, p7) -- Line: 49, Name: Update
        -- upvalues: u1 (copy)
        local v8 = p6 or 1;
    ...
    UpdateBuffer = function(p13, p14, p15, p16) -- Line: 65, Name: UpdateBuffer
        -- upvalues: u1 (copy)
        local v17 = p15 or 0;
    ...
    Finish = function(p22) -- Line: 81, Name: Finish
        return bit32.bnot(p22);
    end
};

function u23.Digest(p24, p25, p26) -- Line: 87
    -- upvalues: u23 (copy)
    local v27 = u23.Init();
...
function u23.DigestBuffer(p29, p30, p31) -- Line: 97
    -- upvalues: u23 (copy)
    local v32 = u23.Init();
