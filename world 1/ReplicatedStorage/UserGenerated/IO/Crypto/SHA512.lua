...
function processBlocks(p63, p64, p65, p66, p67)
    ...
    for i = p66, p67, 128 do
        ...
        local v142 = v118 + v78;
        v70 = bit32.bor(v110 + v70 + v142 // 4294967296, 0);
        v78 = bit32.bor(v142, 0);
        local v143 = v117 + v79;
        v71 = bit32.bor(v116 + v71 + v143 // 4294967296, 0);
        v79 = bit32.bor(v143, 0);
        local v144 = v112 + v80;
        v72 = bit32.bor(v111 + v72 + v144 // 4294967296, 0);
        v80 = bit32.bor(v144, 0);
        local v145 = v119 + v81;
        v73 = bit32.bor(v114 + v73 + v145 // 4294967296, 0);
        v81 = bit32.bor(v145, 0);
        local v146 = v109 + v82;
        v74 = bit32.bor(v115 + v74 + v146 // 4294967296, 0);
        v82 = bit32.bor(v146, 0);
        local v147 = v113 + v83;
        v75 = bit32.bor(v107 + v75 + v147 // 4294967296, 0);
        v83 = bit32.bor(v147, 0);
        local v148 = v106 + v84;
        v76 = bit32.bor(v108 + v76 + v148 // 4294967296, 0);
        v84 = bit32.bor(v148, 0);
        local v149 = v105 + v85;
        v77 = bit32.bor(v120 + v77 + v149 // 4294967296, 0);
...
function sha512(p150)
    local v151 = { 1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225 };
    local v152 = { 4089235720, 2227873595, 4271175723, 1595750129, 2917565137, 725511199, 4215389547, 327033209 };
    local v153 = #p150;
...
local v163 = {
    ...
    Digest = function(p161) -- Line: 347, Name: Digest
        return buffer.tostring(sha512(p161));
    end,

    DigestBuffer = function(p162) -- Line: 350, Name: DigestBuffer
        return sha512(buffer.tostring(p162));
    end,
