...
local function DestroyThing(u1) -- Line: 60
...
local function Add(p3, p4) -- Line: 106
...
local v7 = {
    Destroy = function(p5) -- Line: 90, Name: Destroy
        -- upvalues: DestroyThing (copy)
    ...
    IsDestroyed = function(p6) -- Line: 102, Name: IsDestroyed
        return p6.Destroyed;
    end,
