...
local function insertRight2(p1, p2) -- Line: 78
...
local function unlink2(p3) -- Line: 86
    p3.Left2.Right2 = p3.Right2;
    p3.Right2.Left2 = p3.Left2;
end;

local function unlink(p4) -- Line: 91
...
local function isRed(p5) -- Line: 101
    if p5 then
        return p5.Color1;
    end;
...
local function rotateLeft(p6) -- Line: 109
...
local function rotateRight(p7) -- Line: 119
...
local function flipColors(p8) -- Line: 129
...
local function moveRedLeft(p9) -- Line: 139
...
local function moveRedRight(p12) -- Line: 151
...
local function balance(p15) -- Line: 161
...
local function removeMin(p23) -- Line: 174
...
local function removeMax(p30) -- Line: 188
...
local function height(p39) -- Line: 205
...
local function isBST(p41, p42, p43, p44) -- Line: 214
    -- upvalues: isBST (copy)
    if not p42 then
        return true;
    end;
...
local function remove(p46, p47, p48) -- Line: 233
...
local function insert(p64, p65, p66, p67, p68) -- Line: 280
...
local function isBalanced(p75, p76) -- Line: 317
...
local function size(p79) -- Line: 330
    -- upvalues: size (copy)
    local v80 = 0;
...
local function selectRank(p81, p82) -- Line: 340
...
local function rank(p84, p85, p86) -- Line: 354
...
local function is23(p90, p91) -- Line: 368
    -- upvalues: is23 (copy)
    if not p91 then
        return true;
    end;
...
function v96.Insert(p98, p99, p100) -- Line: 387
...
function v96.Remove(p104, p105) -- Line: 403
...
function v96.RemoveMin(p110) -- Line: 423
...
function v96.RemoveMax(p115) -- Line: 442
...
function v96.Min(p120) -- Line: 462
...
function v96.Max(p121) -- Line: 471
...
function v96.GetSize(p122) -- Line: 481
    return p122.Size;
end;

function v96.ForEach(p123, p124) -- Line: 485
...
function v96.Next(p127, p128) -- Line: 498
    if p128 == nil then
        p128 = p127.List;
    end;
...
function v96.Iterator(p129) -- Line: 508
    return p129.Next, p129;
end;

function v96.IsBST(p130) -- Line: 512
    -- upvalues: isBST (copy)
...
function v96.IsSizeConsistent(p132) -- Line: 516
    -- upvalues: size (copy)
...
function v96.IsRankConsistent(u136) -- Line: 538
    ...
    u136:ForEach(function(p139, p140) -- Line: 548
...
function v96.Is23(p144) -- Line: 558
    -- upvalues: is23 (copy)
    return is23(p144.Root, p144.Root);
end;

function v96.IsBalanced(p145) -- Line: 562
    -- upvalues: isBalanced (copy)
...
function v96.Check(p151) -- Line: 575
...
return table.freeze({
    Compare = function(p152, p153) -- Line: 599, Name: Compare
        return p152 < p153 and -1 or (p153 < p152 and 1 or 0);
    end,

    new = function(p154, p155, p156) -- Line: 605, Name: new
        -- upvalues: u97 (copy)
