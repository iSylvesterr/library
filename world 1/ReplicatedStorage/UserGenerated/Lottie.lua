...
local function HasAnimatedOpacity(p13) -- Line: 102
    if p13 == nil then
        return false;
    end;
...
local function SubdivideCubicBezier(p14, p15, p16, p17, p18, p19, p20, p21, p22, p23) -- Line: 109
    for i = 1, p22 do
        local v24 = i / p22;
        local v25 = 1 - v24;
        local v26 = v25 * v25;
...
local function BezierShapeToPolyline(p30) -- Line: 131
...
local function Cross2D(p48, p49, p50, p51, p52, p53) -- Line: 168
    return (p50 - p48) * (p53 - p49) - (p51 - p49) * (p52 - p48);
end;

local function PointInTriangle(p54, p55, p56, p57, p58, p59, p60, p61) -- Line: 172
...
local function IsConvexPolygon(p65) -- Line: 181
    local v66 = #p65;
...
local function TriangulateFan(p73) -- Line: 204
    local v74 = {};
...
local function TriangulateEarClip(p75) -- Line: 212
...
local function CreateWedge(p94) -- Line: 275
...
local function UpdateTriangle(p95, p96, p97, p98, p99, p100, p101, p102, p103) -- Line: 285
    local v104 = p98 - p96;
    local v105 = p99 - p97;
    local v106 = p100 - p96;
    local v107 = p101 - p97;
...
local function CreateTrianglePair(p118) -- Line: 350
    local v119 = {};
    local ImageLabel = Instance.new("ImageLabel");
    ImageLabel.Image = "rbxassetid://83051256678409";
    ImageLabel.BackgroundTransparency = 1;
...
local function BuildFilledPath(p120, p121, p122, p123, p124, p125, p126) -- Line: 359
...
local function BuildStrokedPath(p132, p133, p134, p135, p136, p137, p138, p139, p140, p141, p142, p143) -- Line: 403
...
local function BuildLinearGradient(p170, p171, p172, p173, p174) -- Line: 509
...
local function BuildRadialGradientApprox(p186, p187, p188, p189, p190, p191, p192) -- Line: 548
    -- upvalues: Easing (copy)
    local p = p187.p;
...
local function ApplyTransform(p210, p211, p212, p213, p214, p215, p216, p217) -- Line: 597
    -- upvalues: Easing (copy)
    if p211 == nil then
        return;
    end;
...
local function CollectShapeInfo(p227) -- Line: 651
    local v228 = nil;
    local v229 = nil;
    local v230 = nil;
    local v231 = nil;
...
local function BuildShapeGroup(p241, p242, p243, p244, p245) -- Line: 696
...
local function BuildShapeLayer(p293, p294, p295, p296, p297) -- Line: 950
...
local function BuildTextLayer(p301, p302, p303, p304, p305) -- Line: 967
    -- upvalues: u4 (copy)
    local t = p301.t;
    ...
    if u306.f then
        local success2, result2 = pcall(function() -- Line: 1013
            -- upvalues: u306 (ref)
...
local function BuildImageLayer(p308, p309, p310, p311, p312) -- Line: 1027
    ...
    if v313.e == 1 and v313.p then
        ...
        if string.sub(p, 1, 22) == "data:image/png;base64," then
            ...
            if result then
                local success2, result2 = pcall(function() -- Line: 1053
                ...
                if success2 and result2 then
                    local success3, result3 = pcall(function() -- Line: 1058
                    ...
                    if success3 and (result3 and pcall(function() -- Line: 1062
...
local function BuildDropShadow(p316, p317, p318, p319, p320) -- Line: 1086
...
local function BuildLayers(p330, p331, p332, p333, p334, p335) -- Line: 1148
    ...
    for _, v in v336 do
        ...
        if Layer.parent and v337[Layer.parent] then
            v.Frame.Parent = v337[Layer.parent].Frame;
...
local function RenderLayerNodes(p367, p368, p369, p370) -- Line: 1314
...
u366 = function(p378, p379, p380, p381) -- Line: 1368
...
return table.freeze({
    Parse = function(p394) -- Line: 1437, Name: Parse
        -- upvalues: HttpService (copy)
        return HttpService:JSONDecode(p394);
    end,

    Create = function(p395) -- Line: 1441, Name: Create
    ...
    Render = function(p397, p398) -- Line: 1476, Name: Render
    ...
    Destroy = function(p399) -- Line: 1487, Name: Destroy
        p399.Root:Destroy();
