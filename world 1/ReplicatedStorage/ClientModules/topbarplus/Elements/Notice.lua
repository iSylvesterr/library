...
return function(u1, u2) -- Line: 1
    ...
    u1.noticeStarted:Connect(function(p7, p8) -- Line: 73
        ...
        u11:add(u1.endNotices:Connect(function() -- Line: 85
            -- upvalues: u12 (copy)
            u12:Fire();
        end));
        u11:add(v9:Connect(function() -- Line: 88
            -- upvalues: u12 (copy)
            u12:Fire();
        end));
        ...
        local function updateNotice() -- Line: 96
            -- upvalues: u1 (ref)
