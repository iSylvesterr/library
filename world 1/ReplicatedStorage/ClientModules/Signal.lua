...
function u4.Disconnect(p5) -- Line: 79
...
setmetatable(u4, {
    __index = function(p6, p7) -- Line: 106, Name: __index
        error(("Attempt to get Connection::%s (not a valid member)"):format((tostring(p7))), 2);
    end,

    __newindex = function(p8, p9, p10) -- Line: 109, Name: __newindex
...
function u11.Connect(p18, p19) -- Line: 187
    -- upvalues: u4 (copy)
...
function u11.ConnectOnce(p21, p22) -- Line: 210
    return p21:Once(p22);
end;

function u11.Once(p23, u24) -- Line: 228
    local u25 = nil;
    local u26 = false;
    u25 = p23:Connect(function(...) -- Line: 232
...
function u11.GetConnections(p27) -- Line: 245
...
function u11.DisconnectAll(p29) -- Line: 265
...
function u11.Fire(p31, ...) -- Line: 299
...
function u11.FireDeferred(p32, ...) -- Line: 320
...
function u11.Wait(p33) -- Line: 347
...
function u11.Destroy(p36) -- Line: 377
    p36:DisconnectAll();
...
setmetatable(u11, {
    __index = function(p38, p39) -- Line: 388, Name: __index
        error(("Attempt to get Signal::%s (not a valid member)"):format((tostring(p39))), 2);
    end,

    __newindex = function(p40, p41, p42) -- Line: 391, Name: __newindex
