    ...
    InitPlant = function(p1, p2, p3) -- Line: 6, Name: InitPlant
        ...
        if v10 == true then
            ...
            for i = 1, v13 do
                ...
                v20.CFrame = v12 * CFrame.new(0, Size.Y / 2, 0) * CFrame.Angles(v49, 0, v48) * CFrame.new(0, v20.Size.Y / 2, 0);
                v20.Color = v14;
                v20.Name = tostring(v11);
                v20.Parent = p1;
                v12 = v20.CFrame;
