        ...
        for i = 1, v34 do
            ...
            if i > 2 then
                for i2 = 1, 4 do
                    ...
                    local v40 = v39 * 0.8;
                    local v41 = v35.CFrame * CFrame.new(0, -v35.Size.Y / 2, 0) * CFrame.Angles(0, math.rad(i2 * 90 + v28), 0) * CFrame.Angles(1.5707963267948966, 0, 0) * CFrame.new(0, v35.Size.X / 2, 0);
