...
return {
    ...
    InitPlant = function(u1, p2, p3) -- Line: 22, Name: InitPlant
        ...
        local function GetRandomHSV(p8, p9) -- Line: 39
            -- upvalues: u5 (copy)
        ...
        local function CreatePart(p15, p16, p17) -- Line: 47
        ...
        local _ = Base.CFrame;
        local Base2 = u1.Base;
        local u22 = Color3.fromRGB(149, 105, 80);
        local u23 = Color3.fromRGB(180, 195, 80);

        local function generateTrunk(p24, p25) -- Line: 86
                ...
                if i == p25 then
                    ...
                    for i2 = 1, v58 do
                        ...
                        for i3 = 1, v59 do
                            ...
                            v66.Color = Color3.fromRGB(126, 180, 40);
    ...
    BeginPlantGrowth = function(u84) -- Line: 303, Name: BeginPlantGrowth
        ...
        local function updateGrowth() -- Line: 321
