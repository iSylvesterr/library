...
return {
    ...
    InitPlant = function(u1, p2, p3) -- Line: 9, Name: InitPlant
        ...
        local v31, v32, v33 = Color3.fromRGB(77, 162, 63):ToHSV();
        ...
        if u4:NextInteger(1, 100) == 1 then
            v37 = Color3.new(1, 1, 0);
        elseif u4:NextInteger(1, 100) == 1 then
            v37 = Color3.new(0, 0.184314, 1);
        elseif u4:NextInteger(1, 100) == 1 then
            v37 = Color3.new(1, 0, 0);
        elseif u4:NextInteger(1, 100) == 1 then
                ...
                for _, v in v38 do
                    ...
                    if i + 1 >= 6 then
                        ...
                        for i2 = 1, 2 do
                            ...
                            Part2.Color = Color3.fromRGB(104, 66, 182);
                    ...
                    Part.Color = Color3.fromRGB(104, 66, 182);
        ...
        for _, v in u1:QueryDescendants("BasePart") do
            if v ~= Base and v.Color ~= Color3.fromRGB(255, 255, 255) then
                ...
                v.Color = Color3.fromHSV(v117 + v116, v118, v119);
            end;
        end;
