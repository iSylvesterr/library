...
return {
    ...
    InitPlant = function(p1, p2, p3) -- Line: 6, Name: InitPlant
        ...
        while v5:NextInteger(1, 200) == 1 do
            ...
            v13 = v13 * v5:NextInteger(5, 7);
            v17 = 0.95;

            while v5:NextInteger(1, 70) == 1 do
                v13 = v13 * v5:NextInteger(2, 3);
        ...
        for _ = 1, v8 do
            if v10 > 0.5 then
                v15 = Stud_Part:Clone();
                v15.Size = Vector3.new(v10, v11, v10);
                v15.CFrame = v9 * CFrame.new(0, v15.Size.Y / 2 + Size.Y / 2, 0);
                ...
                v15.MaterialVariant = "2022 Stud Bark";
                v15.Parent = p1;
                v16 = v16 + 1;
                v15.Name = tostring(v16);
                v9 = v15.CFrame;
                Size = v15.Size;
                v10 = v10 * v17;
                v11 = v11 * v17;
        ...
        for _, v in pairs(v14) do
            ...
            for _ = 1, v5:NextInteger(0, v.Size.Y * 0.5) do
                ...
                while v22 == nil and v21 < 50 do
                    ...
                    local v24 = math.clamp(v13 * 0.5, 0.1, v.Size.X * 0.5);
                    local v25 = Vector3.new(v24, v12, v24);
                    local v26;
                    ...
                    for _, v2 in pairs(v18) do
                        if v2 ~= v15 and not table.find(v14, v2) then
