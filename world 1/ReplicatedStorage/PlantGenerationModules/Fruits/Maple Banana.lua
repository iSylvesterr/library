...
return {
    ...
    InitFruit = function(u1, p2, p3) -- Line: 13, Name: InitFruit
        ...
        local v12 = {
            Color3.fromRGB(242, 157, 49),
            Color3.fromRGB(242, 157, 49),
            Color3.fromRGB(242, 125, 0),
            Color3.fromRGB(242, 133, 0),
            Color3.fromRGB(242, 125, 0)
        };
        local u13 = v12[math.random(1, #v12)];
        local u14 = v12[math.random(1, #v12)];
        local u15 = nil;

        while u13 == u14 do
            u14 = v12[math.random(1, #v12)];
        end;

        local function generateTrunk(p16, p17) -- Line: 46
            -- upvalues: u4 (copy), u15 (ref), u1 (copy), u13 (copy), u14 (ref)
            for i = 1, p17 do
                local v18 = script.Part:Clone();
                local v19 = (i - 1) / math.max(p17 - 1, 1);
                local v20 = (math.sin(v19 * 3.141592653589793) * 0.7 + 0.30000000000000004) * 1.75;
