...
return {
    ...
    InitFruit = function(p1, p2, p3) -- Line: 9, Name: InitFruit
        ...
        local v5 = script.Tomato:Clone();
        v5:PivotTo(p1.PrimaryPart.CFrame);
        v5:ScaleTo(v4 + v4 ^ 3 * 5e-7);
        v5.PrimaryPart:Destroy();
    ...
    BeginFruitGrowth = function(u6) -- Line: 33, Name: BeginFruitGrowth
        ...
        local function updateGrowth() -- Line: 56
            ...
            for _, v in u7 do
                if not v.part:GetAttribute("DontShow") then
                    ...
                    if v14 ~= v.lastProgress then
                        ...
                        if v14 > 0 then
                            if v.part:HasTag("Red") then
                                v.part.Color = Color3.fromHSV(0.4 - 0.4 * v13, 1, 1);
                            end;
    ...
    OnFullyGrown = function(p17) -- Line: 103, Name: OnFullyGrown
